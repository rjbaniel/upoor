...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN','pink-kupy');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
<div class="commentbox">
		...
		<p class="commentinfo"> <a href="#comment-<?php comment_ID() ?>" title=""><?php _e('Link Here',TEMPLATE_DOMAIN);?></a> | <?php comment_date() ?>, <?php get_comment_time(); ?></p>
		<?php comment_text() ?>

<p class="commentby" id="comment-<?php comment_ID() ?>"><?php if ('' != get_comment_author_url()) { ?><a href="<?php comment_author_url(); ?>" title="<?php _e('Visit',TEMPLATE_DOMAIN);?> <?php comment_author() ?>">
...
<?php } ?>
&nbsp;&nbsp;<?php comment_author() ?></a> | <?php edit_comment_link(__("Edit This",TEMPLATE_DOMAIN), ' |'); ?>&nbsp;&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?>
