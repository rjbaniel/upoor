					...
					<div id="et_pt_blog">
						...
						<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
							...
							<div class="et_pt_blogentry clearfix">
								...
								<p class="et_pt_blogmeta"><?php esc_html_e('Posted','BlueMist'); ?> <?php esc_html_e('by','BlueMist'); ?> <?php the_author_posts_link(); ?> <?php esc_html_e('on','BlueMist'); ?> <?php the_time(get_option('bluemist_date_format')) ?> <?php esc_html_e('in','BlueMist'); ?> <?php the_category(', ') ?> | <?php comments_popup_link(esc_html__('0 comments','BlueMist'), esc_html__('1 comment','BlueMist'), '% '.esc_html__('comments','BlueMist')); ?></p>
								...
								<?php if (!$et_ptemplate_blogstyle) { ?>
									...
									<a href="<?php the_permalink(); ?>" class="readmore"><span><?php esc_html_e('read more','BlueMist'); ?></span></a>
								<?php } else { ?>
									<?php
										global $more;
										$more = 0;
