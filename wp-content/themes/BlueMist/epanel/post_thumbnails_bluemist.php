<?php
	...
	$et_post_thumb = sprintf( $et_thumb_size_format,
		intval( get_option( 'bluemist_thumbnail_width_posts', 100 ) ),
		intval( get_option( 'bluemist_thumbnail_height_posts', 100 ) )
	);
	$et_page_thumb = sprintf( $et_thumb_size_format,
		intval( get_option( 'bluemist_thumbnail_width_pages', 100 ) ),
		intval( get_option( 'bluemist_thumbnail_height_pages', 100 ) )
	);

	$et_theme_image_sizes = array(
		$et_post_thumb	=> 'et-posts-thumb',
		$et_page_thumb	=> 'et-pages-thumb',
		'94x94' 	=> 'et-index-thumb',
		'384x122' 	=> 'et-featured-thumb',
	);
