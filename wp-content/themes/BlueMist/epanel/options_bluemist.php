...
$options = array (
	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Show Tabbed Area",
                   "id" => $shortname."_tabs",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to display the Tabbed Area on the homepage. "),

			array( "name" => "Show Recent Entries Area",
                   "id" => $shortname."_show_tabarea_recententries",
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => "Here you can choose to display the Recent Entries Area on the homepage. "),
			...
			array( "name" => "Show Popular Area",
                   ...
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to display the Show Popular Area on the homepage. "),

			array( "name" => "Show Recent Comments Area",
                   "id" => $shortname."_show_tabarea_recentcomments",
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => "Here you can choose to display the Show Recent Comments Area on the homepage. "),
			...
			array( "name" => "Recent posts number",
				   ...
				   "validation_type" => "number",
				   "std" => "5",
				   "desc" => "Here you can choose to display the number of Recent Posts on the homepage. ",),
			...
			array( "name" => "Popular posts number",
				   ...
				   "validation_type" => "number",
				   "std" => "5",
				   "desc" => "Here you can choose to display the number of Popular Posts on the homepage. ",),
			...
			array( "name" => "Recent comments number",
				   ...
				   "validation_type" => "number",
				   "std" => "5",
				   "desc" => "Here you can choose to display the number of Recent Comments on the homepage. ",),

			array( "name" => "Show Adsense code",
                   "id" => $shortname."_show_adsense",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to use display adsense code in the theme. "),
			...
			array( "name" => "About us text",
				   ...
				   "type" => "textarea",
				   "std" => "",
				   "desc" => "You can use this text area to display the About us text on the homepage. ",),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Number of Posts displayed on Homepage",
                   ...
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can designate the number of posts displayed on the homepage. "),
