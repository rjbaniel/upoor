<?php
	...
	$et_page_thumb = sprintf( $et_thumb_size_format,
		intval( get_option( 'puretype_thumbnail_width_pages', 200 ) ),
		intval( get_option( 'puretype_thumbnail_height_pages', 200 ) )
	);

	$et_theme_image_sizes = array(
		$et_page_thumb	=> 'et-pages-thumb',
		'98x98' 	=> 'et-default-thumb',
		'615x223' 	=> 'et-featured-thumb',
	);
