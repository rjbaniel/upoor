<?php get_header(); ?>
  ...
  <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		...
		<div class="post">
			<h2 id="post-<?php the_ID(); ?>"><a href="<?php echo get_permalink() ?>" rel="<?php _e('bookmark',TEMPLATE_DOMAIN); ?>" title="<?php _e('Permanent Link:',TEMPLATE_DOMAIN);?> <?php the_title(); ?>"><?php the_title(); ?></a></h2>
			...
			<div class="entrytext">
				...
				<p class="postmetadata alt">
					...
					<?php _e('Filed under',TEMPLATE_DOMAIN);?> <?php the_category(', ') ?> and<?php the_tags( '&nbsp;' . __( 'tagged',TEMPLATE_DOMAIN ) . ' ', ', ', ''); ?>.
