...
$options = array (
	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => esc_html__("Featured Songs Section Custom Background",$themename),
				   "id" => $shortname."_songs_bg_image",
				   "type" => "upload",
				   "std" => "",
				   "desc" => esc_html__("If you would like to use your own background image for the Featured Songs section on homepage click the Upload Image button.",$themename)
			),

			array( "name" => esc_html__("Media Gallery Section Custom Background",$themename),
				   "id" => $shortname."_media_bg_image",
				   "type" => "upload",
				   "std" => "",
				   "desc" => esc_html__("If you would like to use your own background image for the Media Gallery section on homepage click the Upload Image button.",$themename)
			),
			...
			array( "name" => esc_html__( "Show Twitter Icon", $themename ),
                   ...
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => esc_html__( "Here you can choose to display the Twitter Icon on your site. You also need to set Twitter Profile Url option below.", $themename )
			),
			...
			array( "name" => esc_html__( "Show RSS Icon", $themename ),
                   ...
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => esc_html__( "Here you can choose to display the RSS Icon on your site.", $themename )
			),
			...
			array( "name" => esc_html__( "Show Facebook Icon", $themename ),
                   ...
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => esc_html__( "Here you can choose to display the Facebook Icon on your site. You also need to set Facebook Profile Url option below.", $themename )
			),
			...
			array( "name" => esc_html__( "Show SoundCloud Icon", $themename ),
                   ...
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => esc_html__( "Here you can choose to display the SoundCloud Icon on your site. You also need to set SoundCloud Profile Url option below.", $themename )
			),
			...
			array( "name" => esc_html__( "SoundCloud Profile Url", $themename ),
                   "id" => $shortname."_soundcloud_url",
                   "std" => "",
                   "type" => "text",
                   "validation_type" => "url",
				   "desc" => esc_html__( "Enter the URL of your SoundCloud Profile. ", $themename )
			),
		...
		array( "name" => "general-2",
			...
			array( "name" => esc_html__("Display Recent News Section",$themename),
			...
			array( "name" => esc_html__("Display Featured Songs Section",$themename),
			...
			array( "name" => esc_html__("Display Media Gallery Section",$themename),
			...
			array( "name" => esc_html__("More news link url ( in the Recent News section )",$themename),
			...
			array( "name" => esc_html__("Number of Featured Songs",$themename),
			...
			array( "name" => esc_html__("Number of Media Gallery items",$themename),
			...
			array( "name" => esc_html__("Recent News Section custom title",$themename),
			...
			array( "name" => esc_html__("Featured Songs Section custom title",$themename),
			...
			array( "name" => esc_html__("Media Gallery Section custom title",$themename),
