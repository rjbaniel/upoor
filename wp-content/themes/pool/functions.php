...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN','pool');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
<?php } ?><?php comment_author_link() ?></cite>
			...
			<?php comment_date('F jS, Y') ?> <?php _e("at",TEMPLATE_DOMAIN); ?> <?php comment_time() ?></a>
			<?php edit_comment_link(__('Moderate',TEMPLATE_DOMAIN),'',''); ?>&nbsp;&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?></small>
