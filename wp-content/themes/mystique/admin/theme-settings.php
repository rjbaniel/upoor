...
function reviews24_get_site_preview() {
...
function mystique_update_options() {
  ...
  if(!current_user_can('edit_theme_options')) wp_die(__('You are not authorised to perform this operation.', 'mystique'));
  $options = get_option('mystique');

  foreach (mystique_default_settings() as $key => $value):
   if(($key != 'logo') && ($key != 'background')) $options[$key] = stripslashes($_POST[$key]);
  ...
  if(isset($_POST['remove-logo'])) $options['logo'] = '';
  elseif($_FILES["file-logo"]["type"])
   if(is_valid_image('file-logo')) $options['logo'] = get_upload_dir('baseurl'). "/". $_FILES["file-logo"]["name"];

  if(isset($_POST['remove-background'])) $options['background'] = '';
  elseif($_FILES["file-background"]["type"])
   if(is_valid_image('file-background')) $options['background'] = get_upload_dir('baseurl'). "/". $_FILES["file-background"]["name"];
   ...
   <div id="mystique-settings-tabs">
    ...
    <div class="clear-block">
     <ul class="subsubsub">
      ...
      <li class="adv"><a href='#tab-advanced'><?php _e("Advanced","mystique"); ?></a></li><?php if($multi_site_on != "true") { ?> |
      <li class="usercss"><a href='#tab-css'><?php _e("User CSS","mystique"); ?></a></li> |
      <li class="morethemes"><a href='#tab-more'><?php _e("More themes by digitalnature","mystique"); ?></a></li>
      <?php } ?>
     </ul>
    </div>
    ...
    <div class="sections wrap metabox-holder">
     ...
     <div class="section" id="tab-design">
      ...
      <table class="form-table">
       ...
       <tr>
        ...
        <td>
         ...
         <label for="opt_page_width_fluid"><input name="page_width" type="radio" id="opt_page_width_fluid" class="radio" value="fluid" <?php checked('fluid', get_mystique_option('page_width')) ?> /><?php _e("Fluid (100%)","mystique"); ?></label>
      ...
      <tr>
        <th scope="row"><p><?php _e("Twitter ID","mystique"); ?><span><?php _e("Leave blank to disable twitter streaming","mystique"); ?></span></p></th>
        <td id="twit_user">
         <?php $default_twit_user = get_mystique_option('twit_user'); ?>
         <div class="twit_user">
          <label for="twit_user" class="twit_user"></label>
<input type="text" name="twit_user" id="twit_user" value="<?php if(get_mystique_option('twit_user') != '' ) { ?><?php echo get_mystique_option('twit_user'); ?><?php } ?>" >
         </div>
       ...
       <tr>
        ...
        <td>
           ...
           <div class="color-selector clear-block" id="opt_background_color">
             <div class="preview" style="background-color: #<?php echo esc_html(get_mystique_option('background_color')); ?>">
               <input name="background_color" type="hidden" value="<?php echo esc_html(get_mystique_option('background_color')); ?>" />
             </div>
           </div>
     ...
     <tr>
        ...
        <td>
         <textarea id="opt_footer_content" rows="8" cols="60" name="footer_content" class="code"><?php echo esc_html(get_mystique_option('footer_content')); ?></textarea>
         <br />
       ...
       <tr id="nav-list" <?php if(!get_mystique_option('navigation')): ?>class="hidden"<?php endif; ?>>
        ...
        <td>
          ...
          <ul class="nav-exclude">
            <li><input name="exclude_home" id="opt_exclude_home" class="checkbox" type="checkbox" value="1" <?php checked('1', get_mystique_option('exclude_home')) ?> /><label> <a href="<?php echo get_option('home'); ?>"><?php _e('Home','mystique'); ?></a> </label></li>
          </ul>
          <?php endif; ?>

          <ul class="nav-exclude hidden opt_links">
       ...
       <tr>
        ...
        <td class="clear-block">
         ...
         <div class="ad-code clear-block">
          ...
          <textarea rows="8" cols="40" name="ad_code_<?php echo $i; ?>" id="opt_ad_code_<?php echo $i; ?>" class="code"><?php echo esc_html(get_mystique_option('ad_code_'.$i)); ?></textarea>
     ...
     <div class="section" id="tab-advanced">
      <table class="form-table">
       ...
       <tr>
        ...
        <td><input id="opt_ajax_commentnavi" name="ajax_commentnavi" type="checkbox" class="checkbox" value="1" <?php checked('1', get_mystique_option('ajax_commentnavi') ) ?> /></td>
       </tr>
      ...
      <tr>
        ...
        <td>
         <textarea rows="16" cols="60" name="functions" id="opt_functions" class="code"><?php echo esc_html(get_mystique_option('functions')); ?></textarea>
        </td>
       </tr>
       <?php } ?>
     ...
     <div class="section" id="tab-css">
      <table class="form-table">
       ...
       <tr>
        ...
        <td valign="top">
         <textarea rows="30" cols="80" name="user_css" id="opt_user_css" class="code"><?php echo esc_html(get_mystique_option('user_css')); ?></textarea>
        </td>
       </tr>
...
add_action('wp_ajax_site_preview', 'reviews24_get_site_preview');
