	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Red", "Cobalt", "Green", "Purple", "Teal")),
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "wrap-navigation",
		...
		array( "name" => "navigation-1",
			...
			array( "name" => "Show Home link description",
            		"id" => $shortname."_show_homelink_description",
            		"type" => "checkbox",
            		"std" => "on",
					"desc" => "Here you can choose to display the Home Link Description. "),

			array( "type" => "clearfix",),

			array( "name" => "Home link description",
            "id" => $shortname."_home_description",
            "type" => "text",
            "validation_type" => "nohtml",
            "std" => "Click here to return to the home page",
			"desc" => "This description will appear below the home link in the navigation bar."),
