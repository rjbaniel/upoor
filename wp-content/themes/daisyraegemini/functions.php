...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'daisyraegemini');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
load_theme_textdomain('daisyrae', TEMPLATEPATH . '/languages/');
...
<p class="commentinfo"><?php comment_date() ?> @ <?php comment_time() ?> <?php edit_comment_link(__("Edit This",'daisyrae'), '&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;'); ?>&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?></p>
...
define('HEADER_IMAGE_WIDTH', 762); //width is fixed
define('HEADER_IMAGE_HEIGHT', 190);


function gemini_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'gemini_admin_header_style'));
