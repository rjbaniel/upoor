...
<?php if($video != '') : ?>
	 ...
	 <?php else : ?>
		<a href="<?php echo esc_url($thumbnail["fullpath"]); ?>" title="<?php the_title() ?>" rel="gallery" class="fancybox"><img src="<?php echo get_template_directory_uri(); ?>/images/zoom.png" alt="" class="zoom" /></a>
     <?php endif; ?>
