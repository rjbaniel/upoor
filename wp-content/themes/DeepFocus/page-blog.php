							...
							<div id="et_pt_blog">
								...
								<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
									...
									<div class="et_pt_blogentry clearfix">
										...
										<p class="et_pt_blogmeta"><?php esc_html_e('Posted','DeepFocus'); ?> <?php esc_html_e('by','DeepFocus'); ?> <?php the_author_posts_link(); ?> <?php esc_html_e('on','DeepFocus'); ?> <?php the_time(get_option('deepfocus_date_format')) ?> <?php esc_html_e('in','DeepFocus'); ?> <?php the_category(', ') ?> | <?php comments_popup_link(esc_html__('0 comments','DeepFocus'), esc_html__('1 comment','DeepFocus'), '% '.esc_html__('comments','DeepFocus')); ?></p>
