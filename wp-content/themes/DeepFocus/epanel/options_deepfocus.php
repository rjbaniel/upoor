	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Default", "Noise", "Stone", "Smooth-Green", "Wooden")),
			...
			array( "name" => "Blog Category",
			       ...
			       "options" => $site_cats,
				   "desc" => "Here you can choose what category you would like to display in the From The Blog section of the homepage. "),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Quote Line 1",
                   ...
                   "std" => "Imagery is my life and life is something beautiful",
                   "type" => "text",
				   "desc" => "Here you can define the text that appears in the homepage quote."),

			array( "name" => "Quote Line 2",
                   "id" => $shortname."_quote_two",
                   "std" => "Nam dapibus tortor at massa ornare tincidunt. Donec sagittis commodo diam, a ornare metus",
                   "type" => "text",
				   "desc" => "Here you can define the text that appears in the homepage quote."),
			...
			array( "name" => "Content Area 1 Page",
				   ...
				   "std" => "",
				   "type" => "select",
				   "desc" => "Here you can choose the page you would like to display in the content area of the homepage. ",
				   "options" => $site_pages,
				   'et_array_for' => 'pages'),
			...
			array( "name" => "Content Area 3 Page",
               ...
               "std" => "",
               "type" => "select",
               "desc" => "Here you can choose to the page you would like to display in the content area of the homepage. ",
               "options" => $site_pages,
			   'et_array_for' => 'pages'),

			array( "name" => "Number of posts in the 'From The Blog' section",
                   "id" => $shortname."_fromblog_number",
                   "std" => "9",
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can choose the number of posts you would like to display in the From The Blog Section on the homepage. "),

			array( "name" => "Number of posts in the 'Recent Works' section",
                   "id" => $shortname."_portfolio_number",
                   "std" => "8",
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can choose the number of posts you would like to display in the Recent Works Section on the homepage. "),
			...
			array( "name" => "Gallery Category",
                   ...
                   "et_array_for" => "categories",
			       "options" => $site_cats,
				   "desc" => "Here you can choose the category of posts you would like to display in the Gallery. "),

			array( "name" => "Exclude categories from 'Recent Works' section",
				   "id" => $shortname."_exlcats_recentworks",
				   "type" => "checkboxes",
				   "std" => "",
				   "desc" => "Here you can choose to exclude categories from the Recent Works section on the homepage. ",
				   "usefor" => "categories",
				   "options" => $cats_ids),
			...
			array( "name" => "Exclude categories from homepage recent posts section (in Blog style mode)",
		...
		array( "name" => "general-3",
			...
			array( "name" => "Featured Category",
                   ...
                   "et_array_for" => "categories",
			       "options" => $site_cats,
				   "desc" => "Here you can choose the category of posts you would like to display in the Featured Slider on the homepage. "),
