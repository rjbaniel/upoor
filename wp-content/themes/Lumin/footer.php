...
<?php if (is_front_page() && (get_option('lumin_blog_style') == 'false')) { ?>
			<div id="recent-projects">
				<h3><?php esc_html_e('recent projects','Lumin'); ?></h3>
				<?php $i=1;
				query_posts("posts_per_page=".get_option('lumin_home_projectsnum')."&cat=$projects_cat");
				...
				<a class="readmore" href="<?php echo esc_url( home_url( '/' ) . "?cat=" . get_catid( get_option('lumin_projects_cat') ) ); ?>"><span><?php esc_html_e('enter the gallery &raquo;','Lumin'); ?></span></a>
...
<?php }; ?>
	...
	<div id="footer">
		<div class="container">
			<p><?php esc_html_e('Powered by ','Lumin'); ?> <a href="http://www.wordpress.com">WordPress</a> | <?php esc_html_e('Designed by ','Lumin'); ?> <a href="http://www.elegantthemes.com">Elegant Themes</a></p>
