	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Tagline",
                   ...
                   "type" => "text",
				   "desc" => "Here you can se your tagline on the homepage."),
			...
			array( "name" => "Blog Category",
			       ...
			       "options" => $site_cats,
				   "desc" => "Here you can choose the category of posts you would like to display in the blog page. "),
			...
			array( "name" => "Projects Category",
                   ...
                   "et_array_for" => "categories",
			       "options" => $site_cats,
				   "desc" => "Here you can choose the category of posts you would like to display in the Projects on your homepage. "),
			...
			array( "name" => "Number of Posts displayed on Gallery Category page",
                   ...
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can choose the number of posts you would like to display in the Gallery. "),
...
ultrices et ipsum Integer ligula sed dolor purus"',
			...
			array( "name" => "Content Area 1 Page",
				   ...
				   "std" => "",
				   "type" => "select",
				   "desc" => "Here you can choose the page you would like to display in the content area on the homepage. ",
				   "options" => $site_pages,
				   'et_array_for' => 'pages'),
			...
			array( "name" => "Number of Recent posts in the 'From the Blog' section",
                   ...
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can choose the number of Recent Posts you would like to display in the From the Blog section on the homepage. "),
			...
			array( "name" => "Number of Popular posts in the 'From the Blog' section",
                   ...
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can choose the number of Popular posts in the From the Blog section on the homepage. "),
			...
			array( "name" => "Number of Random posts in the 'From the Blog' section",
                   ...
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can choose the number of Random Posts in the From the Blog section. "),
		...
		array( "name" => "general-3",
			...
			array( "name" => "Pause Autoscroll on hover",
                   ...
                   "type" => "checkbox2",
                   "std" => "false",
                   "desc" => "Here you can choose to Pause Autoscroll on hover. This will pause the slider animation when the mouse hovers over the slider. "),
			...
			array( "name" => "Automatic Animation Speed (in ms)",
                   ...
                   "validation_type" => "number",
			       "std" => "3000",
				   "desc" => "Here you can choose the Animation Speed of the slider in ms. "),
