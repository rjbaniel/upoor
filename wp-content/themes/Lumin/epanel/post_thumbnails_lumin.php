<?php
	...
	$et_post_thumb = sprintf( $et_thumb_size_format,
		intval( get_option( 'lumin_thumbnail_width_posts', 185 ) ),
		intval( get_option( 'lumin_thumbnail_height_posts', 185 ) )
	);
	$et_page_thumb = sprintf( $et_thumb_size_format,
		intval( get_option( 'lumin_thumbnail_width_pages', 185 ) ),
		intval( get_option( 'lumin_thumbnail_height_pages', 185 ) )
	);
	$et_usual_thumb = sprintf( $et_thumb_size_format,
		intval( get_option( 'lumin_thumbnail_width_usual', 155 ) ),
		intval( get_option( 'lumin_thumbnail_height_usual', 155 ) )
	);
	...
	$et_theme_image_sizes = array(
		...
		'571x348' 	=> 'et-featured-big-thumb',
		'80x80' 	=> 'et-featured-small-thumb',
		'123x123' 	=> 'et-footer-small-thumb',
		'377x218' 	=> 'et-footer-big-thumb',
		'595x328' 	=> 'et-single-thumb',
		'44x44' 	=> 'et-fromblog_post-thumb',
	);
