...
<p class="credit"><?php timer_stop(1); ?> <cite><a href="http://wordpress.org/" title="<?php _e('Provided by WordPress, state-of-the-art semantic personal publishing platform');?>"><strong>Wordpress</strong></a></cite></p>
