...
if ( function_exists( 'get_custom_header' ) ) {
	...
	add_action( 'customize_register', 'et_nimble_customize_register' );
	function et_nimble_customize_register( $wp_customize ) {
		...
		$wp_customize->add_control( 'et_nimble[heading_font]', array(
			'label'		=> __( 'Header Font', 'Nimble' ),
			'section'	=> 'et_google_fonts',
			'settings'	=> 'et_nimble[heading_font]',
			'type'		=> 'select',
		...
		$wp_customize->add_control( 'et_nimble[body_font]', array(
			'label'		=> __( 'Body Font', 'Nimble' ),
			'section'	=> 'et_google_fonts',
			'settings'	=> 'et_nimble[body_font]',
			'type'		=> 'select',
			'choices'	=> $font_choices
		) );
	}

	add_action( 'wp_head', 'et_nimble_add_customizer_css' );
	add_action( 'customize_controls_print_styles', 'et_nimble_add_customizer_css' );
