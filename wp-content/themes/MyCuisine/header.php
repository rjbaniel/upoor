						...
						<div id="menu-bar">
							<div id="menu-content" class="clearfix">
								<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
									<?php $logo = (get_option('mycuisine_logo') <> '') ? get_option('mycuisine_logo') : get_template_directory_uri().'/images/logo.png'; ?>
								...
								if ($primaryNav == '') { ?>
									<ul id="<?php echo esc_attr( $menuID ); ?>" class="<?php echo esc_attr( $menuClass ); ?>">
										<?php if (get_option('mycuisine_home_link') == 'on') { ?>
											<li <?php if (is_home()) echo('class="current_page_item"') ?>><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php esc_html_e('Home','MyCuisine') ?></a></li>
										<?php }; ?>
