	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Default", "Blue", "Brown", "Gray", "Green")),
			...
			array( "name" => "Exclude categories from Menu",
				   "id" => $shortname."_exlcats_menupage",
				   "type" => "checkboxes",
				   "std" => "",
				   "desc" => "Here you can choose to exclude categories from the Menu.",
				   "usefor" => "categories",
				   "excludeDefault" => "true",
				   "options" => $cats_ids),
			...
			array( "name" => "Number of posts per category on Menu page",
                   "id" => $shortname."_menu_numposts",
                   "std" => "3",
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can control the number of posts you would like to display in the Menu page. "),
			...
			array( "name" => "Currency Sign",
				   ...
				   "desc" => "Place the Currency symbol here. "),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Use Content Area 1 Page",
                   "id" => $shortname."_use_area1",
                   "type" => "checkbox",
                   "std" => "false",
                   "desc" => "You can use Use Content Area # Page instead of the default content on homepage."),

			array( "name" => "Use Content Area 2 Page",
                   "id" => $shortname."_use_area2",
                   "type" => "checkbox2",
                   "std" => "false",
                   "desc" => "This controls the quote that appears on the homepage 3 blurbs."),
			...
			array( "name" => "Number of Posts in Chef's Recommendations section",
                   "id" => $shortname."_numposts_recommendations",
                   "std" => "3",
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can choose the number of posts you would like to display in the Chef's Recommendations section. "),

			array( "name" => "Exclude categories from Chef's Recommendations",
				   "id" => $shortname."_exlcats_recommendations",
				   "type" => "checkboxes",
				   "std" => "",
				   "desc" => "Here you can choose to exclude categories from the Chef's Recommendations section. ",
				   "usefor" => "categories",
				   "options" => $cats_ids),
			...
			array( "name" => "Address",
                   ...
                   "type" => "text",
                   "validation_type" => "nohtml",
				   "desc" => "Place your Address here. "),

			array( "name" => "MON-FRI ( hours of operation )",
                   "id" => $shortname."_mon_fri",
                   "std" => "8am-6pm",
                   "type" => "text",
                   "validation_type" => "nohtml",
				   "desc" => "Place the hours of operation here. "),

			array( "name" => "SAT-SUN ( hours of operation )",
                   "id" => $shortname."_sat_sun",
                   "std" => "8am-10pm",
                   "type" => "text",
                   "validation_type" => "nohtml",
				   "desc" => "Place the hours of operation here. "),
			...
			array( "name" => "Email Address",
                   ...
                   "type" => "text",
                   "validation_type" => "nohtml",
				   "desc" => "Place the email address here. "),
			...
			array( "name" => "Telephone",
                   ...
                   "type" => "text",
                   "validation_type" => "nohtml",
				   "desc" => "Place the Telephone number here. "),
			...
			array( "name" => "Fax",
                   ...
                   "type" => "text",
                   "validation_type" => "nohtml",
				   "desc" => "Place the Fax number here. "),

			array( "name" => "Content Area 1 Page",
				   "id" => $shortname."_home_page_1",
				   "std" => "",
				   "type" => "select",
				   "desc" => "Here you can choose the page you would like to use in the content area on the homepage. ",
				   "options" => $site_pages,
				   'et_array_for' => 'pages'),
			...
			array( "name" => "Quote Line 1",
                   "id" => $shortname."_quote_line1",
                   "std" => '"Your awesome company slogan goes here, we have the best food around"',
                   "type" => "text",
				   "desc" => "Here you can define the text that appears in the homepage quote."),

			array( "name" => "Quote Line 2",
                   "id" => $shortname."_quote_line2",
                   "std" => "Unc elementum lacus in gravida pellentesque urna dolor eleifend felis eleifend",
                   "type" => "text",
				   "desc" => "Here you can define the text that appears in the homepage quote."),

			array( "name" => "Menu Page Url",
                   "id" => $shortname."_menu_page_url",
                   "std" => "#",
                   "type" => "text",
                   "validation_type" => "url",
				   "desc" => "Here you can define the menu page url for homepage footer menu button."),
