...
<div id="optionswindow" style="visibility:hidden;">
	...
	<tr>
		<td class="optbuttons">
			<input type="submit" id="submit" value="<?php echo esc_attr(__('Save', 'k2_domain')); ?>" class="button-secondary" />
			<input type="submit" id="submitclose" value="<?php echo esc_attr(__('Save &amp; Close', 'k2_domain')); ?>" class="button-primary" />
		</td>
	</tr>
