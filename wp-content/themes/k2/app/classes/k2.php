...
class K2 {
	...
	function add_options_menu() {
		$page = add_theme_page(__('K2 Options','k2_domain'), __('K2 Options','k2_domain'), 'edit_theme_options', 'k2-options', array('K2', 'admin'));

		add_action( "admin_head-$page", array('K2', 'admin_head') );
		add_action( "load-$page", array('K2', 'add_help_tab') );
		add_action( "admin_print_scripts-$page", array('K2', 'admin_print_scripts') );
	}
	
	function add_help_tab() {
		get_current_screen()->add_help_tab(array('id' => 'k2-admin-help-tab-1', 'title' => 'K2', 'content' =>
				'<p><a href="http://groups.google.com/group/k2-support/">' .  __('K2 Support Group', 'k2_domain') . '</a><br />' .
				'<a href="http://code.google.com/p/kaytwo/issues/list">' .  __('K2 Bug Tracker', 'k2_domain') . '</a><br /></p>'
				));
	}
