...
class K2Header {
	function init() {
		...
		if ( extension_loaded('gd') && function_exists('gd_info') ) {
			add_theme_support( 'custom-header', array( 'wp-head-callback' => array('K2Header', 'output_header_css'), 'admin-head-callback' => array('K2Header', 'output_admin_header_css')));
		}
	}

	function install() {
		add_option('k2headerimage', '');
		add_option('k2blogornoblog', 'Blog');
	}
