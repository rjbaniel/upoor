	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Default", "Blue", "Green", "Lights", "Purple", "Radiate", "Wooden")),
			...
			array( "name" => "Submit Answer Page",
				   "id" => $shortname."_answer_page",
				   "std" => "",
				   "type" => "select",
				   "desc" => "Here you can choose the page you created with the Register Page Template as instructed in the readme. ",
				   "options" => $site_pages,
				   'et_array_for' => 'pages'),
