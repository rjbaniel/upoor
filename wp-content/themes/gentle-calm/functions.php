...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'gentle-calm');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
load_theme_textdomain('gentle-calm', TEMPLATEPATH . '/languages/');
...
<?php } ?>&nbsp;&nbsp;<?php comment_author_link() ?></span>
</div>
					...
					<div class="commentinfo">
						<span class="commentdate">
							...
							<a href="#comment-<?php comment_ID() ?>" title="<?php _e('comment link url','gentle-calm'); ?>"><?php comment_time() ?></a>&nbsp;&nbsp;&nbsp;<?php edit_comment_link(__('edit','gentle-calm'),'',''); ?>&nbsp;&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?>
						</span>
					</div>
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'gentle_admin_header_style'));
