	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Black", "Blue", "Light", "Red")),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Display Recent From Categories posts",
                   "id" => $shortname."_recent_fromcat_display",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to display Recent From Categories Posts. "),
			...
			array( "name" => "Recent From Category 1",
			       ...
			       "options" => $site_cats,
				   "desc" => "Choose the category below. "),
