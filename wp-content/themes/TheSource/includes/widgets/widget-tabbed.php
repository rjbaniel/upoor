...
<div id="tabbed-area">
	...
	<div id="all_tabs" class="clearfix">
		<div class="widget popular">
			<ul>
				<?php query_posts("posts_per_page=$postsNumRecent&ignore_sticky_posts=1");
		...
		<div class="widget popular">
			<ul>
				<?php query_posts("posts_per_page=$postsNumRandom&caller_get_posts=1&orderby=rand");
					if (have_posts()) : while (have_posts()) : the_post(); ?>
						<?php get_template_part('includes/widgets/custom_post'); ?>
					<?php endwhile;
					endif; wp_reset_query(); ?>
...
<?php
  ...
  /*Creates the form for the widget in the back-end. */
    function form($instance){
		...
		$postsNumRecent = (int) $instance['postsNumRecent'];
		$postsNumPopular = (int) $instance['postsNumPopular'];
		$postsNumRandom = (int) $instance['postsNumRandom'];
