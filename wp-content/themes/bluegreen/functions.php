...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'bluegreen');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
load_theme_textdomain('bluegreen', TEMPLATEPATH . '/languages/');
...
<li <?php comment_class(); ?> id="comment-<?php comment_ID(); ?>">
		...
		<p style="margin-bottom:5px;"><?php if (function_exists('avatar_display_comments')) { ?>
...
<?php } ?>&nbsp;&nbsp;By <strong><?php comment_author_link() ?></strong> on <a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('M j, Y') ?></a> | <?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?><?php edit_comment_link(__('Edit','bluegreen'),' | ',''); ?></p>
		<?php if ($comment->comment_approved == '0') : ?>
		<em><?php _e('Your comment is awaiting moderation.', 'bluegreen');?></em>
		<?php endif; ?>
		<?php comment_text() ?>
...
function bluegreen_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'bluegreen_admin_header_style'));
