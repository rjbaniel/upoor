...
$pages_ids = array();
$cats_ids = array();
$wp_ecommerce_normal_categories = array();
...
if ( $boutique_active_plugin_name == 'wp_ecommerce' ){
	...
	add_post_type_support( 'wpsc-product', 'comments' );
	add_post_type_support( 'wpsc-product', 'custom-fields' );

	$et_ecommerce_caterogies = get_terms('wpsc_product_category');
	$site_cats = array();
	$cats_ids = array();
	foreach ( $et_ecommerce_caterogies as $ecommerce_caterogy ){
		$site_cats[$ecommerce_caterogy->term_id] = $ecommerce_caterogy->name;
		$cats_ids[] = $ecommerce_caterogy->term_id;
	}
}

$wp_ecommerce_normal_categories_ids = $cats_ids;
...
$options = array (
	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Select Categories used for Blog",
				   "id" => $shortname."_blog_categories",
				   "type" => "checkboxes",
				   "std" => '',
				   "desc" => "All categories are used for Blog, if you use WP e-Commerce plugin",
				   "usefor" => "categories",
				   "excludeDefault" => "true",
				   "options" => $cats_ids),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Display 'Special Offers'",
                   "id" => $shortname."_special_offers",
                   "type" => "checkbox",
				   "std" => "on",
				   "desc" => "Here you can choose to display Special Offers on the homepage. "),

			array( "type" => "clearfix",),

			array( "name" => "'Special Offers' Category",
                   "id" => $shortname."_special_offers_category",
                   "type" => "select",
			       "options" => $site_cats,
			       "et_array_for" => "categories",
				   "desc" => "Here you can choose the category you would like to display in the Special Offers area on the homepage. "),

			array( "name" => "Number of 'Special Offers' Items",
                   "id" => $shortname."_special_offers_numposts",
                   "std" => "5",
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can choose the number of Special Offers items you would like to display on the homepage. "),

			array( "name" => "Special Offers Heading Text",
                   "id" => $shortname."_special_offers_heading",
                   "std" => "Special Offers",
                   "type" => "text",
				   "desc" => "You can use this text area to create a custom heading text for the Special Offers heading on the homepage. "),

			array( "name" => "Recent Products Heading Text",
                   "id" => $shortname."_recent_products_heading",
                   "std" => "Recent Products",
                   "type" => "text",
				   "desc" => "You can use this text area to create a custom heading text for the Recent Products heading on the homepage. "),
			...
			array( "name" => "Exclude categories from homepage recent posts",
				   ...
				   "usefor" => "taxonomy_terms",
				   "taxonomy_name" => $boutique_active_plugin_name == 'wp_ecommerce' ? "wpsc_product_category" : "category",
				   "options" => $wp_ecommerce_normal_categories_ids),
