...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN','waterlily');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
<div class="comment-author"><?php if (function_exists('avatar_display_comments')) { ?>
...
<?php } ?>&nbsp;&nbsp;<?php comment_author_link() ?> <?php _e('says',TEMPLATE_DOMAIN);?>: </div>
...
<span class="commentmetadata"><?php comment_date() ?> @ <?php comment_time(); ?> <?php edit_comment_link('e','',''); ?>&nbsp;&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?></span>
