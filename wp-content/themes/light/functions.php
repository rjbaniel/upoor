...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'light');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
<?php } ?>&nbsp;&nbsp;  <?php comment_author_link()?>
        <?php _e('on',TEMPLATE_DOMAIN);?> <?php comment_date('F jS, Y') ?>
...
function light_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'light_admin_header_style'));
