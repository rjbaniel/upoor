...
<div class="big_post" id="post_<?php echo esc_attr( $i ); ?>">

	<img class="next" src="<?php echo get_template_directory_uri(); ?>/images/<?php echo esc_attr($colorSchemePath); ?>arrow.gif" alt="next page" />
	<img class="previous" src="<?php echo get_template_directory_uri(); ?>/images/<?php echo esc_attr($colorSchemePath); ?>previous.gif" alt="next page" />
	...
	<img class="close" src="<?php echo get_template_directory_uri(); ?>/images/close.png" alt="close" />
	...
	<?php if ($postType == 'video') { ?>
		<div class="video-wrap">
			...
			$video_width = isset($custom["video_width"][0]) ? (int) $custom["video_width"][0] : '526';
			$video_height = isset($custom["video_height"][0]) ? (int) $custom["video_height"][0] : '351'; ?>
	...
	<?php if ($postType == 'photo') { ?>
		...
		<div class="black">
			<a class="lightbox fancybox" href="<?php echo $thumbnail["fullpath"];?>" rel="gallery" title="<?php echo $titletext; ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/shadow-overlay.png" alt="thumbnail" style="position: absolute; top: 0; left: 0; border: none;" /></a>
				<?php print_thumbnail($thumb, $thumbnail["use_timthumb"], $titletext , $width, $height, $classtext); ?>
			<img src="<?php echo get_template_directory_uri(); ?>/images/zoom.png" alt="zoom" class="zoom" />
		</div> <!-- end .black -->
		<span class="post_bottom"></span>
	<?php }; ?>
