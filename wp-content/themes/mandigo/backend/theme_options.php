	...
	function mandigo_options_page() {
		...
		if (isset($_POST['updated'])) {
			...
			foreach ($_POST as $field => $value) {
				if (preg_match("/header_navigation_exclude_page_(\d+)/", $field, $id))
					$header_navigation_exclude_pages[] = $id[1];
...
*/
		...
		<form name="mandigo_options_form" method="post" action="?page=Theme-Options">
