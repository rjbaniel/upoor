...
<?php
	...
	if (function_exists('wp_register_sidebar_widget'))
		wp_register_sidebar_widget('mandigo_search_1', 'Search', 'widget_mandigo_search');
...
<?php
	...
	// if wp supports widgets, register it (make it available)
	if (function_exists('wp_register_sidebar_widget'))
		wp_register_sidebar_widget('mandigo_calendar_1', 'Calendar', 'widget_mandigo_calendar');
	...
	function widget_mandigo_meta() {
		...
		$tag_widget_title = isset($tag_widget_title)?$tag_widget_title:'h4';
?>
				<li>
					<<?php echo $tag_widget_title; ?> class="widgettitle"><?php echo (isset($options['title']) && $options['title'] ? $options['title'] : __('Meta','mandigo')); ?></<?php echo $tag_widget_title; ?>>
...
<?php
		...
		if ($wpmu) {
?>
						<li><a href="http://mu.wordpress.org/" title="Provided by WordPress MU, state-of-the-art semantic personal publishing platform.">WordPress MU</a></li>
<?php
		}
...
<?php
	...
	// if wp supports widgets, register it (make it available)
	if (function_exists('wp_register_sidebar_widget'))
		wp_register_sidebar_widget('mandigo_meta_1', 'Meta', 'widget_mandigo_meta');
?>
