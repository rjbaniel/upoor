...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'greenday');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
load_theme_textdomain('greenday', TEMPLATEPATH . '/languages/');
...
<?php } ?>&nbsp;&nbsp;<cite><?php comment_author_link() ?></cite> <?php _e('Says','greenday');?>:
			<?php if ($comment->comment_approved == '0') : ?>
			<em><?php _e('Your comment is awaiting moderation.','greenday');?></em>
			<?php endif; ?>
			<br />

			<small class="commentmetadata"><a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('F jS, Y') ?> <?php _e('at','greenday');?> <?php comment_time() ?></a> <?php edit_comment_link('e','',''); ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?></small>
...
function greenday_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'greenday_admin_header_style'));



if ( function_exists('wp_register_sidebar_widget') )
    wp_register_sidebar_widget('greenday_recent-posts_1', __('Recent Posts'), 'widget_greenday_recent_entries');
