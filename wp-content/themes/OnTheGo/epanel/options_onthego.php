	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Blue", "Brown", "Green", "Purple")),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Content Area Page",
				   "id" => $shortname."_home_page_1",
				   "std" => "",
				   "type" => "select",
				   "desc" => "Here you can choose which page will be displayed on your Homepage if you are not using BlogStyle mode.",
				   "options" => $site_pages,
				   'et_array_for' => 'pages'),
			...
			array( "name" => "Number of Recent posts in the 'From the Blog' section",
                   ...
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "On the homepage there is a tabbed menu were recent posts from your Blog category are displayed. Here you can choose how many posts are displayed in the Recent Posts tab."),
			...
			array( "name" => "Number of Popular posts in the 'From the Blog' section",
                   ...
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "On the homepage there is a tabbed menu were recent posts from your Blog category are displayed. Here you can choose how many posts are displayed in the Popular Posts tab."),
			...
			array( "name" => "Number of Random posts in the 'From the Blog' section",
                   ...
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "On the homepage there is a tabbed menu were recent posts from your Blog category are displayed. Here you can choose how many posts are displayed in the Random Posts tab."),
