				...
				<div id="et_pt_blog">
					...
					<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
						...
						<div class="et_pt_blogentry clearfix">
							...
							<p class="et_pt_blogmeta"><?php esc_html_e('Posted','OnTheGo'); ?> <?php esc_html_e('by','OnTheGo'); ?> <?php the_author_posts_link(); ?> <?php esc_html_e('on','OnTheGo'); ?> <?php the_time(get_option('onthego_date_format')) ?> <?php esc_html_e('in','OnTheGo'); ?> <?php the_category(', ') ?> | <?php comments_popup_link(esc_html__('0 comments','OnTheGo'), esc_html__('1 comment','OnTheGo'), '% '.esc_html__('comments','OnTheGo')); ?></p>
							...
							<?php if (!$et_ptemplate_blogstyle) { ?>
								...
								<a href="<?php the_permalink(); ?>" class="readmore"><span><?php esc_html_e('read more','OnTheGo'); ?></span></a>
							<?php } else { ?>
								<?php
									global $more;
									$more = 0;
