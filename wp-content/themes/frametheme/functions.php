...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'frametheme');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
load_theme_textdomain('frame', TEMPLATEPATH . '/languages/');
...
<?php } else { ?><?php if (function_exists('get_avatar')) { echo get_avatar( get_comment_author_email() , 48 ); } ?><?php } ?>&nbsp;&nbsp; <?php comment_author_link() ?> &#8212; <?php comment_date() ?> @ <a href="#comment-<?php comment_ID() ?>"><?php comment_time() ?></a> <?php edit_comment_link(__("Edit This"), ' |&nbsp;&nbsp;'); ?>&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?></cite>
...
define('HEADER_TEXTCOLOR', '#F6FFB7');
define('HEADER_IMAGE', '%s/images/top.jpg'); // %s is theme dir uri
define('HEADER_IMAGE_WIDTH', 729); //width is fixed
define('HEADER_IMAGE_HEIGHT', 150);


function frame_admin_header_style() { ?>
<style type="text/css">
#headimg { background: url(<?php header_image() ?>) repeat; }
#headimg { height: <?php echo HEADER_IMAGE_HEIGHT; ?>px; width: <?php echo HEADER_IMAGE_WIDTH; ?>px; }
</style>
<?php }

add_theme_support( 'custom-header', array('admin-head-callback' => 'frame_admin_header_style'));
