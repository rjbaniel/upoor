...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'iblog');

function iblog_footer_link() { ?>
<div id="cred"><?php if( SHOW_AUTHORS != 'false') { ?><div class="designer fix"><a class="pagelines" href="http://www.pagelines.com/themes/" title="Pagelines Theme Designs"><a href="http://www.pagelines.com" alt="pagelines.com">Pagelines Design</a> +</div> &nbsp;<?php } ?><?php if(function_exists('get_current_site')) { $current_site = get_current_site();  $current_network_site = get_current_site_name(get_current_site());  ?><?php _e('Hosted by', 'iblog'); ?> <a title="<?php echo $current_network_site->site_name; ?>" target="_blank" href="http://<?php echo $current_site->domain . $current_site->path ?>"><?php echo $current_network_site->site_name; ?></a>
<?php } ?>
</div>
<?php }
...
load_theme_textdomain('iblog', TEMPLATEPATH . '/languages/');
...
wp_register_sidebar_widget('iblog_search_1', __('Search','iblog'), 'widget_iblog_search');
}

function widget_iblog_meta() { ?>
	<!--sidebox start -->
	<div id="meta" class="dbx-box">
	  <h3 class="dbx-handle"><?php _e('Meta','iblog'); ?></h3>
	  <div class="dbx-content">
	    <ul>
	        ...
	        <li class="wordpress"><a href="http://www.wordpress.org" title="Provided by WordPress">WordPress</a></li>
...
if ( function_exists('wp_register_sidebar_widget') ) {
wp_register_sidebar_widget('iblog_meta_1', __('Meta','iblog'), 'widget_iblog_meta');
}


function widget_iblog_links() { ?>
	<!--sidebox start -->
	<div id="links" class="dbx-box">
	  <h3 class="dbx-handle"><?php _e('Links','iblog'); ?></h3>
	  <div class="dbx-content">
	    <ul>
	      <?php get_bookmarks('-1', '<li>', '</li>', '<br />', FALSE, 'id', FALSE, FALSE, -1, FALSE); ?>
	    </ul>
	  </div>
	</div>
	<!--sidebox end -->
...
if ( function_exists('wp_register_sidebar_widget') ) { ?>
<?php wp_register_sidebar_widget('iblog_links_1', __('Links','iblog'), 'widget_iblog_links'); ?>
<?php }
...
<?php } ?>
			...
			<cite><?php comment_author_link() ?></cite> <?php _e('Says:', 'iblog'); ?>

			<?php if ($comment->comment_approved == '0') : ?>

			<em><?php _e('Your comment is awaiting moderation.', 'iblog'); ?></em>

			<?php endif; ?>

			<br />

			<small class="commentmetadata"><a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('F jS, Y') ?> at <?php comment_time() ?></a> <?php edit_comment_link('e','',''); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?></small>
...
function iblog_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'iblog_admin_header_style'));
