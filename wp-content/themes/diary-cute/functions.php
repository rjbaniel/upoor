...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'diary-cute');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
load_theme_textdomain('diary-cute', TEMPLATEPATH . '/languages/');
...
if ( function_exists('register_sidebar') ) {
	register_sidebar(array(
		'before_widget' => '<div id="%1$s" class="widget %2$s tabshow1-t"></div><div class="contentlist1">',
...
define('HEADER_IMAGE_WIDTH', 680); //width is fixed
define('HEADER_IMAGE_HEIGHT', 200);
define('NO_HEADER_TEXT', true );

function diary_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'diary_admin_header_style'));
