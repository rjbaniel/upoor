...
// Do not delete these lines
	...
	if (!empty($_SERVER['SCRIPT_FILENAME']) && 'comments.php' == basename($_SERVER['SCRIPT_FILENAME']))
		...
		die (__('Please do not load this page directly. Thanks!', 'diary-cute'));



	if ( post_password_required() ) { ?>

		<p class="nocomments"><?php _e('This post is password protected. Enter the password to view comments.', 'diary-cute'); ?></p>
...
<?php if ( have_comments() ) : ?>
	...
	<h3 id="comments"><?php comments_number(__('No Responses', 'diary-cute'), __('One Response', 'diary-cute'), __('% Responses', 'diary-cute') );?> to &#8220;<?php the_title(); ?>&#8221;</h3>
 ...
 <?php else : // this is displayed if there are no comments so far ?>
	...
	<?php if ('open' == $post->comment_status) : ?>
	 ...
	 <?php else : // comments are closed ?>
		...
		<p class="nocomments"><?php _e('Comments are closed.', 'diary-cute'); ?></p>
...
<?php if ($comments) : ?>
	...
	<?php foreach ($comments as $comment) : ?>
				...
				<?php if (get_comment_type() == 'comment'){ ?>
					...
					<div id="comment-<?php comment_ID() ?>" class="<?php if ($comment->comment_author_email == get_the_author_meta('email')) echo 'author'; else echo $oddcomment; ?> message-content">
  ...
  <?php if ('open' == $post-> comment_status) : ?> 
	 ...
	 <?php else : /* comments are closed */ ?>
		...
		<!-- If comments are closed. -->
					...
					<p class="nocomments"><?php _e('Comments are closed at this time.', 'diary-cute'); ?></p>
...
<div class="backtotop"><a class="scroll" href="#menu"><?php _e('Back to top', 'diary-cute'); ?></a></div>
...
<?php if ('open' == $post->comment_status) : ?>
					...
					<div id="response">
						...
						<h4 id="respond"><?php _e('Leave a reply', 'diary-cute'); ?></h4>
...
<?php endif; ?>
								...
								<div class="submit"><input type="submit" name="submit" id="submit" tabindex="5" value="<?php _e('Submit', 'diary-cute'); ?>" /><input type="hidden" name="comment_post_ID" value="<?php echo $id; ?>" /></div>
