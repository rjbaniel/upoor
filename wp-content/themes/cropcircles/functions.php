...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'cropcircles');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
load_theme_textdomain('cropcircles', TEMPLATEPATH . '/languages/');
...
<?php } ?>&nbsp;&nbsp;<?php comment_author_link() ?></cite> Says:
			<?php if ($comment->comment_approved == '0') : ?>
			<em><?php _e('Your comment is awaiting moderation.','cropcircles'); ?></em>
			<?php endif; ?>
			<br />

			<small class="commentmetadata"><a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('F jS, Y') ?> <?php _e('at','cropcircles'); ?> <?php comment_time() ?></a> <?php edit_comment_link(__('edit','cropcircles'),'&nbsp;&nbsp;',''); ?>&nbsp;&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?></small>
