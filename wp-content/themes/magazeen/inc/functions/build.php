						...
						<?php foreach ($options as $value) { ?>
							...
							?>
								...
								<tr valign="top">
									...
									<td>
										<textarea name="<?php echo $value['id']; ?>" id="<?php echo $value['id']; ?>" cols="90" rows="4"><?php if ( get_option( $value['id'] ) != "") { echo stripslashes( get_option( $value['id'] ) ); } else { echo stripslashes( $value['std'] ); } ?></textarea>
										<p class="setting-description"><?php echo $value['description']; ?></p>
									</td>
									<td align="right">
										<?php if( $value['icon'] != "" ) : ?>
