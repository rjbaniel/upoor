<?php
	...
	$et_post_thumb = sprintf( $et_thumb_size_format,
		intval( get_option( 'cion_thumbnail_width_posts', 200 ) ),
		intval( get_option( 'cion_thumbnail_height_posts', 200 ) )
	);
	$et_page_thumb = sprintf( $et_thumb_size_format,
		intval( get_option( 'cion_thumbnail_width_pages', 200 ) ),
		intval( get_option( 'cion_thumbnail_height_pages', 200 ) )
	);
	$et_usual_thumb = sprintf( $et_thumb_size_format,
		intval( get_option( 'cion_thumbnail_width_index', 150 ) ),
		intval( get_option( 'cion_thumbnail_height_index', 150 ) )
	);
