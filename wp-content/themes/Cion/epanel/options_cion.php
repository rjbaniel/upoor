	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Purple", "Blue", "Green")),
		...
		array( "name" => "general-2",
			...
			array(  "name" => "Number of Random Articles displayed in the homepage tabbed menu",
            		"id" => $shortname."_random_count",
            		"std" => "5",
            		"type" => "text",
            		"validation_type" => "number",
 					"desc" => "Here you can designate how many random articles are displayed in the homepage tabbed menu."),

			array(  "name" => "Number of Popular Articles displayed in the homepage tabbed menu",
            		"id" => $shortname."_popular_count",
            		"std" => "5",
            		"type" => "text",
            		"validation_type" => "number",
 					"desc" => "Here you can designate how many popular articles are displayed in the homepage tabbed menu."),

			array(  "name" => "Number of Recent Comments displayed in the homepage tabbed menu",
            		"id" => $shortname."_comment_count",
            		"std" => "5",
            		"type" => "text",
            		"validation_type" => "number",
 					"desc" => "Here you can designate how many recent comments are displayed in the homepage tabbed menu."),

			array(  "name" => "Number of Recent Articles displayed in the homepage tabbed menu",
            		"id" => $shortname."_recent_count",
            		"std" => "5",
            		"type" => "text",
            		"validation_type" => "number",
 					"desc" => "Here you can designate how many recent articles are displayed in the homepage tabbed menu."),

			array(  "name" => "About Me text",
            		"id" => $shortname."_about",
            		"std" => "Consectetuer rutrum urna in, a molestie aliquam gravida, quam vestibulum ac. Consequa't ut lacus tempus a ipsum, sociis urna sed, vel tellus maecenas nec, lorem maecena's tortor. At odio platea etiam. Euismod libero pretium accumsan pellentesque ac. Quam semper in vitae dictum eget, ipsum magna orci odio lectus.",
            		"type" => "textarea",
 					"desc" => "On the homepage of Cion there is an About Me section. You can enter the text you would like to appear in that block here."),
			...
			array(  "name" => "About Me image",
            		...
            		"type" => "text",
            		"validation_type" => "url",
 					"desc" => "On the homepage of Cion there is an About Me section. Enter the URL to the image you would like to use in the About Me block here. The image must be hosted on this domain."),
		...
		array( "name" => "general-3",
			...
			array( "name" => "Featured Category",
			       ...
			       "options" => $site_cats,
				   "desc" => "Here you can choose the category you would like to use for your Featured Articles on the homepage.  "),
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "wrap-layout",
		...
		array( "name" => "layout-1",
			...
			array( "name" => "Enable Share This Button",
				   "id" => $shortname."_share_this",
				   	"type" => "checkbox",
				   "std" => "on",
				   "desc" => "Enabling this option will display a Share This button on post pages that, when clicked, reveals a list of social networking sites that your post can be promoted at.",),
		...
		array( "name" => "layout-2",
			...
			array( "name" => "Enable Share This Button",
				   "id" => $shortname."_share_this_pages",
				   	"type" => "checkbox",
				   "std" => "on",
				   "desc" => "Enabling this option will display a Share This button on post pages that, when clicked, reveals a list of social networking sites that your post can be promoted at.",),
		...
		array( "name" => "layout-3",
			...
			array( "name" => "Choose which items to display in the postinfo section",
				   ...
				   "type" => "different_checkboxes",
				   "std" => array("author","date","categories","comments"),
				   "desc" => "Here you can choose which items appear in the postinfo section on sindex pages. This is the area, usually below the post title, which displays basic information about your post. The highlighted itmes shown below will appear. ",
				   "options" => array("author","date","categories","comments")),

			array( "name" => "Place Thumbs on Index",
                   "id" => $shortname."_index_thumbnails",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "To enable thumbnails on index pages (categories, serach results, archives, etc, enable this option. "),
		...
		array( "name" => "layout-4",
			...
			array( "name" => "Choose which items to display in the postinfo section",
				   "id" => $shortname."_postinfo3",
				   "type" => "different_checkboxes",
				   "std" => array("author","date","categories","comments"),
				   "desc" => "Here you can choose which items appear in the postinfo section on the homepage. This is the area, usually below the post title, which displays basic information about your post. The highlighted itmes shown below will appear. ",
				   "options" => array("author","date","categories","comments")),
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "wrap-colorization",
		...
		array( "name" => "colorization-1",
			...
			array( "name" => "Readmore Link Color",
				   "id" => $shortname."_color_readmore",
				   "type" => "textcolorpopup",
				   "std" => "",
				   "desc" => "This option allows you to customize the color of a certain element of the theme. When you click inside the field a color picker will appear. Scroll to find your desired color and then click the circular submit button on the lower right to accept the value",),
