	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Default", "Green", "Purple", "Red", "Teal")),
			...
			array( "name" => "Blog Category",
			       ...
			       "options" => $site_cats,
				   "desc" => "Here you can choose the category you would like to display in the Blog section on the homepage. "),
		...
		array( "name" => "general-2",
			...
			array( "name" => "About us Page",
			   ...
			   "std" => "",
			   "type" => "select",
			   "desc" => "Here you can choose the page you would like to display in the About us section on the homepage. ",
			   "options" => $site_pages,
			   'et_array_for' => 'pages'),

			array( "name" => "Number of Blog Posts",
                   "id" => $shortname."_blog_postsnum",
                   "std" => "3",
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can choose the number of posts you would like to display in the Blog section of the homepage. "),

			array( "name" => "Number of Posts displayed on Homepage (in Blog style mode)",
                   "id" => $shortname."_homepage_postsnum",
                   "std" => "10",
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can choose the number of posts you would like to display on the homepage. This setting will only be in effect when blog style mode is enabled. "),
