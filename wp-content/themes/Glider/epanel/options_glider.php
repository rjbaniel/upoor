	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Blog Category",
			       ...
			       "options" => $site_cats,
				   "desc" => "Here you can choose the category you would like to display in the Blog section. "),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Show these pages on Homepage",
				   ...
				   "type" => "checkboxes",
				   "std" => '',
				   "desc" => "Here you can choose the pages you would like to display on the navigation of the homepage. ",
				   "usefor" => "pages",
				   "excludeDefault" => "true",
				   "options" => $pages_ids),
