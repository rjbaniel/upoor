...
$options = array (
	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-2",
			...
			array( "name" => esc_html__("Number of Posts displayed on Homepage",$themename),
				   "id" => $shortname."_homepage_posts",
				   "std" => "8",
				   "type" => "text",
				   "desc" => esc_html__("Here you can designate how many recent articles are displayed on homepage. This option works independently from the Settings > Reading options in wp-admin.",$themename),
				   "validation_type" => "number"
			),
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "wrap-layout",
		...
		array( "name" => "layout-1",
			...
			array( "name" => esc_html__("Show Author Avatar and Share Buttons on Single Posts",$themename),
				   "id" => $shortname."_show_avatar_share_on_posts",
				   "type" => "checkbox",
				   "std" => "on",
				   "desc" => esc_html__("Enable this option to show the post author avatar and share buttons on Single Posts.",$themename)
			),
