...
?>
						...
						$attachment_size = apply_filters( 'fable_attachment_size', array( 960, 960 ) );
				...
				<div id="image-navigation" class="navigation clearfix">
					<span class="previous-image"><?php previous_image_link( false, __( '&larr; Previous', 'Fable' ) ); ?></span>
					<span class="next-image"><?php next_image_link( false, __( 'Next &rarr;', 'Fable' ) ); ?></span>
