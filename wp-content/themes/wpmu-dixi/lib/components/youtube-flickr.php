...
$video_save_misc = $_POST['video_save_misc'];
...
<textarea<?php if($the_profile_video_misc != "") { ?> class="save"<?php } ?> id="video_save_misc" name="video_save_misc" value="<?php echo $the_profile_video_misc; ?>" /> </textarea>
