...
$twitter_title = isset($instance['title']) ? $instance['title'] : '';
...
global $wpdb, $bp_existed, $comment;

$sql = "SELECT DISTINCT ID, post_title, post_password, comment_ID,
comment_post_ID, comment_author, comment_author_email, comment_date_gmt, comment_approved,
comment_type,comment_author_url,
SUBSTRING(comment_content,1,80) AS com_excerpt, user_id
FROM $wpdb->comments
...
function form($instance) {
// Get the options into variables, escaping html characters on the way
$fli_name = isset($instance['title']) ? $instance['title'] : '';
...
///////////////////////////////////////////////////////////////////////////////////
class My_WPMUDEV_BP_Searchform_Widget extends WP_Widget {
function My_WPMUDEV_BP_Searchform_Widget() {
//Constructor
...
function form($instance) {
// Get the options into variables, escaping html characters on the way
$bps_name = isset($instance['title']) ? $instance['title'] : '';
?>
<p>
...
register_widget('My_WPMUDEV_BP_Searchform_Widget');
...
?>
<div style="margin: 0px 5px 5px 0px; float: left;" class="item-avatar"><a title="<?php echo $group->name . ' - ' . short_text($group_description, 150); ?>" href="<?php echo home_url() . '/' . bp_get_root_slug( 'groups' ) . '/' . $group->slug; ?>">
...
///////////////////////////////////////////////////////////////////////////////////
class My_WPMUDEV_BP_Random_Groups_Widget extends WP_Widget {
function My_WPMUDEV_BP_Random_Groups_Widget() {
//Constructor
parent::WP_Widget(false, $name = TEMPLATE_DOMAIN . ' | BuddyPress Random Groups', array(
...
function form($instance) {
// Get the options into variables, escaping html characters on the way
$rg_name = isset($instance['title']) ? $instance['title'] : '';
?>
<p>
<label for="<?php echo $this->get_field_id('title'); ?>"><?php  _e('Name',TEMPLATE_DOMAIN); ?>:</label>
...
<?php } }
register_widget('My_WPMUDEV_BP_Random_Groups_Widget');
} } //end bp check
