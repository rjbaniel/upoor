...
$options = apply_filters ( 'et_default_options', array (
	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Default", "Black", "Green", "Purple","Red")),
			...
			array( "name" => "Blog Category",
                   ...
                   "type" => "select",
			       "options" => $site_cats,
				   "desc" => "Here you can choose the category you would like to display in the blog. "),
		...
		array( "name" => "general-4",
			...
			array( "name" => "Show 'Browse Listings' Widget",
                   "id" => $shortname."_listings",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to display the Browse Listings Widget on the homepage. "),

			array( "type" => "clearfix",),

			array( "name" => "Include categories into Listings 1 options",
				   "id" => $shortname."_listings1",
				   "type" => "checkboxes",
				   "std" => "",
				   "desc" => "Here you can choose the categories you would like to disaply in the Listings widget.",
				   "usefor" => "categories",
				   "excludeDefault" => 'true',
				   "options" => $cats_ids),

			array( "name" => "Include categories into Listings 2 options",
				   "id" => $shortname."_listings2",
				   "type" => "checkboxes",
				   "std" => "",
				   "desc" => "Here you can choose the categories you would like to disaply in the Listings widget.",
				   "usefor" => "categories",
			...
			array( "name" => "Include categories into Listings 3 options",
				   "id" => $shortname."_listings3",
				   "type" => "checkboxes",
				   "std" => "",
				   "desc" => "Here you can choose the categories you would like to disaply in the Listings widget.",
				   "usefor" => "categories",
			...
			array( "name" => "Include categories into Listings 4 options",
				   "id" => $shortname."_listings4",
				   "type" => "checkboxes",
				   "std" => "",
				   "desc" => "Here you can choose the categories you would like to disaply in the Listings widget.",
				   "usefor" => "categories",
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "wrap-layout",
		...
		array( "name" => "layout-1",
			...
			array( "name" => "Contact Agent Url",
            "id" => $shortname."_contact_agent",
            "type" => "text",
            "validation_type" => "url",
            "std" => "#",
			"desc" => "You can use this field to specify an external URL that you would like to link to. "),
