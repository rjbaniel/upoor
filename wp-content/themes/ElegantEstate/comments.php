...
// Do not delete these lines
	if (!empty($_SERVER['SCRIPT_FILENAME']) && 'comments.php' == basename($_SERVER['SCRIPT_FILENAME']))
		die (esc_html__('Please do not load this page directly. Thanks!','ElegantEstate'));

	if ( post_password_required() ) { ?>

<p class="nocomments"><?php esc_html_e('This post is password protected. Enter the password to view comments.','ElegantEstate') ?></p>
<?php
		return;
	}
?>
...
<?php if ( have_comments() ) : ?>
	...
	<h3 id="comments"><?php comments_number(esc_html__('0 Comments','ElegantEstate'), esc_html__('1 Comment','ElegantEstate'), '% '.esc_html__('Comments','ElegantEstate') );?></h3>
