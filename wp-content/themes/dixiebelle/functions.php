...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'dixibelle');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
load_theme_textdomain('dixiebelle', TEMPLATEPATH . '/languages/');
...
<div <?php comment_class(); ?> id="comment-<?php comment_ID(); ?>">
	...
	<div class="commentid">
		...
		<p class="commentby"><?php if (function_exists('avatar_display_comments')) { ?>
<?php avatar_display_comments(get_comment_author_email(),'48',''); ?>
<?php } else { ?><?php if (function_exists('get_avatar')) { echo get_avatar( get_comment_author_email() , 48 ); } ?><?php } ?>&nbsp;&nbsp;
<?php comment_author_link() ?></p>
<p class="commentinfo"><?php comment_date() ?> @ <?php comment_time() ?> <?php edit_comment_link(__("Edit This",'dixiebelle'), '&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;'); ?>&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?></p>
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'dx_admin_header_style'));
