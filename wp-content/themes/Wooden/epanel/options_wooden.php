	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Red", "Green", "Blue", "Purple")),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Show About Us box",
                   "id" => $shortname."_show_aboutus",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to display the About Us box. "),

			array( "name" => "Show Recent Comments box",
                   "id" => $shortname."_show_recent_comments",
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => "Here you can choose to display the Recent Comments box. "),
			...
			array( "name" => "About Us Text",
				   ...
				   "type" => "textarea",
				   "std" => "",
				   "desc" => "Enter the text you would like to appear in the About Us section. ",),
