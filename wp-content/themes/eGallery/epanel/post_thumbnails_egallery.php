<?php
	...
	$et_page_thumb = sprintf( $et_thumb_size_format,
		intval( get_option( 'egallery_thumbnail_width_pages', 185 ) ),
		intval( get_option( 'egallery_thumbnail_height_pages', 185 ) )
	);

	$et_theme_image_sizes = array(
		$et_page_thumb	=> 'et-pages-thumb',
		'190x159' 	=> 'et-index-thumb',
		'207x120' 	=> 'et-sidebar-thumb',
		'53x53' 	=> 'et-sidebar-small-thumb',
		'330x330' 	=> 'et-single-thumb',
	);
