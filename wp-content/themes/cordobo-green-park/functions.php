...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'cordobo-green-park');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
load_theme_textdomain('cordobo', TEMPLATEPATH . '/languages/');
...
if ( function_exists('wp_register_sidebar_widget') )
    wp_register_sidebar_widget('search_cordobo-green-park_1', __('Search'), 'widget_green_park_search');
...
<?php } ?>&nbsp;&nbsp;<?php comment_author_link() ?> said,
			</div>
			<?php if ($comment->comment_approved == '0') : ?>
			<em><?php _e('Your comment is awaiting moderation.','cordobo');?></em>
			<?php endif; ?>
			<br />

			<p class="metadate"><?php _e('on','cordobo');?> <?php comment_date('F jS, Y') ?> <?php _e('at','cordobo');?> <?php comment_time() ?> <?php edit_comment_link(__('Edit','cordobo'),' | ',''); ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?></p>
...
function cordobo_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'cordobo_admin_header_style'));
