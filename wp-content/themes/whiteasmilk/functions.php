...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN','whiteasmilk');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
define('HEADER_IMAGE_WIDTH', 620); //width is fixed
define('HEADER_IMAGE_HEIGHT', 100);

function wam_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'wam_admin_header_style'));
...
#header h1 a, #header p#blog_description { color: #<?php header_textcolor() ?> !important; text-decoration: none; }
</style>
<?php } ?>
<?php }
