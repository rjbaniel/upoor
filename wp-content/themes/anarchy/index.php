...
<div class="alignleft"><?php previous_posts_link( __( '&laquo; Newer Entries', 'anarchy') ) ?></div>
<div class="alignright"><?php next_posts_link( __( 'Previous Entries &raquo;', 'anarchy') ) ?></div>
</div>
