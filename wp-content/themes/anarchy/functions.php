...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'anarchy');
////////////////////////////////////////////////////////////////////////////////
...
load_theme_textdomain('anarchy', TEMPLATEPATH . '/languages/');
...
<?php } ?>&nbsp;&nbsp;<?php comment_author_link() ?></cite>&nbsp;&nbsp;<?php _e('Says','anarchy');?>:
			<?php if ($comment->comment_approved == '0') : ?>
			<em><?php _e('Your comment is awaiting moderation.','anarchy');?></em>
			<?php endif; ?>
			<br />

			<small class="commentmetadata"><a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('F jS, Y') ?> <?php _e('at','anarchy');?> <?php comment_time() ?></a> <?php edit_comment_link(__('Edit','anarchy'),'&nbsp;&nbsp;',''); ?></small>&nbsp;&nbsp;&nbsp;&nbsp;<div class="reply"><?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?></div>
