...
<?php if ($comments) : ?>
	...
	<li id="comment-<?php echo $commentcount ?>" class="<?php comment_type(__('comment'),__('trackback'),__('pingback')); ?>">
...
<?php if ($post-> comment_status == "open" && $post->ping_status == "open") { ?>
	...
	<p><a href="<?php trackback_url(display); ?>">Trackback this post</a> &nbsp;|&nbsp; <?php post_comments_feed_link(__('Subscribe to the comments via RSS Feed')); ?></p>

<?php } elseif ($post-> comment_status == "open") {?>

	<p><?php post_comments_feed_link(__('Subscribe to the comments via RSS Feed')); ?></p>
