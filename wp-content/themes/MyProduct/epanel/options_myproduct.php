	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Blue", "Refined-Blue", "Refined-Green", "Refined-Grey", "Refined-Purple")),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Blog Category",
			       ...
			       "options" => $site_cats,
				   "desc" => "Here you can choose which category to be used as your Blog category. This category will be displayed in the tabbed menu on the homepage."),

			array( "name" => "Display Services",
                   "id" => $shortname."_services",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to display Services on the homepage. "),

			array( "name" => "Display Sidebar Home Widgets on Homepage",
                   "id" => $shortname."_homepage_widgets",
                   "type" => "checkbox2",
                   "std" => "false",
                   "desc" => "Here you can choose to display the Sidebar Home Widgets on the homepage. "),

			array( "type" => "clearfix",),

			array( "name" => "Welcome page",
				   "id" => $shortname."_welcome_page",
				   "std" => "",
				   "type" => "select",
				   "desc" => "Choose the page you would like to use as the Welcome Page. ",
				   "options" => $site_pages,
				   'et_array_for' => 'pages'),
			...
			array( "name" => "Service Page 1",
				   ...
				   "std" => "",
				   "type" => "select",
				   "desc" => "Here you can choose the page you would like to use in the Service page area. ",
				   "options" => $site_pages,
				   'et_array_for' => 'pages'),
			...
			array( "name" => "Service Page 4",
				   "id" => $shortname."_service_4",
				   "std" => "",
				   "type" => "select",
				   "desc" => "Here you can choose the page you would like to use in the Service page area. ",
				   "options" => $site_pages,
