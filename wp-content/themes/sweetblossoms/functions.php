...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN','sweetblossoms');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
<li <?php comment_class(); ?> id="comment-<?php comment_ID(); ?>">
	<p <?php comment_class('header'); ?>><strong><?php echo $commentcount ?>.</strong>
...
else { strlen($comment->comment_author)?$author=substr($comment->comment_author,0,25)."&hellip":$author=substr($comment->comment_author,0,25); echo '<a href="'.$comment->comment_author_url.'">'.$author.'</a>';  } ?> &nbsp;|&nbsp; <?php comment_date() ?> <?php _e("at",TEMPLATE_DOMAIN); ?> <?php comment_time() ?></p>
	<?php if ($comment->comment_approved == '0') : ?><p><em><?php _e("Your comment is awaiting moderation.",TEMPLATE_DOMAIN); ?></em></p><?php endif; ?>
	<?php comment_text() ?>
    <p><?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?></p>
	<?php edit_comment_link(__('Edit Comment',TEMPLATE_DOMAIN),'<span class="editlink">','</span>'); ?>
