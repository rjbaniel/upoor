...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'deep-blue');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
load_theme_textdomain('deep-blue', TEMPLATEPATH . '/languages/');
...
define('HEADER_IMAGE', '%s/images/headerhv3.jpg'); // %s is theme dir uri
define('HEADER_IMAGE_WIDTH', 800); //width is fixed
define('HEADER_IMAGE_HEIGHT', 80);

function deep_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'deep_admin_header_style'));
