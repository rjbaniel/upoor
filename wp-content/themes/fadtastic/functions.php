...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'fadtastic');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
load_theme_textdomain('fadtastic', TEMPLATEPATH . '/languages/');
...
<div <?php comment_class(' comment_wrapper '); ?> id="comment-<?php comment_ID(); ?>">
...
<?php } ?>
            &nbsp;&nbsp;<strong><?php comment_author_link() ?></strong><br /><?php comment_date() ?>&nbsp;&nbsp;&nbsp;<?php edit_comment_link(__('edit','fadtastic'),'',''); ?>&nbsp;&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?><br /></p>
					</div>
...
define('HEADER_IMAGE', '%s/images/bg_header_effect.gif'); // %s is theme dir uri
define('HEADER_IMAGE_WIDTH', 960); //width is fixed
define('HEADER_IMAGE_HEIGHT', 107);

function fad_admin_header_style() { ?>
<style type="text/css">
#headimg { background: url(<?php header_image() ?>) repeat-x; }
#headimg { height: <?php echo HEADER_IMAGE_HEIGHT; ?>px; width: <?php echo HEADER_IMAGE_WIDTH; ?>px; }
</style>
<?php }

add_theme_support( 'custom-header', array('admin-head-callback' => 'fad_admin_header_style'));
...
function fadtastic_widget_init() {
	...
	wp_register_sidebar_widget('fadtastic_links_1', __('Links', 'sandbox'), 'widget_fadtastic_links', null, 'links');
	wp_unregister_widget_control('fadtastic_links_1');
}
