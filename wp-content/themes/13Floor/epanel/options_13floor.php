	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Blue", "Brown", "Green", "Purple", "Yellow")),
		...
		array( "name" => "general-3",
			...
			array( "name" => "Custom Featured Animation",
                   "id" => $shortname."_custom_animation",
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => "desc."),
	...
	array( "name" => "wrap-layout",
		...
		array( "name" => "layout-3",
			...
			array( "name" => "Show Thumbs on Index pages",
                   ...
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "By default thumbnails are not placed on index pages, however if you would like to use thumbnails on index pages enable this option. "),
	...
	array( "name" => "wrap-advertisements",
		...
		array( "name" => "advertisements-1",
			...
			array( "name" => "Input 468x60 adsense code",
				   ...
				   "type" => "textarea",
				   "std" => "",
				   "desc" => "Place your adense code here.",),
