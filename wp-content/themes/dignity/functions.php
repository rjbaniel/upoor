...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'dignity');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
load_theme_textdomain('dignity', TEMPLATEPATH . '/languages/');
...
<li <?php comment_class(); ?> id="comment-<?php comment_ID();$ix++; ?>">
...
<?php } ?>&nbsp;&nbsp;
<?php comment_author_link() ?>&nbsp;<?php _e('Says:','dignity'); ?>
    <?php if ($comment->comment_approved == '0') : ?>
    <em><?php _e('Your comment is awaiting moderation.','dignity');?></em>
    <?php endif; ?>
    <br />
    <small class="commentmetadata"><a href="#comment-<?php comment_ID() ?>" title="">
    <?php comment_date('F jS, Y') ?> <?php _e('at','dignity');?> <?php comment_time() ?>
    </a>
...
if ( function_exists('add_theme_support') ) {
  add_theme_support( 'custom-header', array('wp-head-callback' => 'header_style', 'admin-head-callback' => 'admin_header_style'));
} 
