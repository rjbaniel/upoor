...
<title><?php echo get_option('blogname'); ?>- Comments <?php _e('on');?> <?php the_title(); ?>
...
<p>The <abbr title="Universal Resource Locator">URL</abbr> to TrackBack this entry is: <em>
...
<p class="credit">
  ...
  <cite><?php _e('Provided by');?> <a href="http://wordpress.org/" title="<?php _e('Provided by WordPress, state-of-the-art semantic personal publishing platform');?>"><strong>Wordpress</strong></a></cite></p>
