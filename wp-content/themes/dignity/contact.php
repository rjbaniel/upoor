  ...
  <div class="post">
    ...
    <div class="post-content">
      ...
      <form method="post" action="<?php echo "http://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>" id="contactform">
        ...
        <input type="text" class="textbox" id="cp_name" name="cp_name" value="<?php echo $cp_name ;?>" />
        ...
        <input type="text" class="textbox" id="cp_email" name="cp_email" value="<?php echo $cp_email ;?>" />
        ...
        <input type="text" class="textbox" id="cp_url" name="cp_url" value="<?php echo $cp_url ;?>" />
        ...
        <input type="text" class="textbox" id="cp_ans" name="cp_ans" value="<?php echo $cp_ans ;?>" />

        <p class="post-info">[Just to prove you are not a spammer]</p>
    ...
    <?php
						...
						$email_subject	= "[" . get_option('blogname') . "] " . encodeMailHeader($cp_name);
