<?php
/*
Template Name: Tag Search (Don't use here)
*/
?>
<?php get_header(); ?>
	...
	<div class="post">
		...
		<?php if (have_posts()) : ?>
			...
			<?php while (have_posts()) : the_post(); ?>
				<div class="dateline"></div><h2 class="posttitle"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php _e('Permanent Link to','daydream');?> <?php the_title(); ?>"><?php the_title(); ?></a></h2>
	
				<div class="entry">
					<?php the_content(__('Read the rest of this entry &raquo;','daydream')); ?>
				</div>
	
				<?php edit_post_link(__('Edit','daydream'), '','/'); ?><?php comments_popup_link(__('No Comments &#187;','daydream'), __('1 Comment &#187;','daydream'), __('% Comments &#187;','daydream')); ?><br />
		<?php endwhile; ?>
		<?php endif; ?>
