...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'green-marinee');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
<?php } ?>&nbsp;&nbsp;<?php comment_author_link() ?> <?php _e('said',TEMPLATE_DOMAIN); ?>,
			</div>
...
<p class="metadate"><?php _e('on');?> <?php comment_date('F jS, Y') ?> <?php _e('at',TEMPLATE_DOMAIN);?> <?php comment_time() ?>&nbsp;&nbsp;&nbsp;<?php edit_comment_link(__('edit',TEMPLATE_DOMAIN),'',''); ?>&nbsp;&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?></p>
...
define('HEADER_IMAGE_WIDTH', 745); //width is fixed
define('HEADER_IMAGE_HEIGHT', 150);
define('NO_HEADER_TEXT', true );

function gm_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'gm_admin_header_style'));
