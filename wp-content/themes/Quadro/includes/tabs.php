<ul class="idTabs">
	<?php if (get_option('quadro_show_tabarea_recententries') == 'on') { ?>
		<li><a href="#recententries"><?php esc_html_e('Recent Entries','Quadro'); ?></a></li>
	<?php }; ?>
	<?php if (get_option('quadro_show_tabarea_recentcomments') == 'on') { ?>
		<li><a href="#recentcomments2"><?php esc_html_e('Recent Comments','Quadro'); ?></a></li>
	<?php }; ?>
	<?php if (get_option('quadro_show_tabarea_popular') == 'on') { ?>
		<li><a href="#mostcomments"><?php esc_html_e('Popular Posts','Quadro'); ?></a></li>
	<?php }; ?>
</ul>

<?php if (get_option('quadro_show_tabarea_recententries') == 'on') { ?>
	<div id="recententries">
		<span class="toptitle"><?php esc_html_e('Recent Posts','Quadro'); ?></span>
		<?php $recentPostsNum = (int) get_option('quadro_recentposts_num'); ?>
		<ul class="list2">
...
<?php if (get_option('quadro_show_tabarea_recentcomments') == 'on') { ?>
	<div id="recentcomments2">
		<span class="toptitle"><?php esc_html_e('Recent Comments','Quadro'); ?></span>
		<?php $recentCommentsNum = (int) get_option('quadro_recentcomments_num'); ?>
...
<?php if (get_option('quadro_show_tabarea_popular') == 'on') { ?>
	<div id="mostcomments">
		<span class="toptitle"><?php esc_html_e('Popular Articles','Quadro'); ?></span>
		<?php $popularNum = (int) get_option('quadro_popular_posts_num'); ?>
		<ul class="list2">
