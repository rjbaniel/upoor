	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-2",
			...
			array( "name" => "Display Random/Popular Articles",
				   "id" => $shortname."_randompopular",
				   "type" => "checkbox",
				   "std" => "on",
				   "desc" => "Here you can choose to display Random/Popular Articles on the homepage. "),

			array( "name" => "Display Next/Previous Articles on Homepage",
				   "id" => $shortname."_home_nav",
				   "type" => "checkbox2",
				   "std" => "on",
				   "desc" => "desc."),
			...
			array( "name" => "Number of Popular Posts on Homepage",
				   "id" => $shortname."_homepage_popular",
				   "std" => "6",
				   "type" => "text",
				   "validation_type" => "number",
				   "desc" => "Here you can choose the number of Popular Posts you would like to display on the homepage. "),

			array( "name" => "Number of Random Posts on Homepage",
				   "id" => $shortname."_homepage_random",
				   "std" => "6",
				   "type" => "text",
				   "validation_type" => "number",
				   "desc" => "Here you can choose the number of Random Posts you would like to display on the homepage. "),

			array( "name" => "Number of Recent Posts on Homepage",
			...
			array( "name" => "Display Category Boxes on Homepage",
				   "id" => $shortname."_catbox",
				   "type" => "checkbox",
				   "std" => "on",
				   "desc" => "Here you can choose to display the Category Boxes on the homepage. "),

			array( "type" => "clearfix",),

			array( "name" => "Homepage Category Box One",
				   "id" => $shortname."_home_cat_one",
				   "type" => "select",
			       "options" => $site_cats,
				   "desc" => "Here you can choose the category you would like to display in the Category Box One. "),

			array( "name" => "Homepage Category Box One Title",
				   "id" => $shortname."_home_cat_one_title",
				   "std" => "Blog Updates",
				   "type" => "text",
				   "validation_type" => "nohtml",
				   "desc" => "You can edit the title text here. "),

			array( "name" => "Amount of Posts Displayed In Category Box One",
				   "id" => $shortname."_home_cat_one_number",
				   "std" => "6",
				   "type" => "text",
				   "validation_type" => "number",
				   "desc" => "Here you can choose the number of posts you would like to display in Category Box One. "),

			array( "name" => "Homepage Category Box Two",
				   "id" => $shortname."_home_cat_two",
				   "type" => "select",
			       "options" => $site_cats,
				   "desc" => "Here you can choose the category you would like to display in the Category Box Two. "),

			array( "name" => "Homepage Category Box Two Title",
				   "id" => $shortname."_home_cat_two_title",
				   "std" => "Blog Updates",
				   "type" => "text",
				   "validation_type" => "nohtml",
				   "desc" => "You can edit the title text here. "),

			array( "name" => "Amount of Posts Displayed In Category Box Two",
				   "id" => $shortname."_home_cat_two_number",
				   "std" => "6",
				   "type" => "text",
				   "validation_type" => "number",
				   "desc" => "Here you can choose the number of posts you would like to display in Category Box Two. "),
		...
		array( "name" => "general-3",
   			...
   			array( "name" => "Display Featured Articles",
				   ...
				   "type" => "checkbox",
				   "std" => "on",
				   "desc" => "Hide/Display Featured articles."),
			...
			array( "name" => "Number of Featured Posts",
				   ...
				   "type" => "text",
				   "validation_type" => "number",
				   "desc" => "Here you can choose the number of posts you would like to display in the Featured Slider on the homepage. "),
	...
	array( "name" => "wrap-layout",
		...
		array( "name" => "layout-1",
			...
			array( "name" => "Display Thumb on Post Pages",
            	   ...
            	   "type" => "checkbox",
            	   "std" => "on",
            	   "desc" => "Here you can choose to display thumbnails on posts."),
			...
			array( "name" => "Thumbnail width (pixels)",
            	   ...
            	   "validation_type" => "number",
            	   "std" => "200",
				   "desc" => "Here you can set the thumbnail width in pixels. "),
			...
			array( "name" => "Thumbnail height (pixels)",
            	   ...
            	   "validation_type" => "number",
            	   "std" => "200",
				   "desc" => "Here you can set the thumbnail height in pixels. "),
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "wrap-colorization",
		...
		array( "name" => "colorization-1",
			...
			array( "name" => "Post Info color",
				   "id" => $shortname."_postinfo_color",
				   "type" => "textcolorpopup",
				   "std" => "",
				   "desc" => "This option allows you to customize the color of a certain element of the theme. When you click inside the field a color picker will appear. Scroll to find your desired color and then click the circular submit button on the lower right to accept the value.",),
