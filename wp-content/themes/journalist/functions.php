...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'journalist');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
load_theme_textdomain('journalist', TEMPLATEPATH . '/languages/');
...
<?php } ?>
	...
	<p><small><?php comment_date('j M y') ?> at <a href="#comment-<?php comment_ID() ?>"><?php comment_time() ?></a> <? edit_comment_link(__('Edit', 'journalist'), ' ', ''); ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?></small></p>
	</div>
	<div class="clear"></div>
...
define('HEADER_IMAGE_WIDTH', 910); //width is fixed
define('HEADER_IMAGE_HEIGHT', 150);
define('NO_HEADER_TEXT', true );

function journalist_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'journalist_admin_header_style'));
