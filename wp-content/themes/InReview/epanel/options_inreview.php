	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Default", "Blue", "Green", "Red", "Purple")),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Quote Text",
                   ...
                   "std" => 'Fusce placerat nisi nec sem faucibus in consectetur felis suscipit. Praesent vehicula, nisi a bibendum dictum, turpis lorem tempus enim, eu consequat massa lacus in massa.',
                   "type" => "text",
