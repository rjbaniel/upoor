		...
		<div id="top-header-pattern">
			<div class="container clearfix">
				<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
					<?php $logo = (get_option('inreview_logo') <> '') ? get_option('inreview_logo') : get_template_directory_uri().'/images/logo.png'; ?>
				...
				if ($primaryNav == '') { ?>
					<ul id="<?php echo esc_attr( $menuID ); ?>" class="<?php echo esc_attr( $menuClass ); ?>">
						<?php if (get_option('inreview_home_link') == 'on') { ?>
							<li <?php if (is_home()) echo('class="current_page_item"') ?>><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php esc_html_e('Home','InReview') ?></a></li>
						<?php }; ?>
		...
		<div class="container clearfix">
			...
			<div id="search-form">
				<form method="get" id="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>/">
					<input type="text" value="<?php esc_attr_e('Search this site...', 'InReview'); ?>" name="s" id="searchinput" />
