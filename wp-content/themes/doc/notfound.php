...
<p><?php _e('You could search for something else, using the searchbox above; or contact me.', 'doc'); ?></p>
...
<li><?php _e('visit my', 'doc'); ?> <a href="<?php bloginfo('url'); ?>"><?php _e('homepage', 'doc'); ?></a>.</li>

<li><?php _e("browse the blog's archives, using the navigation menus.", 'doc'); ?></li>
