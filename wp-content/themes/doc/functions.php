...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'doc');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
load_theme_textdomain('doc', TEMPLATEPATH . '/languages/');
...
function doc_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'doc_admin_header_style'));
