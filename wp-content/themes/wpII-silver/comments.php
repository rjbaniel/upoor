...
<!-- You can start editing here. -->
   ...
   <?php if ( have_comments() ) : ?>
			...
			<div class="feedback">
			<?php comments_number(__('No Responses',TEMPLATE_DOMAIN), __('One Response',TEMPLATE_DOMAIN), __('% Responses',TEMPLATE_DOMAIN ));?> <?php _e('to',TEMPLATE_DOMAIN);?>  &#8220;<?php the_title(); ?>&#8221;
			</div>
