...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN','wp-silver');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
<?php } ?>&nbsp;&nbsp;<?php comment_author_link() ?> <?php _e('says', TEMPLATE_DOMAIN);?> : <?php if ($comment->comment_approved == '0') : ?>
...
define('HEADER_IMAGE_WIDTH', 750); //width is fixed
define('HEADER_IMAGE_HEIGHT', 150);
define('NO_HEADER_TEXT', true );

function wpsilver_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'wpsilver_admin_header_style'));
...
function flickrock(){
	...
	if ($_POST['action'] == 'update'){
		$flickr_tag = esc_html($_POST['flickr_tag']);
