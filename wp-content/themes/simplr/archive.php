...
<?php while ( have_posts() ) : the_post(); ?>
			...
			<div id="post-<?php the_ID() ?>" class="<?php simplr_post_class() ?>">
				<h3 class="entry-title"><a href="<?php the_permalink() ?>" title="<?php printf(__('Permalink to %s', 'simplr'), esc_html(get_the_title(), 1)) ?>" rel="bookmark"><?php the_title() ?></a></h3>
...
<?php wp_link_pages('<div class="page-link">'.__('Pages: ', 'simplr'), "</div>\n", 'number'); ?>
...
<?php/* the_excerpt('<span class="more-link">'.__('Continued reading &gt;', 'simplr').'</span>')*/ ?>
				...
				<div class="entry-meta">
					...
					<span class="meta-sep">|</span>
					<span class="entry-permalink"><?php printf(__('<a href="%1$s" title="Permalink to %2$s">Permalink</a>', 'simplr'), get_permalink(), esc_html(get_the_title(), 'double') ) ?></span>
					<span class="meta-sep">|</span>
...
<?php endwhile ?>
	...
	<div id="primary" class="sidebar">
		<ul>
			<li id="archive-meta">
<?php if ( is_day() ) : ?>
			<h3><?php printf(__('<a href="%1$s" title="%2$s">Home</a> &gt; Archives for %3$s', 'simplr'), get_bloginfo('url'), esc_html(get_bloginfo('name'), 1), get_the_time(__('l, F jS, Y', 'simplr')) ) ?></h3>
...
<?php elseif ( is_month() ) : ?>
			<h3><?php printf(__('<a href="%1$s" title="%2$s">Home</a> &gt; Archives for %3$s', 'simplr'), get_bloginfo('url'), esc_html(get_bloginfo('name'), 1), get_the_time(__('F, Y', 'simplr')) ) ?></h3>
...
<?php elseif ( is_year() ) : ?>
			<h3><?php printf(__('<a href="%1$s" title="%2$s">Home</a> &gt; Archives for %3$s', 'simplr'), get_bloginfo('url'), esc_html(get_bloginfo('name'), 1), get_the_time(__('Y', 'simplr')) ) ?></h3>
...
<?php elseif ( is_author() ) : ?>
			<h3><?php printf(__('<a href="%1$s" title="%2$s">Home</a> &gt; Archives for %3$s', 'simplr'), get_bloginfo('url'), esc_html(get_bloginfo('name'), 1), $authordata->display_name ) ?></h3>
...
<?php elseif ( is_category() ) : ?>
			<h3><?php printf(__('<a href="%1$s" title="%2$s">Home</a> &gt; %3$s', 'simplr'), get_bloginfo('url'), esc_html(get_bloginfo('name'), 1), single_cat_title("", false) ) ?></h3>
...
<?php elseif ( is_tag() ) : ?>
			<h3><?php printf(__('<a href="%1$s" title="%2$s">Home</a> &gt; %3$s', 'simplr'), get_bloginfo('url'), esc_html(get_bloginfo('name'), 1), single_tag_title("", false) ) ?></h3>
			<div class="archive-meta"><p><?php printf(__('You are viewing the %s tag archives.', 'simplr'), single_cat_title("", false)) ?></p></div>
<?php elseif ( isset($_GET['paged']) && !empty($_GET['paged']) ) : ?>
			<h3><?php printf(__('<a href="%1$s" title="%2$s">Home</a> &gt; Blog Archives', 'simplr'), get_bloginfo('url'), esc_html(get_bloginfo('name'), 1) ) ?></h3>
<?php endif; ?>
			</li>
		</ul>
