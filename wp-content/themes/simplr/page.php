...
<?php wp_link_pages('<div class="page-link">'.__('Pages: ', 'simplr'), '</div>', 'number'); ?>
...
<?php if ( comments_open() ) : comments_template('',true); else : // To show comments on this page, see the readme.html ?>
