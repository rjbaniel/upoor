<?php
	...
	$et_post_thumb = sprintf( $et_thumb_size_format,
		intval( get_option( 'basic_thumbnail_width', 200 ) ),
		intval( get_option( 'basic_thumbnail_height', 200 ) )
	);
	$et_page_thumb = sprintf( $et_thumb_size_format,
		intval( get_option( 'basic_thumbnail_width_pages', 200 ) ),
		intval( get_option( 'basic_thumbnail_height_pages', 200 ) )
	);

	$et_theme_image_sizes = array(
		$et_post_thumb	=> 'et-posts-thumb',
		$et_page_thumb	=> 'et-pages-thumb',
		'190x190' 	=> 'et-blogstyle-thumb',
	);
