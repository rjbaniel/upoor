	...
	array( "name" => "wrap-layout",
		...
		array( "name" => "layout-1",
			...
			array( "name" => "Thumbnail width (pixels)",
            	   ...
            	   "validation_type" => "number",
            	   "std" => "200",
				   "desc" => "Here you can adjust the width of the thumbnail in pixels."),
			...
			array( "name" => "Thumbnail height (pixels)",
            	   ...
            	   "validation_type" => "number",
            	   "std" => "200",
				   "desc" => "Here you can adjust the height of your thumbnails in p"),
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "wrap-colorization",
		...
		array( "name" => "colorization-1",
			...
			array( "name" => "Main container border color",
				   "id" => $shortname."_color_bordercolor",
				   "type" => "textcolorpopup",
				   "std" => "",
				   "desc" => "This option allows you to customize the color of a certain element of the theme. When you click inside the field a color picker will appear. Scroll to find your desired color and then click the circular submit button on the lower right to accept the value",),

			array( "name" => "Post Info background color",
				   "id" => $shortname."_postinfo1_bgcolor",
				   "type" => "textcolorpopup",
				   "std" => "",
				   "desc" => "This option allows you to customize the color of a certain element of the theme. When you click inside the field a color picker will appear. Scroll to find your desired color and then click the circular submit button on the lower right to accept the value.",),

			array( "name" => "Post Info background color 2",
				   "id" => $shortname."_postinfo2_bgcolor",
				   "type" => "textcolorpopup",
				   "std" => "",
				   "desc" => "This option allows you to customize the color of a certain element of the theme. When you click inside the field a color picker will appear. Scroll to find your desired color and then click the circular submit button on the lower right to accept the value.",),
