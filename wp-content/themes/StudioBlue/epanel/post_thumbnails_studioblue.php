<?php
	...
	$et_page_thumb = sprintf( $et_thumb_size_format,
		intval( get_option( 'studioblue_thumbnail_width_pages', 185 ) ),
		intval( get_option( 'studioblue_thumbnail_height_pages', 185 ) )
	);

	$et_theme_image_sizes = array(
		$et_page_thumb	=> 'et-pages-thumb',
		'90x90' 	=> 'et-single-thumb',
		'25x25' 	=> 'et-category-box-thumb',
		'580x160' 	=> 'et-featured-thumb',
	);
