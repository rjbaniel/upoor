	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Blue", "Purple", "Green", "Black", "Brown")),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Category Box 1",
			       ...
			       "options" => $site_cats,
				   "desc" => "Choose the category you could like to display in the category box. "),
			...
			array( "name" => "Number of Posts in Category Box 1",
                   "id" => $shortname."_posts_catbox1",
                   "std" => "6",
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can choose the number of Posts you would like to display in the Category Box. "),

			array( "name" => "Number of Posts in Category Box 2",
                   "id" => $shortname."_posts_catbox2",
                   "std" => "6",
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can choose the number of Posts you would like to display in the Category Box. "),
			...
			array( "name" => "Number of Popular Articles",
                   ...
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can choose the number of Popular Articles. "),
			...
			array( "name" => "Number of Random Articles",
                   ...
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can choose the number of Random Articles. "),
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "wrap-layout",
		...
		array( "name" => "layout-1",
			...
			array( "name" => "Display Tabbed Menu",
            "id" => $shortname."_posttabs",
            "type" => "checkbox",
            "std" => "false",
			"desc" => "Here you can choose to display the Tabbed Menu. "),
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "wrap-advertisements",
		...
		array( "name" => "advertisements-1",
			...
			array( "name" => "Enable 728x90 Single Post banner",
				   "id" => $shortname."_728_enable",
					"type" => "checkbox2",
				   "std" => "false",
				   "desc" => "Enabling this option will display a 728x90 banner ad on the single post pages. If enabled you must fill in the banner image and destination url below.",),
			...
			array( "name" => "Input 728x90 Single Post advertisement banner image",
			...
			array( "name" => "Input 728x90 Single Post advertisement destination url",
				   "id" => $shortname."_728_url",
				   "type" => "text",
				   "validation_type" => "url",
				   "std" => "",
				   "desc" => "Place the destination URL here. ",),

			array( "name" => "Input 728x90 Single Post adsense code",
