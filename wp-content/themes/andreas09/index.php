...
<div id="content">
	...
	<?php while (have_posts()) : the_post(); ?>
		...
		<?php if (function_exists('wp_ozh_wsa')) { wp_ozh_wsa("46860nocolor"); } ?>
			...
			<p class="date"><?php _e('Posted by','andreas09'); ?> <?php if (get_the_author_meta('url')) { ?><a href="<?php the_author_meta('url'); ?>"><?php the_author(); ?></a><?php } else { the_author(); } ?> <?php _e('on','andreas09'); ?> <?php the_time(get_option("date_format")); ?></p>
		...
		<p class="category"><?php _e('Posted in','andreas09'); ?> <?php the_category(', ') ?> | <?php the_tags( __( 'Tagged' ) . ': ', ', ', ' | '); ?> <?php edit_post_link(__('Edit','andreas09'), '', ' | '); ?>  <?php comments_popup_link(__('No Comments &#187;','andreas09'), __('1 Comment &#187;','andreas09'), __('% Comments &#187;','andreas09')); ?></p>
		</div>
