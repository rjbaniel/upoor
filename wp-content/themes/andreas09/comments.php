...
<h3 id="comments"><?php comments_number(__('No Responses','andreas09'), __('One Response','andreas09'), __('% Responses','andreas09') );?> <?php _e('to','andreas09'); ?> &#8220;<?php the_title(); ?>&#8221;</h3>
...
<h3 id="respond"><?php _e('Leave a Reply','andreas09'); ?></h3> <?php if (function_exists('comment_form_text_output')){ comment_form_text_output(); } ?><br /><br />
