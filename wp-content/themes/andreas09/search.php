	...
	<?php if (have_posts()) : ?>
		...
		<?php while (have_posts()) : the_post(); ?>
			...
			<div class="post">
				...
				<p class="date"><?php _e('Posted on','andreas09'); ?> <?php the_time(__('l, F jS, Y','andreas09')) ?></small></p>


		<?php the_excerpt(''); ?>


		<p><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php _e('Permanent Link to');?> <?php the_title(); ?>"><?php _e('Read the rest of this post...','andreas09'); ?></a></p>
