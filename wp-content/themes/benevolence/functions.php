...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'benevolence');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
function benevolence_widgets_init() {
	register_sidebars(1);
	wp_register_sidebar_widget('benevolence_search_1', __('Search'), 'benevolence_search', null, 'search');
	wp_unregister_widget_control('benevolence_search_1');
}
...
add_theme_support( 'custom-header', array('wp-head-callback' => 'header_style', 'admin-head-callback' => 'benevolence_admin_header_style'));
