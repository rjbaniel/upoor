<?php
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'ambiru');
...
add_theme_support( 'custom-header', array('wp-head-callback' => 'header_style', 'admin-head-callback' => 'ambiru_admin_header_style'));
