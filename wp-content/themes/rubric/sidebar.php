...
<?php endif; ?>
 ...
 <li id="meta"><?php _e('Meta:','classic'); ?>
 	<ul>
		...
		<li><a href="feed:<?php bloginfo('rss2_url'); ?>" title="<?php _e('Syndicate this site using RSS','classic'); ?>"><?php _e('<abbr title="Really Simple Syndication">RSS</abbr>','classic'); ?></a></li>
		<li><a href="feed:<?php bloginfo('comments_rss2_url'); ?>" title="<?php _e('The latest comments to all posts in RSS','classic'); ?>"><?php _e('Comments <abbr title="Really Simple Syndication">RSS</abbr>','classic'); ?></a></li>
