...
<div style="position: relative; z-index: 1;" id="slider-nav"> <a href="#" class="slider-link-1"><?php echo esc_html( get_option('ebusiness_slider_1_button') ); ?></a> <a href="#" class="slider-link-2"><?php echo esc_html( get_option('ebusiness_slider_2_button') ); ?></a> </div>
<div id="sections">
    <ul>
        <li>
        ...
        <li>
            ...
            <?php if (get_option('ebusiness_slider_2_type') == 'Video') : ?>
                <div style="background: #DCDBDB; padding: 8px;"><?php echo get_option('ebusiness_slider_2_video'); ?></div>
            <?php else : ?>
