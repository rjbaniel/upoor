<?php
	...
	$et_post_thumb = sprintf( $et_thumb_size_format,
		intval( get_option( 'ebusiness_thumbnail_size', 200 ) ),
		intval( get_option( 'ebusiness_thumbnail_size', 200 ) )
	);
	$et_page_thumb = sprintf( $et_thumb_size_format,
		intval( get_option( 'ebusiness_thumbnail_width_pages', 200 ) ),
		intval( get_option( 'ebusiness_thumbnail_height_pages', 200 ) )
	);
	$et_usual_thumb = sprintf( $et_thumb_size_format,
		intval( get_option( 'ebusiness_thumbnail_size_index', 200 ) ),
		intval( get_option( 'ebusiness_thumbnail_size_index', 200 ) )
	);
