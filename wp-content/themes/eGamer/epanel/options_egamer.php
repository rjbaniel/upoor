	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Rust", "Blue", "Green", "Purple")),
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "wrap-layout",
		...
		array( "name" => "layout-3",
			...
			array( "name" => "Enable Thumbnails",
                   "id" => $shortname."_index_thumbnails",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "If you would like to remove thumbnail images from all index pages then disable this option."),

			array( "name" => "Excerpt Mode",
            "id" => $shortname."_excerpt",
            "type" => "checkbox",
            "std" => "false",
			"desc" => "By default the theme creates post previews based off the beginning of your post. However if you would rather use the excerpts that you define in wp-admin then enable this setting. "),
		...
		array( "name" => "layout-4",
			...
			array( "name" => "Display Recent Videos",
                   "id" => $shortname."_video",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Enable this option to display the most video video on your homepage."),

			array( "name" => "Display Recent Reviews",
                   "id" => $shortname."_rating",
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => "Enable this option to display a list of your most revent reviews on the homepage."),

			array( "name" => "Display Popular Articles",
                   "id" => $shortname."_popular_display",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Enable this option to display a list of your most popular articles on the homepage."),

			array( "name" => "Display Random Articles",
                   "id" => $shortname."_random_display",
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => "Enable this option to display a list of random articles on your homepage."),

			array( "name" => "Enable Page Navi",
				   "id" => $shortname."_home_navi",
				   	"type" => "checkbox",
				   "std" => "on",
				   "desc" => "Enabling this will place page navigation on your homepage which allow users to view older posts without having to view category pages.",),
