...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN','quadruple-blue');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
<?php } ?>&nbsp;&nbsp;
<strong><?php comment_author_link() ?></strong> <?php _e('Said&#58;',TEMPLATE_DOMAIN); ?><br /><a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('F jS, Y') ?> <?php _e('at');?> <?php comment_time() ?></a>  <br /><small><?php edit_comment_link(__('Edit Comment',TEMPLATE_DOMAIN),'',''); ?>&nbsp;&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?></small>
...
define('HEADER_IMAGE_WIDTH', 808); //width is fixed
define('HEADER_IMAGE_HEIGHT', 150);
define('NO_HEADER_TEXT', true );

function quod_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'quod_admin_header_style'));
