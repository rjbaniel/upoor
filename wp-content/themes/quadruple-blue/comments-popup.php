...
<p><a href="<?php trackback_url() ?>" title="trackback URI to this entry"><?php _e('TrackBack <acronym title="<?php _e('Uniform Resource Identifier');?>">URI</acronym>'); ?></a></p>
<?php } ?>
...
<?php foreach ($comments as $comment) { ?>
	...
	<cite><?php comment_type(__('Comment'), __('Trackback'), __('Pingback')); ?> by <strong><?php comment_author_link() ?></strong> &#8212; <?php comment_date() ?> @ <a href="#comment-<?php comment_ID() ?>"><?php comment_time() ?></a></cite>
	<?php comment_text() ?>
	</li>
