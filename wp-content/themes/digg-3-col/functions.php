...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'digg-3-col');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
load_theme_textdomain('digg-3-col', TEMPLATEPATH . '/languages/');
...
<strong><?php if (function_exists('avatar_display_comments')) { ?>
...
<?php } ?>&nbsp;&nbsp;<?php comment_author_link() ?></strong>, <?php _e('on'); ?> <a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('F jS, Y') ?> <?php _e('at');?> <?php comment_time() ?></a> <?php _e('Said&#58;'); ?> <?php edit_comment_link('Edit Comment','',''); ?>
...
define('HEADER_IMAGE', '%s/images/bg_header.gif'); // %s is theme dir uri
define('HEADER_IMAGE_WIDTH', 904); //width is fixed
define('HEADER_IMAGE_HEIGHT', 155);


function digg_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'digg_admin_header_style'));
