...
<link rel="stylesheet" type="text/css" media="screen" href="<?php bloginfo('template_url'); ?>/2813.css"/>
...
<body id="custom" class="<?php if (is_single()) echo permalink; ?>"><div id="page"><hr />
...
<a href="<?php bloginfo('url'); ?>"><img style="border: 0 none;" src="<?php header_image(); ?>" alt="<?php bloginfo('name'); ?>" /></a>
<?php } ?>
