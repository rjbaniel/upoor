...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'flex');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
load_theme_textdomain('flex', TEMPLATEPATH . '/languages/');
...
<?php } ?>&nbsp;&nbsp;<?php comment_author_link() ?></span>
					...
					<?php if ($comment->comment_approved == '0') : ?>
						<em><?php _e('Your comment is awaiting moderation.','flex');?></em>
					<?php endif; ?>
					<div class="commentinfo">
						<span class="commentdate">
							<?php comment_date('F jS, Y') ?> |
							<a href="#comment-<?php comment_ID() ?>" title="comment link url"><?php comment_time() ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php edit_comment_link(__('edit','flex'),'',''); ?>&nbsp;&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?></a>
						</span>
					</div>
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'flex_admin_header_style'));
