<?php
	...
	$et_page_thumb = sprintf( $et_thumb_size_format,
		intval( get_option( 'coldstone_thumbnail_width_pages', 250 ) ),
		intval( get_option( 'coldstone_thumbnail_height_pages', 250 ) )
	);

	$et_theme_image_sizes = array(
		$et_page_thumb	=> 'et-pages-thumb',
		'62x62' 	=> 'et-default-thumb',
		'883x250' 	=> 'et-featured-thumb',
		'470x110' 	=> 'et-magazine-thumb',
	);
