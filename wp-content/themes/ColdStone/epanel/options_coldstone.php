	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Post Format",
				   ...
				   "type" => "select",
				   "std" => "Business",
				   "desc" => "Here you can choose the style of the post format on the homepage. ",
		...
		array( "name" => "general-3",
			...
			array( "name" => "Display Featured Articles",
            	   ...
            	   "type" => "checkbox",
            	   "std" => "on",
            	   "desc" => "Here you can choose to display the Featured Articles on the homepage. "),
	...
	array( "name" => "wrap-layout",
		...
		array( "name" => "layout-1",
			...
			array( "name" => "Thumbnail width (pixels)",
            	   ...
            	   "validation_type" => "number",
            	   "std" => "250",
				   "desc" => "Here you can set the width of the thumbnails in pixels. "),
			...
			array( "name" => "Thumbnail height (pixels)",
            	   ...
            	   "validation_type" => "number",
            	   "std" => "250",
				   "desc" => "Here you can set the height of the thumbnails in pixels. "),
		...
		array( "name" => "advertisements-1",
			...
			array( "name" => "Enable 125x125 banners in the Featured Area",
				   "id" => $shortname."_ads",
				   	"type" => "checkbox",
				   "std" => "on",
				   "desc" => "Enabling this option will display a 125x125 banner in the Featured Area. If enabled you must fill in the banner image and destination url below.",),
			...
			array( "name" => "Input 125x125 Featured Area banner #1 url",
				   ...
				   "validation_type" => "url",
				   "std" => "",
				   "desc" => "Place the URL of the banner image in the field. ",),
			...
			array( "name" => "Input 468x60 advertisement destination url",
				   ...
				   "validation_type" => "url",
				   "std" => "",
				   "desc" => "Place the URL of the banner destination in the field.",),
