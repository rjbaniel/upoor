...
<div class="side_box">
    <div class="menu tabbed">
        <ul class="tabs">
            <li class="t1"><a class="t1 tab" title="<?php esc_attr_e('Latest Headlines','ColdStone'); ?>">
                <?php esc_html_e('Comments','ColdStone'); ?>
                </a></li>
            <li class="t3"><a class="t3 tab" title="<?php esc_attr_e('Categories','ColdStone'); ?>">
                <?php esc_html_e('Recent','ColdStone'); ?>
                </a></li>
            <li class="t4"><a class="t4 tab" title="<?php esc_attr_e('Archives','ColdStone'); ?>">
                <?php esc_html_e('Archives','ColdStone'); ?>
                </a></li>
        </ul>
        <!-- LATEST HEADLINES -->
        <div class="t1">
