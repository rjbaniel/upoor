	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-2",
			...
			array( "name" => "Display Recent Comments",
                   ...
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => "Here you can choose to display the Recent Comments. "),
			...
			array( "name" => "Display Popular Articles",
                   ...
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to display the Popular Articles on the homepage. "),

			array( "name" => "Display Random Posts",
                   "id" => $shortname."_show_randomposts",
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => "Here you can choose to display the Random Posts on the homepage. "),

			array( "type" => "clearfix",),

			array( "name" => "Display Flickr Photos",
                   "id" => $shortname."_show_flickr",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to display Flickr Photos. "),

			array( "type" => "clearfix",),

			array( "name" => "Flickr User ID Number",
                   "id" => $shortname."_flickr",
                   "std" => "29622357%40N07",
                   "type" => "text",
                   "validation_type" => "nohtml",
				   "desc" => "Place your Flickr User ID here. "),
			...
			array( "name" => "Category Box 1",
			       ...
			       "options" => $site_cats,
				   "desc" => "Here you can choose the category of posts you would like to display in the Category box. "),
			...
			array( "name" => "Number of Random Articles",
                   ...
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can choose the number of posts you would to display. "),
			...
			array( "name" => "Number of Recent Comments",
                   ...
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can choose the number of Recent Comments you would to display. "),
