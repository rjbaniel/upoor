...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'nwc');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
<?php } ?>&nbsp;&nbsp;<?php comment_author_link() ?> &#8212; <?php comment_date() ?> @ <a href="#comment-<?php comment_ID() ?>"><?php comment_time() ?></a></cite> <?php edit_comment_link(__("Edit This",TEMPLATE_DOMAIN), ' | '); ?>&nbsp;&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?>
</p>
...
define('HEADER_IMAGE', '%s/images/himmel.jpg'); // %s is theme dir uri
define('HEADER_IMAGE_WIDTH', 729); //width is fixed
define('HEADER_IMAGE_HEIGHT', 205);
