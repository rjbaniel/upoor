...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'color-splash');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
load_theme_textdomain('color-splash', TEMPLATEPATH . '/languages/');
...
<li <?php comment_class(); ?> id="comment-<?php comment_ID(); ?>">
			...
			<em><?php _e('Your Comment is awaiting moderation', 'color-splash'); ?></em><br />
			<?php endif; ?>
...
<?php } ?>
  <!--<?php
   echo get_avatar( $id_or_email, $size = '56', $default = '<path_to_url>' );
   ?> --></span>
  <span class="Author"><?php comment_author_link() ?></span><br />
  <span class="comment_time">
  							<?php comment_date('d.m.y') ?>
  							 <?php comment_time() ?>&nbsp;&nbsp;&nbsp;<?php edit_comment_link(__('edit', 'color-splash'),'',''); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?>
  </span>

  <span class="Comment_text"><?php comment_text() ?></span>

  <span class="commentnumber"><a href="#comment-<?php comment_ID() ?>">#</a></span>
...
if ( function_exists('register_sidebar') )  {
    ...
    register_sidebar(array(
        ...
        'after_widget' => '</span>',
        'before_title' => '<h3 class="widgettitle" align="right">',
        'after_title' => '</h3>',
    ));
...
define('HEADER_IMAGE', '%s/images/ColorBloomHeader.png'); // %s is theme dir uri
define('HEADER_IMAGE_WIDTH', 516); //width is fixed
define('HEADER_IMAGE_HEIGHT', 306);
define('NO_HEADER_TEXT', true );

function splash_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'splash_admin_header_style'));
