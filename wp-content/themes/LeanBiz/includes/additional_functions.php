...
add_action( 'save_post', 'leanbiz_save_details', 10, 2 );
function leanbiz_save_details( $post_id, $post ){
	global $pagenow;
	...
	$temp_array['et_fs_link_custom_text'] = isset($_POST["et_fs_link_custom_text"]) ? sanitize_text_field($_POST["et_fs_link_custom_text"]) : '';
