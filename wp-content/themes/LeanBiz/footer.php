		...
		<div id="footer">
			<div class="container">
				...
				<div id="footer-bottom">
					<p id="copyright">&copy; 2011 <?php echo esc_attr(get_bloginfo('name')); ?> | <?php esc_html_e('Designed by ','LeanBiz'); ?> <a href="http://www.elegantthemes.com" title="Premium WordPress Themes">Elegant Themes</a> | <?php esc_html_e('Powered by ','LeanBiz'); ?> <a href="http://www.wordpress.org">WordPress</a></p>
