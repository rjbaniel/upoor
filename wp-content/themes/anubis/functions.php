...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'anubis');
////////////////////////////////////////////////////////////////////////////////
...
load_theme_textdomain('anubis', TEMPLATEPATH . '/languages/');
...
<?php } ?> &nbsp;&nbsp;<?php comment_author_link() ?>
    ...
    <?php edit_comment_link('e','',''); ?>&nbsp;&nbsp;&nbsp;<div class="reply"><?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?> </div>
    </small>
    <?php comment_text() ?>
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'anubis_admin_header_style'));
