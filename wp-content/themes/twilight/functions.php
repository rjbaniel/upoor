...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN','twilight');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
<?php } ?>&nbsp;&nbsp;
<cite><?php comment_author_link() ?> <small><?php _e('at', TEMPLATE_DOMAIN);?> <?php comment_date('F jS, Y') ?> <?php comment_time() ?></small></cite>:
...
define('HEADER_IMAGE', '%s/images/twilight.jpg'); // %s is theme dir uri
define('HEADER_IMAGE_WIDTH', 710); //width is fixed
define('HEADER_IMAGE_HEIGHT', 200);


function twilight_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'twilight_admin_header_style'));

function header_custom_style() { ?>
<?php if('' != get_header_image() ) { ?>
<style type="text/css">
#header { background: url(<?php header_image() ?>) repeat !important; }
#header h1 a, #header div#description { color: #<?php header_textcolor() ?> !important; text-decoration: none; }
</style>
<?php } ?>
<?php }
