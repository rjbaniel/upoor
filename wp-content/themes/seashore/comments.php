...
<?php if ($post-> comment_status == "open") {?>
	<?php post_comments_feed_link(__('Comments RSS',TEMPLATE_DOMAIN)); ?>
<?php }; ?>
</p>
</div>
...
<label for="email"><small><?php _e("Mail (hidden)",TEMPLATE_DOMAIN); ?> <?php if ($req) _e('(required)'); ?></small></label></p>
