...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN','seashore');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
if ($comment->comment_author_email == get_the_author_meta('email')) { $oddcomment = 'authorcomment'; } ?>

<li <?php comment_class($oddcomment); ?> id="comment-<?php comment_ID(); ?>">
<div class="cmtinfo"><?php if (function_exists('avatar_display_comments')) { ?>
...
<?php } ?>&nbsp;&nbsp;<small class="commentmetadata"><a href="#comment-<?php comment_ID() ?>" title="">#</a> </small><cite><?php comment_author_link() ?></cite><em><?php _e('on',TEMPLATE_DOMAIN);?> <?php comment_date('d M Y') ?> <?php _e('at',TEMPLATE_DOMAIN);?> <?php comment_time() ?> <?php edit_comment_link(__('edit this',TEMPLATE_DOMAIN),'',''); ?></em></div>
...
if ( function_exists('add_theme_support') ) {
	add_theme_support( 'custom-header', array('wp-head-callback' => 'theme_header_style', 'admin-head-callback' => 'theme_admin_header_style'));
}
?>
