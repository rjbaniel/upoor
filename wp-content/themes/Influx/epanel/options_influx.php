	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Number of Recent Entries displayed in Sidebar",
				   ...
				   "desc" => "Here you can choose the number of Recent Entries in the Sidebar. "),
			...
			array( "name" => "Number of Recent Comments displayed in Sidebar",
                   ...
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can choose the number of Recent Comments in the Sidebar. "),

			array( "name" => "About Us Text",
				   "id" => $shortname."_abouttext",
				   "type" => "textarea",
				   "std" => "",
				   "desc" => "You can use this text area to edit the About Us section in the sidebar. ",),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Display Right/Center Column",
                   "id" => $shortname."_show_rcenter_column",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to Display the Right/Center Column. "),
			...
			array( "name" => "Display Random Articles",
                   ...
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to display Random Articles. "),
			...
			array( "name" => "Number of Popular Articles",
                   ...
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can choose the number of Popular Articles to display on the homepage. "),
			...
			array( "name" => "Number of Random Articles",
                   ...
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can choose the number of Random Articles to display on the homepage. "),
