...
<div id="container2"> <img src="<?php echo get_template_directory_uri(); ?>/images/content-top-home-2-full.gif" alt="logo" style="float: left;" />
    <div id="left-div">
        <?php if (have_posts()) : ?>
    ...
    <img src="<?php echo get_template_directory_uri(); ?>/images/content-bottom-2-full.gif" alt="logo" style="float: left;" /> </div>
<?php get_footer(); ?>
</body></html>