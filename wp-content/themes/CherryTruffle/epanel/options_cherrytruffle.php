...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "wrap-navigation",
		...
		array( "name" => "navigation-2",
            ...
            "type" => "checkbox2",
            "std" => "on",
			"desc" => "Disabling this option will cause empty categories to be dislayed in your navigation bar. By default categoires that don't have any posts are hidden."),
		...
		array( "name" => "navigation-3",
			...
			array( "name" => "Disable twitter icon",
            		"id" => $shortname."_icon_twitter_display",
            		"type" => "checkbox",
            		"std" => "on",
					"desc" => "If you don't have a twitter account and would like to remove the twitter icon and link from the top of the sidebar then simply disable this option."),

			array( "name" => "Disable facebook icon",
            		"id" => $shortname."_icon_facebook_display",
            		"type" => "checkbox2",
            		"std" => "on",
					"desc" => "If you don't have a facebook account and would like to remove the facebook icon and link from the top of the sidebar then simply disable this option."),

			array( "name" => "Disable myspace icon",
            		"id" => $shortname."_icon_myspace_display",
            		"type" => "checkbox",
            		"std" => "on",
					"desc" => "If you don't have a myspace account and would like to remove the myspace icon and link from the top of the sidebar then simply disable this option."),

			array( "name" => "Disable rss icon",
            		"id" => $shortname."_icon_rss_display",
            		"type" => "checkbox2",
            		"std" => "on",
					"desc" => "If you don't want to display the rss icon and link in the sidebar then simply disable this option."),

			array( "name" => "Disable linkedin icon",
            		"id" => $shortname."_icon_linkedin_display",
            		"type" => "checkbox",
            		"std" => "on",
					"desc" => "If you don't have a linkedin account and would like to remove the linkedin icon and link from the top of the sidebar then simply disable this option."),

			array( "name" => "Disable stumble icon",
            		"id" => $shortname."_icon_stumble_display",
            		"type" => "checkbox2",
            		"std" => "on",
					"desc" => "If you don't have a stumble account and would like to remove the stumble icon and link from the top of the sidebar then simply disable this option."),

			array( "name" => "Disable youtube icon",
            		"id" => $shortname."_icon_youtube_display",
            		"type" => "checkbox",
            		"std" => "on",
					"desc" => "If you don't have a youtube account and would like to remove the youtube icon and link from the top of the sidebar then simply disable this option."),

			array( "type" => "clearfix",),

    array( "name" => "Twitter icon destination URL",
           "id" => $shortname."_twitter_url",
           "std" => "#",
           "type" => "text",
           "validation_type" => "url",
		   "desc" => "If your twitter icon is enabled input the URl to your twitter page here."),

    array(  "name" => "Facebook icon destination URL",
            "id" => $shortname."_facebook_url",
            "std" => "#",
            "type" => "text",
            "validation_type" => "url",
			"desc" => "If your facebook icon is enabled input the URl to your facebook page here."),

    array(  "name" => "Myspace icon destination URL",
            "id" => $shortname."_myspace_url",
            "std" => "#",
            "type" => "text",
            "validation_type" => "url",
			"desc" => "If your myspace icon is enabled input the URl to your myspace page here."),

    array(  "name" => "RSS icon destination URL",
            "id" => $shortname."_rss_url",
            "std" => "#",
            "type" => "text",
            "validation_type" => "url",
			"desc" => "If your rss icon is enabled input your RSS url here."),

    array(  "name" => "Stumble icon destination URL",
            "id" => $shortname."_stumble_url",
            "std" => "#",
            "type" => "text",
            "validation_type" => "url",
			"desc" => "If your stumble icon is enabled input your stumble url here."),

    array(  "name" => "Linkedin icon destination URL",
            "id" => $shortname."_linkedin_url",
            "std" => "#",
            "type" => "text",
            "validation_type" => "url",
			"desc" => "If your linkedin icon is enabled input your linkedin url here."),

    array(  "name" => "Youtube icon destination URL",
            "id" => $shortname."_youtube_url",
            "std" => "#",
            "type" => "text",
            "validation_type" => "url",
			"desc" => "If your youtube icon is enabled input your youtube url here."),
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "wrap-layout",
		...
		array( "name" => "layout-3",
			...
			array( "name" => "Display Cat/Author links",
                   "id" => $shortname."_index_info",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Disabling this option will remove the links to the categories and post author from index page post previews."),

			array( "type" => "clearfix",),

			array( "name" => "Adjust the width of thumbnail images",
				   "id" => $shortname."_thumbnail_width_index",
				   "type" => "text",
				   "validation_type" => "number",
				   "std" => "200",
				   "desc" => "Here you can adjust the width of your thumbnail images. The width value is in pixels.",),
			...
			array( "name" => "Adjust the height of thumbnail images",
				   "id" => $shortname."_thumbnail_height_index",
				   "type" => "text",
				   "validation_type" => "number",
				   "std" => "200",
				   "desc" => "Here you can adjust the height of your thumbnail images. The height value is in pixels.",),
		...
		array( "name" => "layout-4",
			...
			array( "name" => "Display social icons",
                   "id" => $shortname."_display_social",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "If you don't want to display any of the social networking icons on the sidebar you can disable this option to remove the entire connect area. "),


			array( "name" => "Display Search Bar",
            "id" => $shortname."_display_search",
            "type" => "checkbox",
            "std" => "on",
			"desc" => "If you don't want to display the search bar in the header then disable this option. "),

			array( "name" => "Display footer area",
            "id" => $shortname."_display_footer",
            "type" => "checkbox2",
            "std" => "on",
			"desc" => "If you would like to remove the footer area, including all widgets and links, simply disable this option. "),
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "wrap-colorization",
		...
		array( "name" => "colorization-1",
			...
			array( "name" => "Page menu link hover color",
				   "id" => $shortname."_color_pagelink_hover",
				   "type" => "textcolorpopup",
				   "std" => "",
				   "desc" => "This option allows you to customize the color of a certain element of the theme. When you click inside the field a color picker will appear. Scroll to find your desired color and then click the circular submit button on the lower right to accept the value",),

			array( "name" => "Category menu link color",
				   "id" => $shortname."_color_catlink",
				   "type" => "textcolorpopup",
				   "std" => "",
				   "desc" => "This option allows you to customize the color of a certain element of the theme. When you click inside the field a color picker will appear. Scroll to find your desired color and then click the circular submit button on the lower right to accept the value",),

			array( "name" => "Category menu link hover color",
				   "id" => $shortname."_color_catlink_hover",
				   "type" => "textcolorpopup",
				   "std" => "",
				   "desc" => "This option allows you to customize the color of a certain element of the theme. When you click inside the field a color picker will appear. Scroll to find your desired color and then click the circular submit button on the lower right to accept the value",),
			...
			array( "name" => "Slogan font color",
				   "id" => $shortname."_color_slogan",
				   "type" => "textcolorpopup",
				   "std" => "",
				   "desc" => "This option allows you to customize the color of a certain element of the theme. When you click inside the field a color picker will appear. Scroll to find your desired color and then click the circular submit button on the lower right to accept the value",),
