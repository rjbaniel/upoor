...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'borderlinechaos');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
load_theme_textdomain('borderline', TEMPLATEPATH . '/languages/');
...
if ( function_exists('register_sidebar') )
	register_sidebar(array(
		'before_widget' => '<div id="sidebox1">', // Removes <li>
		'after_widget' => '</div><br /><br />', // Removes </li>
...
<?php comment_text() ?>
<i><?php if (function_exists('avatar_display_comments')) { ?>
<?php avatar_display_comments(get_comment_author_email(),'30',''); ?>
<?php } else { ?>
<?php if (function_exists('get_avatar')) { echo get_avatar( get_comment_author_email() , 30 ); } ?>
<?php } ?>&nbsp;&nbsp; <?php comment_author_link() ?> <?php _e('on'); ?>&nbsp;<?php comment_date('m.d.y') ?> @ <a href="#comment-<?php comment_ID() ?>"><?php comment_time() ?></a> <?php edit_comment_link(__("Edit This"), '&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;'); ?>&nbsp;&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?></i>
</div>
</div>
...
define('HEADER_IMAGE_WIDTH', 1280); //width is fixed
define('HEADER_IMAGE_HEIGHT', 150);
define('NO_HEADER_TEXT', true );

function borderline_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'borderline_admin_header_style'));
