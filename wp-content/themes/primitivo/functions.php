...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN','primitivo');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
<?php } ?><?php comment_author_link() ?>
      <?php _e("said,",TEMPLATE_DOMAIN); ?> </div>
    <?php if ($comment->comment_approved == '0') : ?>
    <em><?php _e('Your comment is awaiting moderation.',TEMPLATE_DOMAIN);?></em>
    <?php endif; ?>
    <br />
    <p class="metadate"><?php _e('on',TEMPLATE_DOMAIN);?> <?php comment_date('F jS, Y') ?> <?php _e('at',TEMPLATE_DOMAIN);?> <?php comment_time() ?>&nbsp;&nbsp;&nbsp;<small><?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?></small>
    </p>
    <?php comment_text() ?>
...
function primitivo_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'primitivo_admin_header_style'));
