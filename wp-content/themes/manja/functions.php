...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'manja');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
<?php } ?>&nbsp;&nbsp;<cite><?php comment_author_link() ?></cite> <?php _e("said:",TEMPLATE_DOMAIN); ?><br />
...
function manja_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'manja_admin_header_style'));
