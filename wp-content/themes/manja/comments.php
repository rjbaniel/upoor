...
<br />
  <?php if ( have_comments() ) : ?>
	<h3 id="comments"><?php comments_number('No Comments', 'One comment', '% Comments' );?> <?php _e('to');?>  &#8220;<?php the_title(); ?>&#8221;</h3>
...
<?php endif; // if you delete this an asteroid will fall on your head ?>
