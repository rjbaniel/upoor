	  ...
	  <?php $post = $posts[0]; // Thanks Kubrick for this code ?>
       ...
       <?php if(isset($_GET['author_name'])) : $curauth = get_userdatabylogin($author_name); else : $curauth = get_userdata(intval($author)); endif; ?>
		...
		<div class="post">
				...
				<h3 id="post-<?php the_ID(); ?>"><a href="<?php echo get_permalink() ?>" rel="bookmark" title="<?php _e('Permanent Link:',TEMPLATE_DOMAIN);?> <?php the_title(); ?>"><?php the_title(); ?></a></h3>
...
<?php } ?>
				...
				& <?php _e('Filed under',TEMPLATE_DOMAIN);?> <?php the_category(', ') ?> <strong>|</strong> <?php the_tags(__('Tags: '), ', ', '&nbsp;&nbsp;&nbsp;'); ?> <?php edit_post_link(__('Edit ',TEMPLATE_DOMAIN), '','<strong>|</strong>'); ?>  <?php comments_popup_link(__('No Comments &#187;',TEMPLATE_DOMAIN), __('1 Comment &#187;',TEMPLATE_DOMAIN), __('% Comments &#187;',TEMPLATE_DOMAIN)); ?>
				</p>
