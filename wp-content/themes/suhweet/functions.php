...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN','suhweet');
if (!defined('TEMPLATE_PATH')) define('TEMPLATE_PATH','suhweet');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
<?php } ?>&nbsp;&nbsp;<?php _e("By",TEMPLATE_DOMAIN); ?> <strong><?php comment_author_link() ?></strong> on <a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('M j, Y') ?></a> | <a href="#respond"><?php _e("Reply",TEMPLATE_DOMAIN); ?></a><?php edit_comment_link(__('Edit',TEMPLATE_PATH),' | ',''); ?></p>
		<?php if ($comment->comment_approved == '0') : ?>
		<em><?php _e('Your comment is awaiting moderation.',TEMPLATE_PATH);?></em>
		<?php endif; ?>
		<?php comment_text() ?>
...
function suhweet_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'suhweet_admin_header_style'));
