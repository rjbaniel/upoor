	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Custom Background",
				   ...
				   "type" => "upload",
				   "std" => "",
				   "desc" => "Place the file URL of your image in the field for your custom background image of the homepage. "
			),
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Black", "Blue", "Green", "Red")),
			...
			array( "name" => "Create Dropcaps",
                   ...
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to create Dropcaps. "),
			...
			array( "name" => "Show Read More Link on index pages",
                   "id" => $shortname."_readmore_button",
                   "type" => "checkbox2",
                   "std" => "false",
                   "desc" => "Here you can choose to show Read More on index pages. "),
