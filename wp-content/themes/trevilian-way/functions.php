...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN','trevilian-way');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'ty_admin_header_style'));
	...
	if ( function_exists('register_sidebar') )
	{
		...
		{
			wp_unregister_sidebar_widget('Links');
