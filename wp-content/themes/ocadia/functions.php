...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN','ocadia');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
<li <?php comment_class(' comment '); ?> id="comment-<?php comment_ID(); ?>">
			...
			<p class="commentauthor"><?php if (function_exists('avatar_display_comments')) { ?>
...
<?php } ?>&nbsp;&nbsp;
<?php comment_author_link() ?> <?php _e('said', TEMPLATE_DOMAIN); ?>,</p>
			<p class="commentmeta"><?php comment_date('F j, Y') ?> <?php _e('at', TEMPLATE_DOMAIN); ?> <a href="#comment-<?php comment_ID() ?>" title="<?php _e('Permanent link to this comment', TEMPLATE_DOMAIN); ?>"><?php comment_time() ?></a> <?php edit_comment_link(__("Edit", TEMPLATE_DOMAIN), ' &#183; ', ''); ?></p>
...
define('HEADER_IMAGE_WIDTH', 713); //width is fixed
define('HEADER_IMAGE_HEIGHT', 115);


function ocadia_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'ocadia_admin_header_style'));
...
function ocadia_widgets_init() {
	register_sidebars(1);
	wp_register_sidebar_widget('ocadia_search_1', __('Search'), 'ocadia_search', null, 'search');
	wp_unregister_widget_control('ocadia_search_1');
}
