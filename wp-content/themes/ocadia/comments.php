...
<!-- You can start editing here. -->
	...
	<h2 id="comments">
		<?php comments_number(__('Comments',TEMPLATE_DOMAIN), __('1 Comment',TEMPLATE_DOMAIN), __('% Comments',TEMPLATE_DOMAIN)); ?>
...
<?php cancel_comment_reply_link(); ?>
		...
		<?php else : ?>
			...
			<label for="email"><?php _e('E-mail',TEMPLATE_DOMAIN); ?> <?php if ($req) _e('(required)',TEMPLATE_DOMAIN); ?></label>
			</p>
	
			<p>
			<input type="text" name="url" id="url" value="<?php echo $comment_author_url; ?>" size="30" tabindex="3" />
			<label for="url"><abbr title="<?php _e('Uniform Resource Identifier',TEMPLATE_DOMAIN); ?>"><?php _e('URI',TEMPLATE_DOMAIN); ?></abbr></label>
			</p>
