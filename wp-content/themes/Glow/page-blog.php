		...
		<div id="et_pt_blog">
			...
			<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
				...
				<div class="et_pt_blogentry clearfix">
					...
					<p class="et_pt_blogmeta"><?php esc_html_e('Posted','Glow'); ?> <?php esc_html_e('by','Glow'); ?> <?php the_author_posts_link(); ?> <?php esc_html_e('on','Glow'); ?> <?php the_time(get_option('glow_date_format')) ?> <?php esc_html_e('in','Glow'); ?> <?php the_category(', ') ?> | <?php comments_popup_link(esc_html__('0 comments','Glow'), esc_html__('1 comment','Glow'), '% '.esc_html__('comments','Glow')); ?></p>
