	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Purple", "Blue", "Green", "Red")),
		...
		array( "name" => "general-3",
			...
			array( "name" => "Featured Category",
			       ...
			       "options" => $site_cats,
				   "desc" => "Here you can choose the category you would like to display in the Featured Slider. This option is only in effect if you have the Use Pages option disabled. "),
			...
			array( "name" => "Pause Autoscroll on hover",
                   ...
                   "type" => "checkbox2",
                   "std" => "false",
                   "desc" => "Here you can choose to pause the autoscroll on hover function. "),
			...
			array( "name" => "Automatic Animation Speed (in ms)",
                   ...
                   "validation_type" => "number",
			       "std" => "3000",
				   "desc" => "Here you can adjust the autoscroll speed in ms. "),
	...
	array( "name" => "wrap-colorization",
		...
		array( "name" => "colorization-1",
			...
			array( "name" => "Sidebar title background color",
				   "id" => $shortname."_color_sidebar_bgtitles",
				   "type" => "textcolorpopup",
				   "std" => "",
				   "desc" => "This option allows you to customize the color of a certain element of the theme. When you click inside the field a color picker will appear. Scroll to find your desired color and then click the circular submit button on the lower right to accept the value",),

			array( "name" => "Sidebar link color",
				   "id" => $shortname."_color_sidebar_link",
				   "type" => "textcolorpopup",
				   "std" => "",
				   "desc" => "This option allows you to customize the color of a certain element of the theme. When you click inside the field a color picker will appear. Scroll to find your desired color and then click the circular submit button on the lower right to accept the value",),

		    array( "name" => "Reply link color",
				   "id" => $shortname."_color_reply",
				   "type" => "textcolorpopup",
				   "std" => "",
				   "desc" => "This option allows you to customize the color of a certain element of the theme. When you click inside the field a color picker will appear. Scroll to find your desired color and then click the circular submit button on the lower right to accept the value",),
