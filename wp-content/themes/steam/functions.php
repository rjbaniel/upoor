...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN','steam');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
<?php } ?>&nbsp;&nbsp;<cite><?php comment_author_link() ?></cite> <?php _e('Says',TEMPLATE_DOMAIN);?>:
			...
			<small class="commentmetadata"><a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('F jS, Y') ?> <?php _e('at',TEMPLATE_DOMAIN);?> <?php comment_time() ?></a> <?php edit_comment_link(__('e',TEMPLATE_DOMAIN),'',''); ?></small>
...
function steam_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'steam_admin_header_style'));
