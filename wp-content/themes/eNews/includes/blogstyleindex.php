<div id="post-top">
	<div class="breadcrumb">
		<?php if(function_exists('bcn_display')) { bcn_display(); }
			...
			<?php if( is_tag() ) { ?>
				<?php esc_html_e('You are currently viewing','eNews') ?>: <em><?php esc_html_e('Posts Tagged &quot;','eNews') ?> <?php single_tag_title(); ?>&quot;</em>
			<?php } elseif (is_day()) { ?>
				<?php esc_html_e('You are currently viewing','eNews') ?>: <em><?php esc_html_e('Posts made in','eNews') ?> <?php the_time('F jS, Y'); ?></em>
			<?php } elseif (is_month()) { ?>
				<?php esc_html_e('You are currently viewing','eNews') ?>: <em><?php esc_html_e('Posts made in','eNews') ?> <?php the_time('F, Y'); ?></em>
			<?php } elseif (is_year()) { ?>
				<?php esc_html_e('You are currently viewing','eNews') ?>: <em><?php esc_html_e('Posts made in','eNews') ?> <?php the_time('Y'); ?></em>
			<?php } elseif (is_search()) { ?>
				<?php esc_html_e('Search results for','eNews') ?>: <em><?php the_search_query() ?></em>
			<?php } ?>
		<?php }; ?>
	</div> <!-- end breadcrumb -->
</div> <!-- end post-top -->
