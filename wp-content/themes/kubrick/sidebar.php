	<div id="sidebar">
		...
		<ul>
			...
			<p><?php _e('You are currently browsing the');?> <a href="<?php bloginfo('url'); ?>/"><?php echo bloginfo('name'); ?></a> <?php _e('blog archives');?>
			...
			<?php /* If this is the frontpage */ if ( is_home() || is_page() ) { ?>
				...
				<ul>
					...
					<li><a href="http://<?php echo $current_site->domain . $current_site->path ?>" title="<?php echo $current_network_site->site_name; ?>"><?php echo $current_network_site->site_name; ?></a></li>
					<?php wp_meta(); ?>
				</ul>
				</li>
			<?php } ?>
