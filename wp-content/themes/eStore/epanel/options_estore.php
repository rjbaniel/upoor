...
if ( class_exists( 'woocommerce' ) ) {
	$et_ecommerce_caterogies = get_terms( 'product_cat' );
	$site_cats = array();
	$cats_ids = array();
	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Currency Sign",
				   ...
				   "desc" => "Place the currency symbol you would like to display here. This setting is ignored if the WooCommerce plugin is used ( you can find the option on the plugin settings page ) "),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Display 'Deals Of The Day'",
                   ...
                   "type" => "checkbox",
				   "std" => "on",
				   "desc" => "Here you can choose to display the Deals Of The Day on the homepage. This option is ignored if WooCommerce plugin is used ( Deals of the Day scroller shows products marked as featured in such case. )"),
			...
			array( "name" => "'Deals Of The Day' Category",
                   ...
                   "type" => "select",
			       "options" => $site_cats,
				   "desc" => "Choose the category you would like to use for the Deals Of The Day section. "),
			...
			array( "name" => "Number of 'Deals Of The Day' Slides",
                   ...
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can choose the number of posts you would like to display in the Deals OF The Day section. "),
			...
			array( "name" => "Exclude categories from homepage recent posts",
				   ...
				   "taxonomy_name" => class_exists( 'woocommerce' ) ? "product_cat" : "category",
				   "options" => $cats_ids ),
