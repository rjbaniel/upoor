	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Default", "Green", "Purple", "Red")),
			...
			array( "name" => "Single Post Date format",
				   "id" => $shortname."_single_post_date_format",
				   "std" => "M j, Y",
                   "type" => "text",
                   "validation_type" => "nohtml",
				   "desc" => "This option allows you to change how your dates are displayed. For more information please refer to the WordPress codex here:<a href='http://codex.wordpress.org/Formatting_Date_and_Time' target='_blank'>Formatting Date and Time</a>"),
			...
			array( "name" => "Enable Ajax Functionality",
				   "id" => $shortname."_enable_ajax",
				   "type" => "checkbox2",
				   "std" => "on",
				   "desc" => "Here you can choose to use Ajax Functionality. "),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Homepage Title",
                   ...
                   "std" => "Welcome to sky theme",
                   "type" => "text",
                   "validation_type" => "nohtml",
				   "desc" => "Use the text field below for the Homepage Title. "),

			array( "name" => "Homepage Tagline",
                   "id" => $shortname."_homepage_tagline",
                   "std" => "Your Super Awesome Description Text Goes Right Over Here",
                   "type" => "text",
				   "desc" => "Use the text field below for the Homepage Tagline. "),
