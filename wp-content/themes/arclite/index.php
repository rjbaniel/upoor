       ...
       <?php while (have_posts()) : the_post(); ?>
        ...
        <div id="post-<?php the_ID(); ?>" <?php if (function_exists("post_class")) post_class(); else print 'class="post"'; ?>>
          ...
          <div class="post-header">
           ...
           <p class="post-author">
            <span class="info"><?php printf(__('Posted by %s in %s','arclite'),'<a href="'. get_author_posts_url(get_the_author_meta('ID')) .'" title="'. sprintf(__("Posts by %s","arclite"), esc_attr(get_the_author())).' ">'. get_the_author() .'</a>',get_the_category_list(', '));
          ...
          <?php } ?>
           ...
           <?php $arclite_social_bookmark = get_option('arclite_social_bookmark');  if ($arclite_social_bookmark == 'enable') { ?>
           <?php if(( is_home() ) || ( is_single() )) { ?>
           <?php custom_post_social(); ?>
           <?php } ?>
           <?php } ?>
