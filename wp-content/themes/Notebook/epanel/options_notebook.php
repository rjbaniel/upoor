	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => esc_html__("Background Image",$themename),
				   ...
				   "type" => "upload",
				   "std" => "",
				   "desc" => esc_html__("Place the file URL of the image you would like to use as your background. ",$themename)
			),
			...
			array( "name" => esc_html__("Show Control Panel",$themename),
				   ...
				   "type" => "checkbox2",
				   "std" => "on",
				   "desc" => esc_html__("Here you can choose to display the CSS control panel on the homepage. This will only be visible to users that are logged in as an Administrator. ",$themename)
			),
