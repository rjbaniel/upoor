...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'deichnetz');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
load_theme_textdomain('deichnetz', TEMPLATEPATH . '/languages/');
...
<?php } ?>
&nbsp;&nbsp; <?php comment_author_link() ?> &#8212; <?php comment_date() ?> @ <a href="#comment-<?php comment_ID() ?>"><?php comment_time() ?></a></cite> <br /><?php edit_comment_link(__("Edit This",'deichnetz')); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?></p>


<?php if ($comment->comment_approved == '0') : ?>
<em><?php _e('Your comment is awaiting moderation.','deichnetz'); ?></em>
<?php endif; ?>
<?php comment_text() ?>
...
define('HEADER_IMAGE', '%s/pics/header.jpg'); // %s is theme dir uri
define('HEADER_IMAGE_WIDTH', 570); //width is fixed
define('HEADER_IMAGE_HEIGHT', 200);

function deichnetz_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'deichnetz_admin_header_style'));
