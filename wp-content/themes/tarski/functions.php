...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN','tarski');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
if ($comment->comment_author_email == get_the_author_meta('email')) { $author_com = ' author-comment'; }
?>
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'tarski_admin_header_style'));
