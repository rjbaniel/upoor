<?php
	...
	$et_post_thumb = sprintf( $et_thumb_size_format,
		intval( get_option( 'bold_thumbnail_width_posts', 200 ) ),
		intval( get_option( 'bold_thumbnail_height_posts', 200 ) )
	);
	$et_page_thumb = sprintf( $et_thumb_size_format,
		intval( get_option( 'bold_thumbnail_width_pages', 200 ) ),
		intval( get_option( 'bold_thumbnail_height_pages', 200 ) )
	);

	$et_theme_image_sizes = array(
		$et_post_thumb	=> 'et-posts-thumb',
		$et_page_thumb	=> 'et-pages-thumb',
		'85x85' 	=> 'et-default-thumb',
	);
