	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Light-Red", "Light-Blue", "Light-Green", "Light-Purple", "Light-Turquoise")),
		...
		array( "name" => "general-2",
			...
			array(  "name" => "Number of Random Articles displayed in the homepage",
            		"id" => $shortname."_random",
            		"std" => "8",
            		"type" => "text",
            		"validation_type" => "number",
 					"desc" => "Here you can designate how many random articles are displayed on the homepage, if enabled."),

			array(  "name" => "Number of Popular Articles displayed in the homepage",
            		"id" => $shortname."_popular_count",
            		"std" => "8",
            		"type" => "text",
            		"validation_type" => "number",
 					"desc" => "Here you can designate how many popular articles are displayed on the homepage, if enabled."),
		...
		array( "name" => "general-3",
			...
			array( "name" => "Featured Category",
			       ...
			       "options" => $site_cats,
				   "desc" => "Here you can choose the category of posts that will display in the Featured Articles area of the homepage. "),
	...
	array( "name" => "wrap-layout",
		...
		array( "name" => "layout-3",
			...
			array( "name" => "Display popular articles",
                   "id" => $shortname."_popular_display",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "If you don't want to display the random articles on the homepage then simply disable this option."),

			array( "name" => "Display random articles",
                   "id" => $shortname."_random_display",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "If you don't want to display the popular articles on the homepage then simply disable this option."),

			array( "name" => "Display homepage sidebar",
                   "id" => $shortname."_display_sidebar",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "If you don't want to display the inside sidebar on the homepage then simply disable this option."),
		...
		array( "name" => "layout-4",
			...
			array( "name" => "Display connect icons",
                   "id" => $shortname."_display_connect",
                   "type" => "checkbox",
                   "std" => "on",
			...
			array( "name" => "Display Slogan",
            "id" => $shortname."_display_slogan",
            "type" => "checkbox2",
            "std" => "on",
			"desc" => "If you would like to remove the slogan from the header simply disable this option. "),
