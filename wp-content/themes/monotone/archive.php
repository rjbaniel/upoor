...
--></script>
 	  ...
 	  <?php /* If this is a category archive */ if (is_category()) { ?>
		<h2><?php _e('Archive for the', 'monotone'); ?> &#8216;<?php single_cat_title(); ?>&#8217; <?php _e('Category', 'monotone'); ?></h2>
 	  <?php /* If this is a tag archive */ } elseif( is_tag() ) { ?>
		<h2><?php _e('Posts Tagged', 'monotone'); ?> &#8216;<?php single_tag_title(); ?>&#8217;</h2>
 	  <?php /* If this is a daily archive */ } elseif (is_day()) { ?>
		<h2><?php _e('Archive for', 'monotone'); ?> <?php the_time('F jS, Y'); ?></h2>
 	  <?php /* If this is a monthly archive */ } elseif (is_month()) { ?>
		<h2><?php _e('Archive for', 'monotone'); ?> <?php the_time('F, Y'); ?></h2>
 	  <?php /* If this is a yearly archive */ } elseif (is_year()) { ?>
		<h2><?php _e('Archive for', 'monotone'); ?> <?php the_time('Y'); ?></h2>
