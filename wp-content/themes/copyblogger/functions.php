...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'copyblogger');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
load_theme_textdomain('copyblogger', TEMPLATEPATH . '/languages/');
...
<dt<?php if ($comment->comment_author_email == get_the_author_meta('email')) { ?> <?php comment_class('author'); ?><?php } ?>>
<div class="arrow"></div> 
...
<?php } ?>&nbsp;&nbsp;<strong><?php comment_author_link() ?> </strong><?php _e('on');?> <?php comment_date('m.d.y') ?> <?php _e('at');?> <?php comment_time() ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?>
</dt>
<dd class="entry<?php if ($comment->comment_author_email == get_the_author_meta('email')) { ?> author<?php } ?>">
<?php comment_text() ?>
<?php if ($comment->comment_approved == '0') : ?>
<p><strong><?php _e('Your comment is awaiting moderation.','copyblogger');?></strong></p>
<?php endif; ?><br />
</dd>
...
define('HEADER_IMAGE_WIDTH', 800); //width is fixed
define('HEADER_IMAGE_HEIGHT', 150);
define('NO_HEADER_TEXT', true );

function copyblogger_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'copyblogger_admin_header_style'));
