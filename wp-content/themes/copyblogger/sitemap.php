...
<?php get_header(); ?>
	...
	<div id="content_box">
		...
		<div id="content" class="page">
			...
			<h1><?php the_title(); ?></h1>
			<div class="entry">
				<p><strong><?php _e('All internal pages:','copyblogger');?></strong></p>
				<ul>
					<?php wp_list_pages('title_li='); ?>
				</ul>
				<p><strong><?php _e('All internal blog posts'):?>:</strong></p>
				<ul>
					<?php $archive_query = new WP_Query('showposts=1000');
						while ($archive_query->have_posts()) : $archive_query->the_post(); ?>
					<li><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php _e('Permanent Link to','copyblogger');?> <?php the_title(); ?>"><?php the_title(); ?></a> <strong><?php comments_number('0', '1', '%'); ?></strong></li>
					<?php endwhile; ?>
				</ul>
				<p><strong><?php _e('Monthly archive pages:','copyblogger');?></strong></p>
				<ul>
					<?php wp_get_archives('type=monthly'); ?>
				</ul>
				<p><strong><?php _e('Topical archive pages:','copyblogger');?></strong></p>
				<ul>
					<?php wp_list_categories('title_li=0'); ?>
				</ul>
				<p><strong><?php _e('Available RSS Feeds','copyblogger'):?>:</strong></p>
				<ul>
