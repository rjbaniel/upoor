<?php get_header(); ?>
	...
	<div id="content_box">
		...
		<?php if (have_posts()) : ?>
			...
			<h1><?php _e('Entries Tagged');?>  '<?php echo single_cat_title(); ?>' &darr;</h1>
			
			<?php /* If this is a monthly archive */ } elseif (is_month()) { ?>
			<h1><?php _e('Entries from');?> <?php the_time('F Y'); ?> &darr;</h1>
...
<?php the_post_thumbnail(); ?></div><?php } } ?>
		...
		<?php else : ?>
			...
			<h2><?php _e("Welp, we couldn't find that...try again?");?></h2>
			<p class="post_date">* * *</p>
			<div class="entry">
