	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Red", "Blue", "Green", "Purple")),
			...
			array( "name" => "Cufon Font Replacement",
			   ...
			   "type" => "checkbox2",
			   "std" => "on",
			   "desc" => "Here you can enable cufon font replacement. "),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Include categories in the Recent scroller",
				   "id" => $shortname."_feat_categories",
				   "type" => "checkboxes",
				   "std" => "",
				   "desc" => "Here you can choose the categories you would like to display in the Recent Scroller on the homepage. ",
				   "usefor" => "categories",
				   "excludeDefault" => "true",
				   "options" => $cats_ids),

			array( "name" => "Display Recent From Boxes",
				   "id" => $shortname."_show_recent_boxes",
				   "type" => "checkbox",
				   "std" => "on",
				   "desc" => "Here you can choose to display the Recent posts as boxes. "),
