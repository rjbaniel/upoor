...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'greenery');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
<?php if ($comment->comment_author_email == get_the_author_meta('email')) { $alt_x = 'adminreply'; } ?>
<li <?php comment_class($alt_x . 'item'); ?> id="comment-<?php comment_ID(); ?>">
		<!-- Comment Counter -->
...
<?php } ?>
		...
		<h3 class="commenttitle"><?php comment_author_link() ?> <?php _e('said',TEMPLATE_DOMAIN); ?>,</h3>
...
add_theme_support( 'custom-header', array('wp-head-callback' => 'header_style', 'admin-head-callback' => 'greenery_10_admin_header_style'));
