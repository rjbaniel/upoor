...
<h3><?php comment_form_title( __('Leave a Reply',TEMPLATE_DOMAIN), __('Leave a Reply to %s',TEMPLATE_DOMAIN) ); ?></h3>
...
<p><input name="submit" type="submit" id="submit" tabindex="5" value="<?php _e("Submit Comment",TEMPLATE_DOMAIN); ?>" /></p>
