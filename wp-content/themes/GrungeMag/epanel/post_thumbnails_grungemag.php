<?php
	...
	$et_page_thumb = sprintf( $et_thumb_size_format,
		intval( get_option( 'grungemag_thumbnail_width_pages', 185 ) ),
		intval( get_option( 'grungemag_thumbnail_height_pages', 185 ) )
	);

	$et_theme_image_sizes = array(
		$et_page_thumb	=> 'et-pages-thumb',
		'80x80' 	=> 'et-single-thumb',
		'100x100' 	=> 'et-category_box-thumb',
		'281x130' 	=> 'et-default-thumb',
		'60x60' 	=> 'et-defaultindex-thumb',
		'155x123' 	=> 'et-scroller-thumb',
	);
