...
$options = array (
	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Display Tabbed Sidebar Menu",
				   "id" => $shortname."_show_tabbed",
				   "type" => "checkbox",
				   "std" => "on",
				   "desc" => "Here you can choose to display the Tabbed Sidebar Menu on the homepage. "),
			...
			array( "name" => "Number of Recent Entries displayed in Sidebar",
				   ...
				   "desc" => "Here you can choose the number of Recent Entries in the Tabbed Sidebar. "),
			...
			array( "name" => "Number of Recent Comments displayed in Sidebar",
                   ...
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can choose the number of Recent Comments in the Tabbed Sidebar. "),

			array( "name" => "About Us Text",
				   "id" => $shortname."_abouttext",
				   "type" => "textarea",
				   "std" => "",
				   "desc" => "You can use this text area to edit the About Us tab in the Sidebar. ",),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Number of Recent Posts displayed in the Scroller",
                   "id" => $shortname."_scroller_num",
                   "std" => "11",
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can choose the number of Recent Posts displayed in the Scroller on the homepage. "),

			array( "name" => "Display Scroller",
                   "id" => $shortname."_show_scroller",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to display the Scroller on the homepage. "),

			array( "name" => "Display Popular Articles",
                   "id" => $shortname."_show_popular",
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => "Here you can choose to display Popular Articles on the homepage. "),

			array( "type" => "clearfix",),

			array( "name" => "Display Random Articles",
                   "id" => $shortname."_show_random",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to display Random Articles on the homepage. "),
			...
			array( "name" => "Number of Popular Articles",
                   ...
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can choose the number of Popular Articles on the homepage. "),
			...
			array( "name" => "Number of Random Articles",
                   ...
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can choose the number of Random Articles on the homepage. "),
			...
			array( "name" => "Recent From Category 1",
				   ...
				   "desc" => "Here you can choose the category you would like to display in the Recent From section."),
			...
			array( "name" => "Recent From Category 4",
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "wrap-advertisements",
		...
		array( "name" => "advertisements-1",
			...
			array( "name" => "Enable 468x60 Header banner",
			...
			array( "name" => "Input 468x60 Header advertisement banner image",
			...
			array( "name" => "Input 468x60 Header advertisement destination url",
			...
			array( "name" => "Input 468x60 Header adsense code",
