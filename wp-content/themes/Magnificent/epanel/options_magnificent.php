	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Default", "Light-Blue", "Light-Green", "Light-Red", "Lights", "Radiate", "Wooden")),
			...
			array( "name" => "Quote text",
                   "id" => $shortname."_quote",
                   "std" => "Here Is Your Slogan <span>&amp;</span> Something Else Here",
                   "type" => "text",
				   "desc" => "Use the text area below to customize your slogan on the homepage. "),
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "wrap-layout",
		...
		array( "name" => "layout-3",
			...
			array( "name" => "Show Thumbs on Index pages (in Blog style mode)",
