				...
				<?php
					...
					if (!$send) { ?>
						...
						<div class="post-content">
							...
							?>
							<p class="post-info">* - <?php _e('Required Fields','ml');?></p>
							<?php echo $error_msg;?>
							<form method="post" action="<?php echo "http://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>" id="contactform">
								...
								<fieldset>
									...
									<strong><?php _e('Message','ml');?></strong>*<br/>
					...
					<?php
						...
						if (@mail(get_option('admin_email'), $email_subject, $email_text, $header)) {
							echo "<h2>" . __('Hey','ml') . " " . $displayName . ",</h2><p>".__('thanks for your message! I\'ll get back to you as soon as possible.','ml')."</p>";
						}
					}
					?>
				<?php endwhile; ?>
