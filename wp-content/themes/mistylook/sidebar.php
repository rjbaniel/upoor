...
<li class="sidebox">
	...
	<ul>
		...
		{
			wp_list_categories('optioncount=1');
		}
		?>
	</ul>
</li>
...
<li class="sidebox">
	...
	<ul>
		...
		<li><a href="http://wordpress.org/" title="<?php _e('Provided by WordPress, state-of-the-art semantic personal publishing platform.','ml');?>">WordPress</a></li>
		<?php wp_meta(); ?>
	</ul>
</li>
<?php }?>
