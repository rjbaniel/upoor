...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'almost-spring');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
load_theme_textdomain('almost-spring', TEMPLATEPATH . '/languages/');
...
set_post_thumbnail_size( 200, 160, true ); // Normal post thumbnails
...
<?php } ?><?php comment_author_link() ?> <?php _e('Said', 'almost-spring'); ?>,
</h3>
...
<?php edit_comment_link(__("Edit", 'almost-spring'), ' &#183; ', ''); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?>

</p>


<?php if ('0' == $comment->comment_approved) { ?><p><strong><?php _e('Your comment is awaiting moderation.'); ?></strong></p><?php } else { comment_text(); } ?>
...
function spring_admin_header_style() { ?>
<style type="text/css">
...
if (function_exists('add_theme_support')) {
add_theme_support( 'custom-header', array('admin-head-callback' => 'spring_admin_header_style'));
}
