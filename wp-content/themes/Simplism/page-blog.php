					...
					<div id="et_pt_blog">
						...
						<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
							...
							<div class="et_pt_blogentry clearfix">
								...
								<p class="et_pt_blogmeta"><?php esc_html_e('Posted','Simplism'); ?> <?php esc_html_e('by','Simplism'); ?> <?php the_author_posts_link(); ?> <?php esc_html_e('on','Simplism'); ?> <?php the_time(get_option('simplism_date_format')) ?> <?php esc_html_e('in','Simplism'); ?> <?php the_category(', ') ?> | <?php comments_popup_link(esc_html__('0 comments','Simplism'), esc_html__('1 comment','Simplism'), '% '.esc_html__('comments','Simplism')); ?></p>
								...
								<?php if (!$et_ptemplate_blogstyle) { ?>
									...
									<a href="<?php the_permalink(); ?>" class="readmore"><span><?php esc_html_e('read more','Simplism'); ?></span></a>
								<?php } else { ?>
									<?php
										global $more;
										$more = 0;
