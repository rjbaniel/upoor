...
$options = array (
	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Adsense code (468x60)",
		...
		array( "name" => "general-2",
			...
			array( "name" => "Show Popular Area",
                   ...
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to display the Populare Area on the homepage. "),
			...
			array( "name" => "Recent posts number",
				   ...
				   "validation_type" => "number",
				   "std" => "6",
				   "desc" => "Here you can choose the number of Recent Posts to display. ",),
			...
			array( "name" => "Popular posts number",
				   ...
				   "validation_type" => "number",
				   "std" => "6",
				   "desc" => "Here you can choose the number of Popular Posts to display. ",),
			...
			array( "name" => "Recent comments number",
				   ...
				   "validation_type" => "number",
				   "std" => "6",
				   "desc" => "Here you can choose the number of Recent Comments to display. ",),
			...
			array( "name" => "Number of Posts displayed on Homepage",
                   ...
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can choose the number of Posts displayed on the homepage. "),
