	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Tagline",
                   ...
                   "type" => "text",
				   "desc" => "Place your tagline in the text field below. "),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Gallery Category on Homepage",
                   ...
                   "type" => "select",
			       "options" => $site_cats,
				   "desc" => "Here you can choose the category for the Gallery on the homepage. "),
			...
			array( "name" => "Number Of Gallery Items on Homepage",
                   ...
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can choose the number of Gallery Items you would like to display on the homepage. "),
			...
			array( "name" => "Footer Quote Url",
                   ...
                   "type" => "text",
                   "validation_type" => "url",
				   "desc" => "Place the destination URL you would like for the Footer Quote on the homepage. "),
			...
			array( "name" => "Use Content Area 3 Page",
                   ...
                   "type" => "checkbox",
                   "std" => "false",
                   "desc" => "Here you can choose to use the Content Area Page 3 on the homepage. "),
			...
			array( "name" => "Content Area 3 Page",
				   ...
				   "std" => "",
				   "type" => "select",
				   "desc" => "Here you can choose to the page you would like to display in the content area on the homepage. ",
				   "options" => $site_pages,
				   'et_array_for' => 'pages'),
