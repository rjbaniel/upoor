			...
			<div id="et_pt_blog">
				...
				<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
					...
					<div class="et_pt_blogentry clearfix">
						...
						<p class="et_pt_blogmeta"><?php esc_html_e('Posted','Modest'); ?> <?php esc_html_e('by','Modest'); ?> <?php the_author_posts_link(); ?> <?php esc_html_e('on','Modest'); ?> <?php the_time(get_option('modest_date_format')) ?> <?php esc_html_e('in','Modest'); ?> <?php the_category(', ') ?> | <?php comments_popup_link(esc_html__('0 comments','Modest'), esc_html__('1 comment','Modest'), '% '.esc_html__('comments','Modest')); ?></p>
						...
						<?php if (!$et_ptemplate_blogstyle) { ?>
							...
							<a href="<?php the_permalink(); ?>" class="readmore"><span><?php esc_html_e('read more','Modest'); ?></span></a>
						<?php } else { ?>
							<?php
								global $more;
								$more = 0;
