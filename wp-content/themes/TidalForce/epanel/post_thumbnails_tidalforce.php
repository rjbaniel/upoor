<?php
	...
	$et_post_thumb = sprintf( $et_thumb_size_format,
		intval( get_option( 'tidalforce_thumbnail_width_posts', 84 ) ),
		intval( get_option( 'tidalforce_thumbnail_height_posts', 84 ) )
	);
	$et_page_thumb = sprintf( $et_thumb_size_format,
		intval( get_option( 'tidalforce_thumbnail_width_pages', 84 ) ),
		intval( get_option( 'tidalforce_thumbnail_height_pages', 84 ) )
	);
	$et_usual_thumb = sprintf( $et_thumb_size_format,
		intval( get_option( 'tidalforce_thumbnail_width_usual', 84 ) ),
		intval( get_option( 'tidalforce_thumbnail_height_usual', 84 ) )
	);
	...
	$et_theme_image_sizes = array(
		...
		'200x200' 	=> 'et-home-thumb',
		'44x44' 	=> 'et-random-thumb',
		'84x84' 	=> 'et-entry-thumb',
	);
