...
$options = array (
	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Show Search/Subscribe/Popular Tags in the Sidebar",
				   "id" => $shortname."_show_sidebardark",
				   "type" => "checkbox2",
				   "std" => "on",
				   "desc" => "Here you can choose to display the Search/Subscribe/Popular Tags in the Sidebar. "),
			...
			array( "name" => "Number of Featured Posts in the Footer Area",
                   "id" => $shortname."_feat_cat_foooternum",
                   "std" => "5",
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can choose to display the number of Featured Posts in the Footer Area. "),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Show Homepage Tabbed Area",
                   "id" => $shortname."_show_home_tabarea",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to display the Homepage Tabbed Area. "),

			array( "name" => "Show Featured Area",
                   "id" => $shortname."_show_tabarea_featured",
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => "Here you can choose to display the Featured Area. "),
			...
			array( "name" => "Show Popular Area",
                   ...
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to display the Popular Area. "),

			array( "name" => "Show Recent Comments Area",
                   "id" => $shortname."_show_tabarea_recentcomments",
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => "Here you can choose to display the Recent Comments Area. "),
			...
			array( "name" => "Show Recent Entries Area",
                   ...
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to display the Recent Entries Area. "),

			array( "name" => "Show Random Articles box",
                   "id" => $shortname."_show_tabarea_randomarticles",
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => "Here you can choose to display the Random Articles box. "),

			array( "type" => "clearfix",),

			array( "name" => "Show About box",
                   "id" => $shortname."_show_about_box",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to display the About box. "),
			...
			array( "name" => "Popular posts number",
				   ...
				   "validation_type" => "number",
				   "std" => "6",
				   "desc" => "Here you can choose the number of posts you would like to display. ",),
			...
			array( "name" => "Random posts number",
				   "id" => $shortname."_randomposts_num",
				   "type" => "text",
				   "validation_type" => "number",
				   "std" => "6",
				   "desc" => "Here you can choose the number of posts you would like to display. ",),
			...
			array( "name" => "About Us Text",
				   ...
				   "type" => "textarea",
				   "std" => "",
				   "desc" => "Use the textarea below for the About Us section. ",),

			array( "name" => "Number of homepage posts",
