...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'citrus-islandWP');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
load_theme_textdomain('citrus', TEMPLATEPATH . '/languages/');
...
<li style="list-style:none;" <?php comment_class(); ?> id="comment-<?php comment_ID(); ?>">
...
<?php } ?>&nbsp;&nbsp;<?php comment_author_link() ?>
			...
			<em><?php _e('Your comment is awaiting moderation.','citrus');?></em>
			<?php endif; ?>
			<br />

			<small class="commentmetadata"><a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('F jS, Y') ?> <?php _e('at','citrus');?> <?php comment_time() ?></a> <?php edit_comment_link(__('Edit','citrus'),'',''); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?></small>
</div>
			<?php comment_text() ?>
...
define('HEADER_IMAGE_WIDTH', 850); //width is fixed
define('HEADER_IMAGE_HEIGHT', 150);
define('NO_HEADER_TEXT', true );

function citrus_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'citrus_admin_header_style'));
