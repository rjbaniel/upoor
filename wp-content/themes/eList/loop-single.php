<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
	...
	<?php
		if ( get_option('elist_468_enable') == 'on' ){
			if ( get_option('elist_468_adsense') <> '' ) echo( get_option('elist_468_adsense') );
			else { ?>
			   <a href="<?php echo esc_url(get_option('elist_468_url')); ?>"><img src="<?php echo esc_attr(get_option('elist_468_image')); ?>" alt="468 ad" class="foursixeight" /></a>
	<?php 	}
		}
	?>
