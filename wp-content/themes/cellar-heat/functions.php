...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'cellar-heat');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
load_theme_textdomain('cellar-heat', TEMPLATEPATH . '/languages/');
...
<?php } ?>
			...
			<span class="comment-metadata"><?php _e('wrote on'); ?> <?php comment_date('F jS, Y') ?> <?php edit_comment_link(__('edit','cellar-heat'),'&nbsp;&nbsp;',''); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?></span>
...
function cellar_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'cellar_admin_header_style'));
		...
		foreach ($comments as $comment) {
			...
			?>
				...
				<li>
					...
					<span class="listMeta">by <strong><?php echo dp_get_author($comment); ?></strong></span></a>
...
function previous_post_excerpt($in_same_cat = false, $excluded_categories = '') {
	...
	if ( is_attachment() )
		...
		$post = get_previous_posts_link($in_same_cat, $excluded_categories);
...
function next_post_excerpt($in_same_cat = false, $excluded_categories = '') {
	...
	$post = get_next_post_link($in_same_cat, $excluded_categories);
