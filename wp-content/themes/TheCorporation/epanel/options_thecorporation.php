	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Blue", "Green", "Purple", "Refined", "Refined-Red", "Refined-Silver")),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Display Services",
                   ...
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to display the Services section on the homepage. "),

			array( "name" => "Display Sidebar Widgets on Homepage",
                   "id" => $shortname."_homepage_widgets",
                   "type" => "checkbox2",
                   "std" => "false",
                   "desc" => "Here you can choose to display the Sidebar Widgets on the homepage. "),
			...
			array( "name" => "Service Page 1",
				   ...
				   "std" => "",
				   "type" => "select",
				   "desc" => "Choose the page you would like to display in the Service Page. ",
				   "options" => $site_pages,
				   'et_array_for' => 'pages'),
