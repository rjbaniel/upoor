...
<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar() ) : ?>
			...
			<form method="get" id="searchform" action="<?php bloginfo('url'); ?>/">
				...
				<input type="submit" id="searchsubmit" class="bt" value="<?php _e('GO', 'japan-style'); ?>" /></p>
			</form>
		</div>
	
	<div class="block">
		<h3><?php _e('Categories', 'japan-style'); ?></h3>
		<ul>
	...
	<div class="block">
		<h3><?php _e('Archive', 'japan-style'); ?></h3>
		<ul>
	...
	<div class="block">
		<h3><?php _e('Blogroll', 'japan-style'); ?></h3>
		<ul>
		...
		<p><?php _e('Hello! welcome to my blog.', 'japan-style'); ?></p>
	</div>		
	
	<div class="block">
		<h3><?php _e('Meta', 'japan-style'); ?></h3>
		<ul>
			<?php wp_register(); ?>
