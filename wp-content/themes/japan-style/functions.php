...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'japan-style');
...
load_theme_textdomain('japan-style', TEMPLATEPATH . '/languages/');
...
<?php avatar_display_comments(get_comment_author_email(),'50',''); ?>
<?php } else { ?>
...
<?php } ?>
				...
				<div class="comment-content">
					<div class="comment-info"><span><?php comment_author_link() ?></span><?php comment_date('F jS, Y') ?> at <?php comment_time() ?> <?php edit_comment_link(__('edit','japan-style'),'&nbsp;&nbsp;',''); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?></div>

					<?php if ($comment->comment_approved == '0') : ?>
						<em><?php _e('Your comment is awaiting moderation.','japan-style'); ?></em>
					<?php endif; ?>
