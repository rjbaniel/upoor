...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN','reaching-darkness');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
<div class="commentmetadata"><?php if (function_exists('avatar_display_comments')) { ?>
...
<?php } ?>&nbsp;&nbsp;
<strong><?php comment_author_link() ?></strong> <?php _e('Said&#58;',TEMPLATE_DOMAIN); ?><br />
<a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('F jS, Y') ?> <?php comment_time() ?></a>&nbsp;&nbsp;&nbsp;
<?php edit_comment_link(__('Edit Comment',TEMPLATE_DOMAIN),'',''); ?>&nbsp;&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?>
