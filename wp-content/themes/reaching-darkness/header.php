...
<div id="feed">
<ul class="feed">
<li><a href="<?php bloginfo('rss_url'); ?>" title="Entries Feed"><?php _e("Entries RSS",TEMPLATE_DOMAIN); ?></a></li>
<li><a href="<?php bloginfo('comments_rss2_url'); ?>" title="Comments Feed"><?php _e("Comments RSS",TEMPLATE_DOMAIN); ?></a></li>
</ul>
</div><!-- feed -->
</div><!-- header -->
