	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-2",
			...
			array( "name" => "Quote Text",
                   ...
                   "std" => "Vivamus id feugiat ligula. Nulla facilisi. Integer lacus justo, elementum eget consequat a, molestie nec sapien. Quisque tincidunt, nunc vitae",
                   "type" => "text",
				   "desc" => "Here you can define the text that appears in the homepage quote."),

			array( "name" => "Quote Url",
                   "id" => $shortname."_quote_url",
                   "std" => "#",
                   "type" => "text",
                   "validation_type" => "url",
				   "desc" => "You can place an external URL you would like the Additional Info to link to. "),

			array( "name" => "Number of Posts in Media section",
                   "id" => $shortname."_posts_media",
                   "std" => "10",
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can designate how many recent articles are displayed in Media section on homepage."),
