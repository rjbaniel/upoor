				...
				<div id="et_pt_blog">
					...
					<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
						...
						<div class="et_pt_blogentry clearfix">
							...
							<p class="et_pt_blogmeta"><?php esc_html_e('Posted','Envisioned'); ?> <?php esc_html_e('by','Envisioned'); ?> <?php the_author_posts_link(); ?> <?php esc_html_e('on','Envisioned'); ?> <?php the_time(get_option('envisioned_date_format')) ?> <?php esc_html_e('in','Envisioned'); ?> <?php the_category(', ') ?> | <?php comments_popup_link(esc_html__('0 comments','Envisioned'), esc_html__('1 comment','Envisioned'), '% '.esc_html__('comments','Envisioned')); ?></p>
