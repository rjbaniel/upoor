...
<div id="header">
    ...
    <a href="<?php bloginfo('rss2_url'); ?>" class="topnav_rss">RSS</a>
    <a href="<?php bloginfo('url'); ?>/contact" class="topnav_contact">Contact</a>
    </div>
...
<a href="<?php bloginfo('url'); ?>"><img style="margin-top: 20px;" class="centered" src="<?php header_image(); ?>" alt="<?php bloginfo('name'); ?>" /></a>
<?php } ?>
