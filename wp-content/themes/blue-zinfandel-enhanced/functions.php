...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'blue-zinfandel-enhanced');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
load_theme_textdomain('blue-zinfandel', TEMPLATEPATH . '/languages/');
...
<?php } ?>&nbsp;&nbsp;   <?php comment_author_link()?> <?php _e('on');?> <?php comment_date('F j, Y') ?>
        <?php comment_time()?>
		<?php edit_comment_link(__("Edit This",'blue-zinfandel'), ''); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?>

      <?php if ($comment->comment_approved == '0') : ?>
      <em><?php _e('Your comment is awaiting moderation.','blue-zinfandel');?></em>
      <?php endif; ?>
      <?php
...
function bluezinfandel_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'bluezinfandel_admin_header_style'));
