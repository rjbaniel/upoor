	...
	<div id="content">
				...
				<div class="post">
					...
					<div class="postbody grid_7 omega first">
						...
						<h2><?php _e('Sitemap', 'blogtheme'); ?></h2>
                        ...
                        <h2><?php _e('Categories', 'blogtheme'); ?></h2>
                    ...
                    ?>
                        ...
                        <ul>	
                                ...
                                <li style="font-weight:normal !important;"><a href="<?php the_permalink() ?>"><?php the_title(); ?></a> - <?php _e('Comments', 'blogtheme'); ?> (<?php echo $post->comment_count ?>)</li>
