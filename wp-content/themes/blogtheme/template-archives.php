					...
					<div class="postbody grid_7 omega first">
                        ...
                        <ul>
                            ...
                            <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
                                ...
                                <li><a href="<?php the_permalink() ?>"><?php the_title(); ?></a> - <?php the_time('j F Y') ?> - <?php echo $post->comment_count ?> <?php _e('comments', 'blogtheme'); ?></li>
                        ...
                        <h2><?php _e('Monthly Archives', 'blogtheme'); ?></h2>
