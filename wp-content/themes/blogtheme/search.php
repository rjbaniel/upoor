				...
				<div class="post">
					...
					<div class="meta grid_2 alpha">
						...
						<ul>
							...
							<li class="comms"><a href="<?php comments_link(); ?>"><?php comments_number('0','1','%'); ?>
                            <?php _e('Comments', 'blogtheme'); ?></a></li>
					...
					<div class="postbody grid_7 omega <?php if ( $counter == 1 ) { ?>first<?php } ?>">
						...
						<div class="entry">
							 ...
							 <?php if ( get_option('woo_the_content') ) { the_content(); } else { the_excerpt(); ?><p><a href="<?php the_permalink() ?>" title="<?php the_title(); ?>"><?php _e('Continue Reading...', 'blogtheme'); ?></a></p><?php } ?>
