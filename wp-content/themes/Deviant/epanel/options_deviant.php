	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Red", "Blue", "Green", "Purple", "Orange", "Black")),
	...
	array( "name" => "wrap-layout",
		...
		array( "name" => "layout-1",
			...
			array( "name" => "Display Thumb on Post Pages",
            	   ...
            	   "type" => "checkbox2",
            	   "std" => "on",
            	   "desc" => "You can disable this option if you would like to remove Thumbnails from posts. "),
			...
			array( "name" => "Thumbnail width (pixels)",
            	   ...
            	   "validation_type" => "number",
            	   "std" => "200",
				   "desc" => "Here you can choose the thumbnail width in pixels.  "),
			...
			array( "name" => "Thumbnail height (pixels)",
            	   ...
            	   "validation_type" => "number",
            	   "std" => "200",
				   "desc" => "Here you can choose the thumbnail height in pixels. "),
		...
		array( "name" => "layout-3",
			...
			array( "name" => "Display Thumb on Index Pages",
            	   "id" => $shortname."_index_thumbnails",
            	   "type" => "checkbox",
            	   "std" => "on",
            	   "desc" => "If you would like to remove thumbnails for all index pages then disable this option."),
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "wrap-colorization",
		...
		array( "name" => "colorization-1",
			...
			array( "name" => "Post title background color",
				   "id" => $shortname."_color_heading_bg",
				   "type" => "textcolorpopup",
				   "std" => "",
				   "desc" => "This option allows you to customize the color of a certain element of the theme. When you click inside the field a color picker will appear. Scroll to find your desired color and then click the circular submit button on the lower right to accept the value",),

			array( "name" => "Post title hover background color",
				   "id" => $shortname."_color_heading_bg_hover",
				   "type" => "textcolorpopup",
				   "std" => "",
				   "desc" => "This option allows you to customize the color of a certain element of the theme. When you click inside the field a color picker will appear. Scroll to find your desired color and then click the circular submit button on the lower right to accept the value",),
			...
			array( "name" => "Sidebar links hover color",
				   "id" => $shortname."_color_sidebar_links_hover",
				   "type" => "textcolorpopup",
				   "std" => "",
				   "desc" => "This option allows you to customize the color of a certain element of the theme. When you click inside the field a color picker will appear. Scroll to find your desired color and then click the circular submit button on the lower right to accept the value",),
			...
			array( "name" => "Post info font color",
				   "id" => $shortname."_color_postinfo_font",
				   "type" => "textcolorpopup",
				   "std" => "",
				   "desc" => "This option allows you to customize the color of a certain element of the theme. When you click inside the field a color picker will appear. Scroll to find your desired color and then click the circular submit button on the lower right to accept the value",),

			array( "name" => "Quote font color (on homepage)",
				   "id" => $shortname."_color_quote",
				   "type" => "textcolorpopup",
				   "std" => "",
				   "desc" => "This option allows you to customize the color of a certain element of the theme. When you click inside the field a color picker will appear. Scroll to find your desired color and then click the circular submit button on the lower right to accept the value",),
