...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'gonzo-daily');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
load_theme_textdomain('gonzo-daily', TEMPLATEPATH . '/languages/');
...
function gd_short_excerpt($text) {
...
<p class="comment-data"><a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date() ?> @ <?php comment_time() ?></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php edit_comment_link(__('edit', 'gonzo-daily'),'',''); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?></p>

				<?php if ($comment->comment_approved == '0') : ?>

					<span class="await_mod"><?php _e('Awaiting Moderation', 'gonzo-daily'); ?></span>
...
define('HEADER_IMAGE_WIDTH', 1150); //width is fixed
define('HEADER_IMAGE_HEIGHT', 150);
define('NO_HEADER_TEXT', true );

function gonzo_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'gonzo_admin_header_style'));
