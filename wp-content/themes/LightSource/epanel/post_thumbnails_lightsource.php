<?php
	...
	$et_page_thumb = sprintf( $et_thumb_size_format,
		intval( get_option( 'lightsource_thumbnail_width_pages', 200 ) ),
		intval( get_option( 'lightsource_thumbnail_height_pages', 200 ) )
	);
	$et_usual_thumb = sprintf( $et_thumb_size_format,
		intval( get_option( 'lightsource_thumbnail_usualwidth', 200 ) ),
		intval( get_option( 'lightsource_thumbnail_thumbnail_usualheight', 200 ) )
	);
