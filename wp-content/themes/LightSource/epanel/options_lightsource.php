	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Purple", "Green", "Blue")),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Number of Featured Posts",
				   ...
				   "type" => "text",
				   "validation_type" => "number",
				   "desc" => "Here you can choose the number of Featured Posts you would like to display in the Slider on the homepage. "),

			array( "name" => "Display Random Posts",
				   "id" => $shortname."_random",
				   "type" => "checkbox",
				   "std" => "on",
				   "desc" => "Hide/Display Random posts."),

			array( "name" => "Display Recent Comments",
				   "id" => $shortname."_recent",
				   "type" => "checkbox2",
				   "std" => "on",
				   "desc" => "Hide/Display Recent Comments."),

			array( "type" => "clearfix",),

			array( "name" => "Number of Random Posts",
				   "id" => $shortname."_random_posts",
				   "std" => "5",
				   "type" => "text",
				   "validation_type" => "number",
				   "desc" => "Here you can choose how many random posts are displayed on the homepage."),
			...
			array( "name" => "Number of Recent Comments",
				   ...
				   "type" => "text",
				   "validation_type" => "number",
				   "desc" => "Here you can choose how many recent comments are displayed on the homepage."),
	...
	array( "name" => "wrap-layout",
		...
		array( "name" => "layout-1",
			...
			array( "name" => "Thumbnail width (pixels)",
            	   ...
            	   "validation_type" => "number",
            	   "std" => "200",
				   "desc" => "Enter the thumbnail width in pixels here. "),
			...
			array( "name" => "Thumbnail height (pixels)",
            	   ...
            	   "validation_type" => "number",
            	   "std" => "200",
				   "desc" => "Enter the thumbnail height in pixels here. "),
		...
		array( "name" => "layout-3",
			...
			array( "name" => "Thumbnail width (pixels)",
            	   "id" => $shortname."_thumbnail_usualwidth",
            	   "type" => "text",
            	   "validation_type" => "number",
            	   "std" => "200",
				   "desc" => "Here you can adjust the width of your thumbnail images. The width value is in pixels."),
			...
			array( "name" => "Thumbnail height (pixels)",
            	   "id" => $shortname."_thumbnail_usualheight",
            	   "type" => "text",
            	   "validation_type" => "number",
            	   "std" => "200",
				   "desc" => "Here you can adjust the height of your thumbnail images. The height value is in pixels."),
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "wrap-advertisements",
		...
		array( "name" => "advertisements-1",
			...
			array( "name" => "Enable 250x250 banner",
				   "id" => $shortname."_twofifty",
				   	"type" => "checkbox2",
				   "std" => "false",
				   "desc" => "Here you can choose to enable the 250x250 banner. ",),
			...
			array( "name" => "Input 250x250 Banner Image",
				   "id" => $shortname."_banner_twofifty_image",
				   "std" => "http://www.elegantwordpressthemes.com/images/StudioBlue/250x250.gif",
				   "type" => "text",
				   "validation_type" => "url",
				   "desc" => "Place the file URL image here. "),

			array( "name" => "Input 250x250 Banner URL",
