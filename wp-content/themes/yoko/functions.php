...
if (!defined('TEMPLATE_DOMAIN'))  define('TEMPLATE_DOMAIN','yoko');
/**
 * @package WordPress
 * @subpackage Yoko
 */
...
function yoko() {
	...
	add_theme_support( 'custom-header', array('admin-head-callback' => 'yoko_admin_header_style' ));
 ...
 * Referenced via add_theme_support() in yoko_setup().
 */
