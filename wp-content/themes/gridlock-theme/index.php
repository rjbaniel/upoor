...
<div id="main_content">
	...
	<!-- post content -->
	<?php the_content(__('<em><strong>continue reading... &raquo;</strong></em>',TEMPLATE_DOMAIN)); ?>

	<h4 class="comment"><?php _e("posted",TEMPLATE_DOMAIN); ?> <?php the_time('j F Y'); ?> @ <?php the_time('G:i'); ?> <?php _e("by",TEMPLATE_DOMAIN); ?> <?php the_author() ?>
	 &raquo; <?php comments_popup_link(__('0 Comments',TEMPLATE_DOMAIN), __('One Comment',TEMPLATE_DOMAIN), __('% Comments',TEMPLATE_DOMAIN), '', __('Comments Locked',TEMPLATE_DOMAIN) ); ?> </h4>
	...
	<div class="substory" id="left">
				...
				<h4 class="substory_comment"><?php the_time('j F Y'); ?>
				 ...
				 <?php comments_popup_link(__('0 Comments',TEMPLATE_DOMAIN), __('One Comment',TEMPLATE_DOMAIN), __('% Comments',TEMPLATE_DOMAIN), '', __('Comments Locked',TEMPLATE_DOMAIN) ); ?></h4>
	</div>
	<?php endwhile;?>
