<?php
	...
	$et_post_thumb = sprintf( $et_thumb_size_format,
		intval( get_option( 'bluesky_thumbnail_width_posts', 100 ) ),
		intval( get_option( 'bluesky_thumbnail_height_posts', 100 ) )
	);
	$et_page_thumb = sprintf( $et_thumb_size_format,
		intval( get_option( 'bluesky_thumbnail_width_pages', 100 ) ),
		intval( get_option( 'bluesky_thumbnail_height_pages', 100 ) )
	);
