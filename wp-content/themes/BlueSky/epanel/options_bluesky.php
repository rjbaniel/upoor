	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Show Popular Area",
                   ...
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to display the Popular Post area on the homepage. "),

			array( "name" => "Show Recent Comments Area",
                   "id" => $shortname."_show_tabarea_recentcomments",
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => "Here you can choose to display the Recent Comments Area on the homepage. "),

			array( "type" => "clearfix",),

			array( "name" => "Show Additional Date",
                   "id" => $shortname."_additional_date",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to display the additional date on the homepage. "),
			...
			array( "name" => "Recent posts number",
				   ...
				   "validation_type" => "number",
				   "std" => "5",
				   "desc" => "Here you can choose the number of Recent posts to display on the homepage. ",),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Number of Posts displayed on Homepage",
                   ...
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can choose to display the number of posts on the homepage. "),
