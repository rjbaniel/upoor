...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN','pressrow');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
add_theme_support( 'custom-header', array('wp-head-callback' => 'header_style', 'admin-head-callback' => 'pressrow_admin_header_style'));
		...
		<?php echo $before_widget ?>
			<?php echo $before_title ?><label for="s"><?php echo $title ?></label><?php echo $after_title ?>
				<div class="sidebar_section">
					...
					<input id="s" name="s" class="text_input" type="text" value="<?php echo esc_html(stripslashes($_GET['s']), true) ?>" size="10" />
...
function pressrow_widgets_init() {
	register_sidebars(1);
	wp_register_sidebar_widget('pressrow_search_1', __('Search', 'sandbox'), 'widget_pressrow_search', null, 'search');
	wp_unregister_widget_control('pressrow_search_1');
}
