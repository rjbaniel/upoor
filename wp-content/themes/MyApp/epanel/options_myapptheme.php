...
$options = array (
	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Logo on homepage",
				   "id" => $shortname."_logo",
				   "type" => "upload",
				   "std" => "",
				   "desc" => "If you would like to use your own custom logo image on homepage click the Upload Image button."
			),

			array( "name" => "Logo on inner pages",
				   "id" => $shortname."_logo2",
				   "type" => "upload",
				   "std" => "",
				   "desc" => "If you would like to use your own custom logo image on inner pages click the Upload Image button."
			),
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Red", "Green", "Black", "Purple")),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Description Text on Homepage",
                   "id" => $shortname."_header_description",
                   "std" => '<p>Vulputate velit esse lorem consequat vellorum illum dolore eu feugiat ipsum dolor sit amet</p>
					<ul>
						<li><a href="#">Human per seacula quarta decima et quinta dima eodebis
	consequat vel illum dolore eu feugiat nulla facilisis.</a></li>
						<li><a href="#">Nunc putamus parum, claram antep osuerit litterarum formas lorem ipsum dolor sit amet consectetuer adipiscing. </a></li>
						<li><a href="#">Littera gothica quam nunc putamus parum clantepo a nunc.</a></li>
					</ul> ',
                   "type" => "textarea",
				   "desc" => "Use the text area below for the description on the homepage. "),
		...
		array( "name" => "general-3",
			...
			array( "name" => "Show featured posts/pages on homepage",
                   "id" => $shortname."_featured",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to show featured posts/pages on the homepage. "),
			...
			array( "name" => "Buy Now Link text",
                   "id" => $shortname."_buynow_text",
                   "type" => "text",
                   "validation_type" => "nohtml",
			       "std" => "Buy Now",
				   "desc" => "Use this text field to edit the Buy Now Link text. "),

			array( "name" => "Buy Now Url",
                   "id" => $shortname."_buynow_url",
                   "type" => "text",
                   "validation_type" => "url",
			       "std" => "#",
				   "desc" => "Place the desination URL below."),

			array( "name" => "Use Timthumb resizing for product images",
                   "id" => $shortname."_product_timthumb",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to use Timthumb resizing for product images. "),

			array( "type" => "clearfix",),

			array( "name" => "Number of product images",
                   "id" => $shortname."_product_images_number",
                   "type" => "text",
                   "validation_type" => "number",
			       "std" => "8",
				   "desc" => "Here you can choose the number of product images. "),

			array( "name" => "Product Image 1 (205x310px)",
                   "id" => $shortname."_product_image_1",
                   "type" => "text",
                   "validation_type" => "url",
			       "std" => "",
				   "desc" => "Place the file URL of the Product Image here. "),

			array( "name" => "Product Image 2 (205x310px)",
                   "id" => $shortname."_product_image_2",
                   "type" => "text",
                   "validation_type" => "url",
			       "std" => "",
				   "desc" => "Place the file URL of the Product Image here. "),

			array( "name" => "Product Image 3 (205x310px)",
                   "id" => $shortname."_product_image_3",
                   "type" => "text",
                   "validation_type" => "url",
			       "std" => "",
				   "desc" => "Place the file URL of the Product Image here. "),

			array( "name" => "Product Image 4 (205x310px)",
                   "id" => $shortname."_product_image_4",
                   "type" => "text",
                   "validation_type" => "url",
			       "std" => "",
				   "desc" => "Place the file URL of the Product Image here. "),

			array( "name" => "Product Image 5 (205x310px)",
                   "id" => $shortname."_product_image_5",
                   "type" => "text",
                   "validation_type" => "url",
			       "std" => "",
				   "desc" => "Place the file URL of the Product Image here. "),

			array( "name" => "Product Image 6 (205x310px)",
                   "id" => $shortname."_product_image_6",
                   "type" => "text",
                   "validation_type" => "url",
			       "std" => "",
				   "desc" => "Place the file URL of the Product Image here. "),

			array( "name" => "Product Image 7 (205x310px)",
                   "id" => $shortname."_product_image_7",
                   "type" => "text",
                   "validation_type" => "url",
			       "std" => "",
				   "desc" => "Place the file URL of the Product Image here. "),

			array( "name" => "Product Image 8 (205x310px)",
                   "id" => $shortname."_product_image_8",
                   "type" => "text",
                   "validation_type" => "url",
			       "std" => "",
				   "desc" => "Place the file URL of the Product Image here. "),
