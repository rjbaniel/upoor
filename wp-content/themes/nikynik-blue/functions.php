...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'nikynik');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
<?php } ?>
                  ...
                  <em>
                  <?php _e('Your comment is awaiting moderation.','nikynik'); ?>
                  </em>
                  <?php endif; ?>
                  <br />

                  <div class="commentmetadata"><em><a href="#comment-<?php echo($comment->comment_ID) ?>" title="<?php _e('Permanent link to this comment','nikynik') ?>"><?php echo($comment_number) ?></a></em>
				<strong><?php comment_author_link(); ?></strong>
				<?php _e('says:','nikynik') ?></div>
...
<small>
				...
				<?php edit_comment_link(__("Edit Comment",'nikynik'), ' ', ' | '); ?>&nbsp;&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?>


				<?php _e('Posted','nikynik') ?>
...
define('HEADER_IMAGE_WIDTH', 740); //width is fixed
define('HEADER_IMAGE_HEIGHT', 192);
define('NO_HEADER_TEXT', true );

function niki_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'niki_admin_header_style'));
