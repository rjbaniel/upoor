...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN','veryplaintxt');
////////////////////////////////////////////////////////////////////////////////
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'veryplain_admin_header_style'));
...
function veryplaintxt_globalnav() {
	...
	if ( !is_front_page() ) { ?><li class="page_item_home home-link"><a href="<?php bloginfo('url'); ?>/" title="<?php echo esc_html(get_bloginfo('name'), 1) ?>" rel="home"><?php _e('Home', 'veryplaintxt') ?></a></li><?php }
...
?>
		<?php echo $before_widget; ?>
			<?php echo $before_title . $title . $after_title; ?>
			<ul>
				<li><a href="<?php bloginfo('rss2_url') ?>" title="<?php echo esc_html( get_bloginfo('name'), 1 ) ?> <?php _e( 'Posts RSS feed', 'veryplaintxt' ); ?>" rel="alternate" type="application/rss+xml"><?php _e( 'All posts', 'veryplaintxt' ) ?></a></li>
				<li><a href="<?php bloginfo('comments_rss2_url') ?>" title="<?php echo esc_html(bloginfo('name'), 1) ?> <?php _e( 'Comments RSS feed', 'veryplaintxt' ); ?>" rel="alternate" type="application/rss+xml"><?php _e( 'All comments', 'veryplaintxt' ) ?></a></li>
			</ul>
		<?php echo $after_widget; ?>
<?php
}
...
function veryplaintxt_add_admin() {
	...
	add_theme_page( __( 'veryplaintxt Theme Options', 'veryplaintxt' ), __( 'Theme Options', 'veryplaintxt' ), 'edit_theme_options', basename(__FILE__), 'veryplaintxt_admin' );
}
...
function veryplaintxt_admin() { // Theme options menu 
	if ( isset($_REQUEST['saved']) && $_REQUEST['saved'] ) { ?><div id="message1" class="updated fade"><p><?php printf(__('Veryplaintxt theme options saved. <a href="%s">View site.</a>', 'veryplaintxt'), get_bloginfo('url') . '/'); ?></p></div><?php }
	if ( isset($_REQUEST['reset']) && $_REQUEST['reset'] ) { ?><div id="message2" class="updated fade"><p><?php _e('Veryplaintxt theme options reset.', 'veryplaintxt'); ?></p></div><?php }
	...
	<form action="<?php echo esc_html( $_SERVER['REQUEST_URI'] ) ?>" method="post">
		...
		<table class="form-table" summary="Veryplaintxt typography options">
			<tr valign="top">
				...
				<td>
					<input id="vp_basefontsize" name="vp_basefontsize" type="text" class="text" value="<?php if ( get_option('veryplaintxt_basefontsize') == "" ) { echo "90%"; } else { echo esc_attr( get_option('veryplaintxt_basefontsize') ); } ?>" tabindex="1" size="10" />
		...
		<table class="form-table" summary="Veryplaintxt layout options">
			<tr valign="top">
				...
				<td>
					<input id="vp_layoutwidth" name="vp_layoutwidth" type="text" class="text" value="<?php if ( get_option('veryplaintxt_layoutwidth') == "" ) { echo "80%"; } else { echo esc_attr( get_option('veryplaintxt_layoutwidth') ); } ?>" tabindex="20" size="10" />
			...
			<tr valign="top">
				...
				<td>
					<input id="vp_maxwidth" name="vp_maxwidth" type="text" class="text" value="<?php if ( get_option('veryplaintxt_maxwidth') == "" ) { echo "55em"; } else { echo esc_attr( get_option('veryplaintxt_maxwidth') ); } ?>" tabindex="21" size="10" />
			...
			<tr valign="top">
				...
				<td>
					<input id="vp_minwidth" name="vp_minwidth" type="text" class="text" value="<?php if ( get_option('veryplaintxt_minwidth') == "" ) { echo "35em"; } else { echo esc_attr( get_option('veryplaintxt_minwidth') ); } ?>" tabindex="22" size="10" />
		...
		<table class="form-table" summary="Veryplaintxt content options">
			<tr valign="top">
				...
				<td>
					<input id="vp_avatarsize" name="vp_avatarsize" type="text" class="text" value="<?php if ( get_option('veryplaintxt_avatarsize') == "" ) { echo "40"; } else { echo esc_attr( get_option('veryplaintxt_avatarsize') ); } ?>" size="6" />
...
function veryplaintxt_wp_head() {
	...
	if ( get_option('veryplaintxt_basefontsize') == '' ) {
		...
		$basefontsize = esc_attr( stripslashes( get_option('veryplaintxt_basefontsize') ) ); 
	}
	...
	if ( get_option('veryplaintxt_layoutwidth') == "" ) {
		...
		$layoutwidth = esc_attr( stripslashes( get_option('veryplaintxt_layoutwidth') ) ); 
	}
	if ( get_option('veryplaintxt_maxwidth') == "" ) {
		$maxwidth = '55em';
	} else {
		$maxwidth = esc_attr( stripslashes( get_option('veryplaintxt_maxwidth') ) ); 
	}
	if ( get_option('veryplaintxt_minwidth') == "" ) {
		$minwidth = '35em';
	} else {
		$minwidth = esc_attr( stripslashes( get_option('veryplaintxt_minwidth') ) ); 
	}
	if ( get_option('veryplaintxt_posttextalignment') == "" ) {
		$posttextalignment = 'left';
	} else {
		$posttextalignment = esc_attr( stripslashes( get_option('veryplaintxt_posttextalignment') ) ); 
	}
...
';
	...
	if ( get_option('veryplaintxt_sidebartextalignment') == "" ) {
		...
		$sidebartextalignment = esc_attr( stripslashes( get_option('veryplaintxt_sidebartextalignment') ) ); 
	}
?>
