...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'chaoticsoul');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
?>
	...
	<div><input type="text" value="<?php echo esc_html($s, 1); ?>" name="s" id="s" value="Journal Search&#8230;" />
...
function chaoticsoul_widget_init() {
	...
	wp_register_sidebar_widget('chaoticsoul_links_1', __('Links', 'widgets'), 'widget_chaoticsoul_links', null, 'links');
	wp_register_sidebar_widget('chaoticsoul_search_1', __('Search', 'widgets'), 'widget_chaoticsoul_search', null, 'search');
}
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'chaoticsoul_admin_header_style'));
