	...
	<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar() ) : ?>
      ...
      <?php /* If this is a yearly archive */ } elseif (is_year()) { ?>
		 ...
		 <?php /* If this is a search */ } elseif (is_search()) { ?>
			<h3><?php _e('About This Page'); ?></h3>
			<p><?php printf(__('You have searched the %s weblog archives for %s. If you are unable to find anything in these search results, you can try one of these links.', 'chaoticsoul'), '<a href="'.get_bloginfo('url').'/">'.get_bloginfo('name').'</a>', '<strong>'.esc_html($s).'</strong>');?></p>
