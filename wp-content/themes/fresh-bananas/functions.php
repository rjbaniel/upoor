...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'fresh-bananas');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
load_theme_textdomain('fresh-bananas', TEMPLATEPATH . '/languages/');
...
<?php } ?>&nbsp;&nbsp;<?php comment_author_link() ?></cite> <?php _e('Says','fresh-bananas');?>:
			<?php if ($comment->comment_approved == '0') : ?>
			<em><?php _e('Your comment is awaiting moderation.','fresh-bananas');?></em>
			<?php endif; ?>
			<br />

			<small class="commentmetadata"><a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('F jS, Y') ?> <?php _e('at','fresh-bananas');?> <?php comment_time() ?></a> <?php edit_comment_link(__('Edit','fresh-bananas'),'&nbsp;&nbsp;',''); ?>&nbsp;&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?></small>
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'fb_admin_header_style'));
