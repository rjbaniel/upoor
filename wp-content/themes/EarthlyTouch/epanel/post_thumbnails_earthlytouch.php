<?php
	...
	$et_post_thumb = sprintf( $et_thumb_size_format,
		intval( get_option( 'earthlytouch_thumbnail_width_posts', 84 ) ),
		intval( get_option( 'earthlytouch_thumbnail_height_posts', 84 ) )
	);
	$et_page_thumb = sprintf( $et_thumb_size_format,
		intval( get_option( 'earthlytouch_thumbnail_width_pages', 84 ) ),
		intval( get_option( 'earthlytouch_thumbnail_height_pages', 84 ) )
	);
	...
	$et_theme_image_sizes = array(
		...
		'70x80' 	=> 'et-home-thumb',
		'90x150' 	=> 'et-entry-thumb',
		'200x200' 	=> 'et-featured-thumb',
	);
