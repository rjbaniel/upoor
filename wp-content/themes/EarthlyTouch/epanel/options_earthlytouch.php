	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Orange", "Blue", "Green", "Purple", "Red")),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Number of Recent Comments",
                   ...
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can choose the number of Recent Comments you would like to display on the homepage. "),
			...
			array( "name" => "Show Recent Comments box",
                   "id" => $shortname."_show_recent_comments",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to diplay the Recent Comments on the homepage. "),

			array( "name" => "Show Random Articles box",
                   "id" => $shortname."_show_random_posts",
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => "Here you can choose to display the Random Articles on the homepage. "),
