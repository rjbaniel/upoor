...
$options = array (
	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Default background image(s) (separated with commas)",
				   "id" => $shortname."_default_bg_images",
				   "type" => "textarea",
				   "std" => get_bloginfo('template_directory') . '/images/clouds.jpg, ' . get_bloginfo('template_directory') . '/images/landscape.jpg',
				   "desc" => "ex. http://mysite.com/uploads/image1.jpg, http://mysite.com/uploads/image2.jpg, http://mysite.com/uploads/image3.jpg"),

			array( "name" => "Homepage background image(s) (separated with commas)",
				   "id" => $shortname."_home_bg_images",
				   "type" => "textarea",
				   "std" => '',
				   "desc" => "ex. http://mysite.com/uploads/image1.jpg, http://mysite.com/uploads/image2.jpg, http://mysite.com/uploads/image3.jpg"),

			array( "name" => "Category page background image(s) (separated with commas)",
				   "id" => $shortname."_category_bg_images",
				   "type" => "textarea",
				   "std" => '',
				   "desc" => "ex. http://mysite.com/uploads/image1.jpg, http://mysite.com/uploads/image2.jpg, http://mysite.com/uploads/image3.jpg"),

			array( "name" => "Search page background image(s) (separated with commas)",
				   "id" => $shortname."_search_bg_images",
				   "type" => "textarea",
				   "std" => '',
				   "desc" => "ex. http://mysite.com/uploads/image1.jpg, http://mysite.com/uploads/image2.jpg, http://mysite.com/uploads/image3.jpg"),

			array( "name" => "Tag page background image(s) (separated with commas)",
				   "id" => $shortname."_tag_bg_images",
				   "type" => "textarea",
				   "std" => '',
				   "desc" => "ex. http://mysite.com/uploads/image1.jpg, http://mysite.com/uploads/image2.jpg, http://mysite.com/uploads/image3.jpg"),

			array( "name" => "Archive page background image(s) (separated with commas)",
				   "id" => $shortname."_archive_bg_images",
				   "type" => "textarea",
				   "std" => '',
				   "desc" => "ex. http://mysite.com/uploads/image1.jpg, http://mysite.com/uploads/image2.jpg, http://mysite.com/uploads/image3.jpg"),

			array( "name" => "Background images animation speed",
                   "id" => $shortname."_bg_image_speed",
                   "std" => "8000",
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can control the Background images animation speed in ms. "),

			array( "name" => "Service images animation speed",
                   "id" => $shortname."_service_image_speed",
                   "std" => "1000",
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can control the Service images animation speed in ms. "),
			...
			array( "name" => "Create Dropcaps",
                   "id" => $shortname."_dropcaps",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "You can use this option to create Dropcaps. "),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Content Area 1 Page",
				   ...
				   "std" => "",
				   "type" => "select",
				   "desc" => "Here you can choose the page you would like to display in the Content Area. ",
				   "options" => $site_pages,
				   'et_array_for' => 'pages'),
