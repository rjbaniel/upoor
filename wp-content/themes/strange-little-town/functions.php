...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN','strange-little-town');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
load_theme_textdomain('slt', TEMPLATEPATH . '/languages/');
...
<span class="author"><?php comment_author_link() ?></span><br /><span class="time"><?php comment_time() ?></span> <?php _e('on', 'slt'); ?> <a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('F jS, Y') ?></a> <?php edit_comment_link(__('edit','slt'),'&nbsp;&nbsp;',''); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?>
...
<em><?php _e('Your comment is awaiting moderation','slt'); ?>.</em>
...
function slt_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'slt_admin_header_style'));
