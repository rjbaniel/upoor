...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'genkitheme');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
load_theme_textdomain('genki', TEMPLATEPATH . '/languages/');
...
<?php } ?>&nbsp;&nbsp;<strong><?php comment_author_link() ?></strong> | <a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('F jS, Y') ?> <?php _e('at','genki');?> <?php comment_time() ?></a> <?php edit_comment_link(__('edit','genki'),'',''); ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?>
<?php if ($comment->comment_approved == '0') : ?>
<em><?php _e('Your comment is awaiting moderation.','genki');?></em>
<?php endif; ?>
<br />
<?php comment_text() ?>
...
function genki_admin_header_style() { ?>
<style type="text/css">
#headimg { background: #2189CC url(<?php header_image() ?>) repeat-x; }
#headimg { height: <?php echo HEADER_IMAGE_HEIGHT; ?>px; width: <?php echo HEADER_IMAGE_WIDTH; ?>px; }
</style>
<?php }

add_theme_support( 'custom-header', array('admin-head-callback' => 'genki_admin_header_style'));
