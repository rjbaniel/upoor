	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-2",
			...
			array( "name" => "Display Services",
                   ...
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to display the Services or Content Areas on the homepage. "),

			array( "name" => "Display Sidebar Home Widgets on Homepage",
                   "id" => $shortname."_homepage_widgets",
                   "type" => "checkbox2",
                   "std" => "false",
                   "desc" => "Here you can choose to display Home Widgets on the homepage. "),
			...
			array( "name" => "Service Page 1",
				   ...
				   "std" => "",
				   "type" => "select",
				   "desc" => "Here you can choose the page you would like to display in the Service area on the homepage. ",
				   "options" => $site_pages,
				   'et_array_for' => 'pages'),
