...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN', 'newsportal');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
<?php } ?>&nbsp;&nbsp;<cite><?php comment_author_link() ?></cite> <?php _e('Says',TEMPLATE_DOMAIN);?>:
			...
			<small class="commentmetadata"><a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('F jS, Y') ?> <?php _e('at',TEMPLATE_DOMAIN);?> <?php comment_time() ?></a> <?php edit_comment_link('e','',''); ?></small>
...
function np_admin_header_style() { ?>
<style type="text/css">
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'np_admin_header_style'));
...
if ( function_exists('wp_register_sidebar_widget') )
    wp_register_sidebar_widget('newsportal_pages_1', __('Pages'), 'widget_newsportal_pages');
...
<input type="text" size="10" value="<?php echo esc_html($s, 1); ?>" name="s" id="s" /><input type="submit" id="sidebarsubmit" value="<?php _e('Search');?>" />
...
if ( function_exists('wp_register_sidebar_widget') )
    wp_register_sidebar_widget('newsportal_pages_1', __('Search'), 'widget_newsportal_search');
