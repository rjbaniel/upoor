...
$options = array (
	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Show Delete Button",
                   "id" => $shortname."_delete_button",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "This option allows you to control the delete function post function."),

			array( "name" => "Show Share Button",
                   "id" => $shortname."_share_button",
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => "This option allows you to control the share button."),

			array( "type" => "clearfix",),

			array( "name" => "Show About Us box in Sidebar",
                   "id" => $shortname."_show_about",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "This option allows you to control the About Us box in the Sidebar."),

			array( "name" => "Show Random posts in Sidebar",
                   "id" => $shortname."_show_random",
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => "This option allows you to control the Show Random posts in Sidebar."),

			array( "type" => "clearfix",),

			array( "name" => "Show Recent Comments box in Sidebar",
                   "id" => $shortname."_show_recent_comments",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "This option allows you to control the Show Recent Comments in Sidebar."),
			...
			array( "name" => "About Us Text",
				   ...
				   "type" => "textarea",
				   "std" => "",
				   "desc" => "This field will display in the About Us funtion of the Sidebar. ",),
			...
			array( "name" => "Random posts number",
				   ...
				   "validation_type" => "number",
				   "std" => "6",
				   "desc" => "Choose the number of Random posts you would like to be displayed in the Sidebar. ",),
			...
			array( "name" => "Recent comments number",
				   ...
				   "validation_type" => "number",
				   "std" => "6",
				   "desc" => "Choose the number of Recent comments you would like to display in the Sidebar. ",),

		array( "name" => "Use excerpts when defined",
			   "id" => $shortname."_use_excerpt",
			   "type" => "checkbox",
			   "std" => "false",
			   "desc" => "This will ebable the use of excerpts in posts or pages."),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Number of Posts displayed on Homepage",
                   ...
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can designate how many posts you would like to display in the homepage. "),
