...
if (!defined('TEMPLATE_DOMAIN')) define('TEMPLATE_DOMAIN','simpla');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
add_theme_support( 'custom-header', array('admin-head-callback' => 'simpla_admin_header_style'));
...
#header h1 a, #header p { color: #<?php header_textcolor() ?> !important; text-decoration: none; }
</style>
<?php } ?>
<?php }
