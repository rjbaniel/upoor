...
class Wdcab_AdminPages {
	...
	function css_print_styles () {
		if (!isset($_GET['page']) || 'wdcab' != $_GET['page']) return false;
		//wp_enqueue_style('jquery-ui-dialog', 'https://ajax.googleapis.com/ajax/libs/jqueryui/1.8.2/themes/smoothness/jquery-ui.css');
	...
	function add_hooks () {
		...
		add_action('network_admin_print_styles', array($this, 'css_print_styles'));
