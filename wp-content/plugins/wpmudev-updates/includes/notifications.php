					...
					<div class="squish">
						<h4>
							...
							<a id="api-add" class="wpmu-button" href="<?php echo $link; ?>"><i
									class="icon-pencil icon-large"></i> <?php _e( 'Get Started', 'wpmudev' ); ?></a>
						</h4>
							...
							<div class="dev-cta-wrap">
								<?php if ( ! $wpmudev_un->get_apikey() ) { //no api key yet
									?><a id="wdv-release-install" href="<?php echo $wpmudev_un->dashboard_url; ?>"
										...
										class="icon-download-alt icon-large"></i> <?php _e( 'INSTALL', 'wpmudev' ); ?></a><?php
									...
									?><a id="wdv-release-install" href="<?php echo esc_url( $project['url'] ); ?>" target="_blank"
									     class="wpmu-button"><i
										class="icon-download icon-large"></i> <?php _e( 'DOWNLOAD', 'wpmudev' ); ?></a><?php
									...
									?><a id="wdv-release-install"
										...
										class="icon-arrow-up icon-large"></i> <?php _e( 'Upgrade to Install', 'wpmudev' ); ?></a><?php
								} ?>
